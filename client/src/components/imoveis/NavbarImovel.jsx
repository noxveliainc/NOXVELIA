              ...
              <div ref={userMenuRef} style={{ position: 'relative' }}>
                ...
                {userMenuAberto && (
                  <div className="nim-user-dropdown" onClick={(e) => e.stopPropagation()}>
                    ...
                    <button onClick={() => { setUserMenuAberto(false); abrirModalInfo(); }} className="nim-ud-item"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>Informações Pessoais</button>
            ...
            <div className="nim-drawer-menu">
              {signed ? (
                <>
                  ...
                  <button type="button" className="nim-drawer-link" onClick={() => { setMenuMobileAberto(false); abrirModalInfo(); }}>
