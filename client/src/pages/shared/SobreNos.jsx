...
const valores = [
  ...
  },
  {
    ...
    text: 'A NOXVELIA Drive foi pensada para destacar automóveis com dados completos e pesquisa rápida.',
  },
  {
    icon: mdiHomeCityOutline,
    title: 'Imóveis com contexto',
    text: 'A NOXVELIA Estate organiza casas, terrenos e espaços comerciais para uma decisão mais simples.',
  },
  {
  ...
  return (
    <>
      ...
      <style>{`
        ...
        .about-kicker { display: inline-flex; align-items: center; gap: 8px; margin-bottom: 16px; color: #0f766e; background: rgba(42, 193, 180, .1); border: 1px solid rgba(42, 193, 180, .22); border-radius: 999px; padding: 7px 11px; font-size: 11px; font-weight: 900; text-transform: uppercase; letter-spacing: .08em; }
        ...
        .about-btn.primary { background: #2ac1b4; color: #ffffff; border: 1px solid #2ac1b4; box-shadow: 0 18px 34px -24px rgba(42, 193, 180, .9); }
        ...
        .about-value-icon { width: 36px; height: 36px; border-radius: 8px; display: inline-flex; align-items: center; justify-content: center; color: #0f766e; background: rgba(42, 193, 180, .1); margin-bottom: 18px; }
        ...
        .about-location-note { display: inline-flex; align-items: center; gap: 8px; width: fit-content; margin-top: 8px; padding: 9px 12px; border-radius: 999px; color: #0f766e; background: rgba(42, 193, 180, .09); border: 1px solid rgba(42, 193, 180, .22); font-size: 12px; font-weight: 850; }
