...
import { mdiArrowRight, mdiCarSports, mdiHeartOutline, mdiHomeCityOutline, mdiMagnify } from '@mdi/js';
  ...
  return (
    <>
      <style>{`
        ...
        .fav-suggestion-icon.drive { background: #ccfbf1; color: #0f766e; }
        .fav-suggestion-icon.estate { background: #dcfce7; color: #047857; }
        .fav-suggestion strong {
          display: block;
          font-size: 13px;
          color: #0f172a;
          margin-bottom: 3px;
        ...
        @media (max-width: 820px) {
          ...
          .fav-hero,
          .fav-empty { grid-template-columns: 1fr; }
        ...
        <div className="fav-shell">
          ...
          {favoritos.length > 0 ? (
            ...
            <div className="fav-empty">
              ...
              <div className="fav-empty-side">
                <div className="fav-suggestion">
                  <span className="fav-suggestion-icon drive"><Icon path={mdiCarSports} size={0.9} /></span>
                  <div><strong>Compara viaturas</strong><span>Quilómetros, combustível, cilindrada e vendedor ficam à distância de um clique.</span></div>
                </div>
                <div className="fav-suggestion">
                  <span className="fav-suggestion-icon estate"><Icon path={mdiHomeCityOutline} size={0.9} /></span>
                  <div><strong>Guarda imóveis</strong><span>Área, tipologia e zona tornam-se mais fáceis de comparar lado a lado.</span></div>
                </div>
              </div>
            </div>
          )}
