        ...
        <section ref={heroRef} className="lp-hero" aria-labelledby="lp-hero-title">
          ...
          <div className="lp-shell lp-hero-inner">
            <div className="lp-hero-copyblock lp-reveal">
              ...
              <h1 id="lp-hero-title">Carros e imóveis em Portugal</h1>
              <p className="lp-hero-copy">Filtra por localização, preço e características com contacto direto ao anunciante.</p>
