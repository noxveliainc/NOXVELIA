  ...
  return (
    <div className="pro-root">
      <Seo
        ...
        description="Encontra stands, mediadores e vendedores premium com anúncios ativos na Noxvelia."
        path="/profissionais"
      />
      <style>{`
        ...
        .pro-list-kicker { display: block; margin-bottom: 6px; color: #0b5e58; font-size: 11px; font-weight: 900; letter-spacing: 0.1em; text-transform: uppercase; }
        .pro-list-title { margin: 0; color: #082126; font-size: 22px; line-height: 1.15; font-weight: 900; }
        ...
        .pro-card.is-featured { border-color: rgba(11,94,88,0.34); box-shadow: 0 14px 30px -26px rgba(8,33,38,0.45); }
        ...
        .pro-rank { position: absolute; top: 12px; right: 12px; display: inline-flex; align-items: center; gap: 6px; min-height: 28px; padding: 0 10px; border-radius: 999px; background: rgba(8,33,38,0.88); color: #ffffff; font-size: 10px; font-weight: 900; letter-spacing: 0.04em; text-transform: uppercase; }
        ...
        .dark .pro-card.is-featured { border-color: rgba(94,234,212,0.45); box-shadow: 0 18px 36px -28px rgba(94,234,212,0.38); }
        .dark .pro-name strong, .dark .pro-summary-item strong, .dark .pro-list-title { color: #f8fafc; }
        .dark .pro-hero p, .dark .pro-bio, .dark .pro-location, .dark .pro-summary-item span, .dark .pro-list-note { color: #a7bec3; }
      ...
      <section className="pro-hero">
        <div className="pro-shell pro-hero-grid">
          <div>
            ...
            <p>Encontra stands, mediadores e vendedores premium ordenados por volume real de anúncios ativos, localização e ligação direta ao perfil público.</p>
          </div>
      ...
      <section className="pro-section">
        <div className="pro-shell">
          ...
          {!error && !loading && profissionais.length === 0 && <div className="pro-state">Ainda não há anunciantes com anúncios ativos para estes filtros.</div>}
          {!error && !loading && profissionais.length > 0 && (
            <div className="pro-results">
              <div className="pro-list-head">
                <div>
                  <span className="pro-list-kicker">Destaque</span>
                  <h2 className="pro-list-title">Anunciantes com mais anúncios ativos</h2>
                </div>
                <span className="pro-list-note">Ordenado pelo tamanho da montra pública</span>
              </div>
                  ...
                  return (
                    <Link className={`pro-card${index < 3 ? ' is-featured' : ''}`} to={`/vendedor/${profissional._id}`} key={profissional._id}>
                      ...
                      <div className="pro-body">
                        ...
                        <p className="pro-bio">{profissional.bio || 'Anunciante com montra ativa na Noxvelia.'}</p>
