import{u as be,b as me,r as l,j as e,c as p}from"./index-BBQ9M_rT.js";import{A as ge}from"./AnuncioCard-DkdVMrOt.js";import{o as he,P as ve}from"./ProfileView-2XC9hHR2.js";import{I as c,G as $,_ as we,$ as ye,a0 as ke,a1 as je,a2 as Ne,a3 as Ee,a4 as Pe,a5 as Ae,U as Ce,a6 as ze,a7 as Se,a8 as Ie,g as Le,X as De,a9 as Te}from"./mdi-B3DqShuu.js";const j=[{value:"website",label:"Website",icon:ke,placeholder:"Ex: https://www.teusite.pt"},{value:"instagram",label:"Instagram",icon:je,placeholder:"Ex: https://instagram.com/oteuperfil"},{value:"facebook",label:"Facebook",icon:Ne,placeholder:"Ex: https://facebook.com/oteuperfil"},{value:"linkedin",label:"LinkedIn",icon:Ee,placeholder:"Ex: https://linkedin.com/in/oteuperfil"},{value:"youtube",label:"YouTube",icon:Pe,placeholder:"Ex: https://youtube.com/@oteucanal"},{value:"tiktok",label:"TikTok",icon:Ae,placeholder:"Ex: https://tiktok.com/@oteuperfil"},{value:"whatsapp",label:"WhatsApp",icon:Ce,placeholder:"Ex: 912345678 ou https://wa.me/351912345678"},{value:"outro",label:"Outro",icon:ze,placeholder:"Ex: https://www.outrolink.pt"}],N=()=>({tipo:"website",url:""}),Me=f=>j.find(b=>b.value===f)||j[j.length-1],Oe=(f,b)=>{const w=Array.isArray(f)?f.filter(n=>n==null?void 0:n.url).slice(0,3):[];return w.length>0?w.map(n=>({tipo:n.tipo||"outro",url:n.url||""})):b?[{tipo:"website",url:b}]:[N()]};function $e(){const{user:f,signed:b,atualizarAvatar:w,atualizarUser:n,logout:E}=be(),m=me(),G=l.useRef(null),W=l.useRef(null),q=localStorage.getItem("@App:contexto_visual")||"imovel",[s,g]=l.useState(null),[P,T]=l.useState([]),[y,M]=l.useState(q),[B,O]=l.useState(!0),[J,h]=l.useState(!1),[Y,R]=l.useState(!1),[H,F]=l.useState(!1),[Re,K]=l.useState(null),[X,_]=l.useState(!1),[A,C]=l.useState(null),[v,U]=l.useState(null),[Q,z]=l.useState(!1),[d,S]=l.useState({nomeEmpresa:"",nif:"",website:""}),[Z,I]=l.useState(!1),[x,k]=l.useState({bio:"",website:"",localidade:"",linksPerfil:[N()]}),ee=y==="carro"?"/carros":"/imoveis",ae=y==="carro"?"Automóveis":"Imóveis";l.useEffect(()=>{if(!b){m("/login");return}f&&g(f);let a=!0;return(async()=>{var i,t;try{const[o,u]=await Promise.all([p.get("/users/me"),p.get("/users/me/anuncios")]);if(!a)return;g(o.data),T(u.data),O(!1)}catch(o){if(!a)return;((i=o.response)==null?void 0:i.status)===401||((t=o.response)==null?void 0:t.status)===403?(E(),m("/login")):(K("Não foi possível carregar os teus dados."),O(!1))}})(),()=>{a=!1}},[m,b,f,E]);const re=()=>{E(),m("/",{replace:!0})},te=async a=>{const r=a.target.files[0];if(r){R(!0);try{const i=new FormData;i.append("imagens",r);const t=await p.post("/upload/imagens",i,{headers:{"Content-Type":"multipart/form-data"}}),o=Array.isArray(t.data.urls)?t.data.urls[0]:t.data.url,u=await p.put("/users/me",{avatarUrl:o});w&&w(o),g(u.data)}catch{alert("Erro ao processar a imagem do avatar.")}finally{R(!1)}}},oe=async a=>{const r=a.target.files[0];if(r){F(!0);try{const i=new FormData;i.append("imagens",r);const t=await p.post("/upload/imagens",i,{headers:{"Content-Type":"multipart/form-data"}}),o=Array.isArray(t.data.urls)?t.data.urls[0]:t.data.url,u=await p.put("/users/me",{capaUrl:o});g(u.data),n&&n(u.data)}catch{alert("Erro ao processar a imagem de capa.")}finally{F(!1)}}},ie=async a=>{if(a.preventDefault(),!d.nomeEmpresa){alert("O Nome da Empresa é obrigatório.");return}try{z(!1),h(!0);const r=await p.put("/users/me",{tipoConta:"profissional",nome:d.nomeEmpresa,nif:d.nif,website:d.website});g(r.data),n&&n(r.data),alert("A tua conta foi evoluída para Profissional com sucesso.")}catch{alert("Ocorreu um erro ao evoluir a tua conta.")}finally{h(!1)}},se=()=>{k({bio:(s==null?void 0:s.bio)||"",website:(s==null?void 0:s.website)||"",localidade:(s==null?void 0:s.localidade)||"",linksPerfil:Oe(s==null?void 0:s.linksPerfil,s==null?void 0:s.website)}),I(!0)},V=(a,r,i)=>{k(t=>({...t,linksPerfil:t.linksPerfil.map((o,u)=>u===a?{...o,[r]:i}:o)}))},le=()=>{k(a=>a.linksPerfil.length>=3?a:{...a,linksPerfil:[...a.linksPerfil,N()]})},ne=a=>{k(r=>{const i=r.linksPerfil.filter((t,o)=>o!==a);return{...r,linksPerfil:i.length?i:[N()]}})},de=async a=>{var t;a.preventDefault();const r=x.linksPerfil.map(o=>({tipo:o.tipo||"outro",url:(o.url||"").trim()})).filter(o=>o.url).slice(0,3),i=((t=r.find(o=>o.tipo==="website"))==null?void 0:t.url)||"";try{h(!0),I(!1);const o=await p.put("/users/me",{bio:x.bio,localidade:x.localidade,website:i,linksPerfil:r});g(o.data),n&&n(o.data)}catch{alert("Erro ao guardar as alterações do perfil.")}finally{h(!1)}},pe=async a=>{if(A===a){C(null),U(null);return}C(a);try{const{data:r}=await p.get(`/analytics/anuncio/${a}`);U(r)}catch{alert("Erro ao carregar dados."),C(null)}},ce=a=>{h(!0),T(r=>r.filter(i=>i._id!==a)),setTimeout(()=>h(!1),800)},fe=()=>{const a=`${window.location.origin}/vendedor/${s._id}`;navigator.clipboard.writeText(a),_(!0),setTimeout(()=>_(!1),2e3)},xe=P.filter(a=>a.tipo===y),L=P.filter(a=>a.tipo==="imovel").length,D=P.filter(a=>a.tipo==="carro").length,ue=he(s);return B?e.jsx("div",{style:{height:"100vh",display:"flex",alignItems:"center",justifyContent:"center",background:"#f8fafc"},children:e.jsx("div",{className:"nx-spinner",style:{borderColor:"rgba(42, 193, 180, 0.2)",borderTopColor:"#2ac1b4"}})}):e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
      ...
      `}),Q&&e.jsx("div",{className:"modal-overlay",children:e.jsxs("div",{className:"modal-card",children:[e.jsx("button",{className:"modal-close",onClick:()=>z(!1),children:e.jsx(c,{path:$,size:1})}),e.jsxs("h2",{className:"modal-title",children:[e.jsx(c,{path:we,size:1.2,color:"#3b82f6"})," Evolução de Conta"]}),e.jsx("p",{className:"modal-desc",children:"Transforma a tua conta num perfil empresarial. Terás direito a uma montra exclusiva com links para o teu website e contactos diretos."}),e.jsxs("form",{onSubmit:ie,children:[e.jsxs("div",{className:"modal-form-group",children:[e.jsx("label",{children:"Nome do Stand / Agência *"}),e.jsx("input",{className:"modal-input",type:"text",placeholder:"Ex: Stand Vale do Sousa",value:d.nomeEmpresa,onChange:a=>S({...d,nomeEmpresa:a.target.value}),required:!0})]}),e.jsxs("div",{className:"modal-form-group",children:[e.jsx("label",{children:"NIF da Empresa (Opcional)"}),e.jsx("input",{className:"modal-input",type:"text",placeholder:"Ex: 501234567",value:d.nif,onChange:a=>S({...d,nif:a.target.value})})]}),e.jsxs("div",{className:"modal-form-group",children:[e.jsx("label",{children:"Website (Opcional)"}),e.jsx("input",{className:"modal-input",type:"url",placeholder:"Ex: https://www.omeustand.pt",value:d.website,onChange:a=>S({...d,website:a.target.value})})]}),e.jsx("button",{className:"modal-btn-submit",type:"submit",children:"Confirmar Evolução"})]})]})}),Z&&e.jsx("div",{className:"modal-overlay",children:e.jsxs("div",{className:"modal-card",children:[e.jsx("button",{className:"modal-close",onClick:()=>I(!1),children:e.jsx(c,{path:$,size:1})}),e.jsxs("h2",{className:"modal-title",children:[e.jsx(c,{path:ye,size:1.2,color:"#3b82f6"})," Editar Perfil"]}),e.jsx("p",{className:"modal-desc",children:"Personaliza a tua presença na plataforma. Adiciona uma biografia para que os compradores saibam quem és."}),e.jsxs("form",{onSubmit:de,children:[e.jsxs("div",{className:"modal-form-group",children:[e.jsx("label",{children:"Biografia do Perfil (Máx 800 Carateres)"}),e.jsx("textarea",{className:"modal-input",placeholder:"Escreve um pouco sobre ti ou sobre o teu stand...",value:x.bio,onChange:a=>k({...x,bio:a.target.value}),maxLength:800})]}),e.jsxs("div",{className:"modal-form-group",children:[e.jsxs("div",{className:"links-editor-header",children:[e.jsx("label",{children:"Links do Perfil"}),e.jsxs("span",{className:"links-editor-count",children:[x.linksPerfil.filter(a=>a.url).length,"/3"]})]}),e.jsx("div",{className:"link-editor-list",children:x.linksPerfil.map((a,r)=>{const i=Me(a.tipo);return e.jsxs("div",{className:"link-editor-row",children:[e.jsx("div",{className:"modal-select-wrap",children:e.jsx("select",{className:"modal-select",value:a.tipo,onChange:t=>V(r,"tipo",t.target.value),children:j.map(t=>e.jsx("option",{value:t.value,children:t.label},t.value))})}),e.jsx("input",{className:"modal-input",type:"text",inputMode:"url",placeholder:i.placeholder,value:a.url,onChange:t=>V(r,"url",t.target.value)}),e.jsx("button",{type:"button",className:"link-remove-btn",onClick:()=>ne(r),"aria-label":"Remover link",children:e.jsx(c,{path:Se,size:.72})})]},r)})}),e.jsxs("button",{type:"button",className:"link-add-btn",onClick:le,disabled:x.linksPerfil.length>=3,children:[e.jsx(c,{path:Ie,size:.65})," Adicionar Link"]})]}),e.jsx("button",{className:"modal-btn-submit",type:"submit",children:"Guardar Alterações"})]})]})}),e.jsx("div",{className:"perfil-outer",children:e.jsxs("div",{className:"perfil-moldura",children:[J&&e.jsx("div",{className:"perfil-loading-overlay",children:e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:"16px"},children:[e.jsx("div",{className:"nx-spinner",style:{borderColor:"rgba(42, 193, 180, 0.2)",borderTopColor:"#2ac1b4"}}),e.jsx("span",{style:{fontFamily:"var(--nx-font-body)",fontWeight:600,color:"#0f172a",fontSize:"14px"},children:"A processar..."})]})}),e.jsxs("button",{onClick:()=>m(ee),className:"perfil-back",children:[e.jsx(c,{path:Le,size:.7})," ",ae]}),e.jsx(ve,{user:s,isOwner:!0,totalImoveis:L,totalCarros:D,links:ue,onEditProfile:se,onShare:fe,onLogout:re,onUpgrade:()=>z(!0),onAvatarChange:te,onCapaChange:oe,fileInputAvatarRef:G,fileInputCapaRef:W,uploadingAvatar:Y,uploadingCapa:H,linkCopiado:X}),!1,e.jsxs("div",{className:"tabs-row",children:[e.jsxs("button",{className:`tab-btn${y==="imovel"?" active-imovel":""}`,onClick:()=>M("imovel"),children:["Imóveis ",L>0&&`(${L})`]}),e.jsxs("button",{className:`tab-btn${y==="carro"?" active-carro":""}`,onClick:()=>M("carro"),children:["Automóveis ",D>0&&`(${D})`]})]}),e.jsx("div",{className:"cards-grid",children:xe.map(a=>e.jsxs("div",{className:"card-wrapper",children:[e.jsx(ge,{anuncio:a,showStatus:!0,onAnuncioEliminado:ce}),a.destacado?e.jsxs("div",{className:"badge-destacado",children:[e.jsx(c,{path:De,size:.6})," Destaque Ativo"]}):e.jsx("button",{className:"btn-destacar",onClick:()=>m("/sucesso/"+a._id),children:"Promover Anúncio (1.99€)"}),e.jsxs("button",{className:"analytics-trigger-btn",onClick:()=>pe(a._id),children:[e.jsx(c,{path:Te,size:.7})," ",A===a._id?"Ocultar Relatório":"Ver Performance"]}),A===a._id&&v&&e.jsxs("div",{className:"analytics-panel",children:[e.jsxs("div",{className:"stat-grid",children:[e.jsxs("div",{className:"stat-box",children:[e.jsx("div",{className:"stat-box-val",children:v.totalVisitas}),e.jsx("div",{className:"stat-box-lbl",children:"Visitas"})]}),e.jsxs("div",{className:"stat-box",style:{borderLeft:"1px solid #e2e8f0",borderRight:"1px solid #e2e8f0"},children:[e.jsx("div",{className:"stat-box-val",style:{color:"#3b82f6"},children:v.guardadoEmFavoritos}),e.jsx("div",{className:"stat-box-lbl",children:"Favoritos"})]}),e.jsxs("div",{className:"stat-box",children:[e.jsx("div",{className:"stat-box-val",style:{color:"#2ac1b4"},children:v.contactosGerados}),e.jsx("div",{className:"stat-box-lbl",children:"Mensagens"})]})]}),e.jsx("div",{className:"chart-row",children:v.graficoSeteDias.map((r,i)=>e.jsxs("div",{className:"chart-bar-wrap",children:[e.jsx("div",{className:"chart-bar",style:{height:`${Math.max(r.visitas/Math.max(...v.graficoSeteDias.map(t=>t.visitas),10)*100,5)}%`,opacity:r.visitas===0?.3:1}}),e.jsx("div",{className:"chart-day",children:r.dataLabel})]},i))})]})]},a._id))})]})})]})}export{$e as default};
//# sourceMappingURL=Perfil-COKaKFWk.js.map
