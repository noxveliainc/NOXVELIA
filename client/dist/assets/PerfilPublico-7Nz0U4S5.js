import{d as z,b as N,r as a,j as t,c as C}from"./index-W-wvA4Qe.js";import{S as P}from"./Seo-bxcOZPuy.js";import{b as S}from"./seo-DNd8R9iT.js";import{A}from"./AnuncioCard-taZ8Q-RK.js";import{o as E,P as V}from"./ProfileView-Lonw5Bi6.js";import"./mdi-B2-VfyGs.js";function J(){var d,x;const{id:i}=z(),l=N(),[e,m]=a.useState(null),[r,b]=a.useState([]),[u,h]=a.useState(!0),[c,y]=a.useState(""),[w,f]=a.useState(!1);a.useEffect(()=>{let o=!0;return(async()=>{try{const{data:p}=await C.get(`/users/vendedor/${i}`);if(!o)return;m(p.vendedor),b(p.anuncios||[])}catch{o&&y("Erro ao carregar a montra do vendedor.")}finally{o&&h(!1)}})(),()=>{o=!1}},[i]);const k=()=>{const o=window.location.href;navigator.clipboard.writeText(o),f(!0),setTimeout(()=>f(!1),2e3)};if(u)return t.jsx("div",{style:{minHeight:"calc(100vh - 80px)",display:"flex",alignItems:"center",justifyContent:"center",background:"#f8fafc"},children:t.jsx("div",{className:"nx-spinner",style:{borderColor:"#e2e8f0",borderTopColor:"#0f172a"}})});if(c)return t.jsxs("div",{style:{minHeight:"calc(100vh - 80px)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:"#f8fafc",color:"#0f172a"},children:[t.jsx("p",{style:{color:"#64748b",marginBottom:"24px",fontSize:"15px"},children:c}),t.jsx("button",{onClick:()=>l(-1),style:{padding:"12px 24px",background:"#0f172a",color:"#fff",border:"none",borderRadius:"8px",fontWeight:700,cursor:"pointer"},children:"Voltar a pesquisa"})]});(d=e==null?void 0:e.nome)!=null&&d.charAt(0).toUpperCase();const n=(e==null?void 0:e.tipo)==="admin";n||(e==null||e.premiumAtivo);const s=n?e.nome.toUpperCase().includes("NOXVELIA")?e.nome:`NOXVELIA ${e.nome}`:e==null?void 0:e.nome,j=(e==null?void 0:e.tipoConta)==="profissional"||n;(x=e==null?void 0:e.telefone)==null||x.replace(/\D/g,"");const v=E(e);return t.jsxs(t.Fragment,{children:[t.jsx(P,{title:`${s} — vendedor na Noxvelia`,description:((e==null?void 0:e.bio)||`Consulta os anúncios de ${s} na Noxvelia.`).slice(0,160),path:`/vendedor/${i}`,image:(e==null?void 0:e.avatarUrl)||void 0,type:"profile",jsonLd:{"@context":"https://schema.org","@type":j?"Organization":"Person",name:s,description:e==null?void 0:e.bio,image:e==null?void 0:e.avatarUrl,url:S(`/vendedor/${i}`)}}),t.jsx("style",{children:`
      ...
      `}),t.jsxs("div",{className:"pp-root",children:[t.jsxs("div",{className:"pp-hero",children:[t.jsx("div",{className:"pp-cover",children:(e==null?void 0:e.capaUrl)&&t.jsx("img",{src:e.capaUrl,alt:""})}),t.jsxs("div",{className:"pp-hero-content",children:[t.jsx("button",{onClick:()=>l(-1),className:"pp-back",children:"Voltar atras"}),t.jsx(V,{user:e,isOwner:!1,totalImoveis:r.filter(o=>o.tipo==="imovel").length,totalCarros:r.filter(o=>o.tipo==="carro").length,links:v,onShare:k,linkCopiado:w}),!1]})]}),t.jsxs("div",{className:"pp-main",children:[t.jsxs("div",{className:"pp-section-header",children:[t.jsx("h2",{className:"pp-section-title",children:"Portfolio de Ativos"}),t.jsxs("div",{className:"pp-count",children:[r.length," Disponiveis"]})]}),t.jsx("div",{className:"pp-grid",children:r.map(o=>{const g=o!=null&&o.utilizador&&typeof o.utilizador=="object"?o.utilizador:e;return t.jsx(A,{anuncio:{...o,utilizador:g},forceSellerIdentity:!0},o._id)})})]})]})]})}export{J as default};
