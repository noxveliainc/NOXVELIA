import{C as e,N as t,S as n,j as r,k as i,w as a}from"./index-DvzIvgaI.js";var o=t(r(),1),s=n();function c(){let{token:t}=i(),[n,r]=(0,o.useState)(`a_verificar`),[c,l]=(0,o.useState)(``);return(0,o.useEffect)(()=>{t&&(async()=>{try{let n=await e.get(`/auth/verify-email/${t}`);l(n.data?.mensagem||`Email verificado com sucesso!`),r(`sucesso`)}catch(e){l(e.response?.data?.erro||`Não foi possível verificar o teu email.`),r(`erro`)}})()},[t]),(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(`style`,{children:`
        .auth-root {
