import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{n as t,t as n}from"./jsx-runtime-BX1tsrJU.js";import{C as r,T as i,g as a,k as o}from"./index-ivs6hXma.js";import{Xt as s,et as c,o as l,ut as u}from"./mdi-CokkA71s.js";import{t as d}from"./AnuncioCard-BA99-ciy.js";var f=e(t(),1),p=s(),m=n();function h(){let[e,t]=(0,f.useState)([]),[n,s]=(0,f.useState)(!0),[h,g]=(0,f.useState)(``),_=o(),v=(localStorage.getItem(`@App:contexto_visual`)||`carro`)===`carro`,y=v?`/carros`:`/imoveis`,b=v?`automóveis`:`imóveis`;return(0,f.useEffect)(()=>{(async()=>{try{let{data:e}=await r.get(`/anuncios/favoritos`);t(e||[])}catch(e){console.error(e),g(`Não foi possível carregar a tua lista de favoritos.`)}finally{s(!1)}})()},[]),n?(0,m.jsx)(a,{label:`A carregar favoritos`,detail:`Estamos a reunir os anúncios que guardaste.`,minHeight:`calc(100vh - 72px)`,tone:`light`}):(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(`style`,{children:`
        .fav-outer {
          background: #ffffff;
