import{d as h,r as i,j as e,L as x,c as u}from"./index-CE1zdK-t.js";function p(){const{token:r}=h(),[a,o]=i.useState("a_verificar"),[n,s]=i.useState("");return i.useEffect(()=>{r&&(async()=>{var c,l,d;try{const t=await u.get(`/auth/verify-email/${r}`);s(((c=t.data)==null?void 0:c.mensagem)||"Email verificado com sucesso!"),o("sucesso")}catch(t){s(((d=(l=t.response)==null?void 0:l.data)==null?void 0:d.erro)||"Não foi possível verificar o teu email."),o("erro")}})()},[r]),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        .auth-root {
...
//# sourceMappingURL=VerificarEmail-DDBqNaLX.js.map
