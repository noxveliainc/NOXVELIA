import{A as e,E as t,O as n,T as r,b as i,p as a,y as o}from"./index-C4H3Y4wR.js";import{Rt as s}from"./mdi-BBApqC-c.js";import{n as c}from"./seo-BmrZTbI5.js";import{t as l}from"./Seo-DilJ5Ih4.js";import{t as u}from"./AnuncioCard-CTTu4HRU.js";import{n as d,t as f}from"./ProfileView-Cre1f5fB.js";var p=e(n(),1);s();var m=o();function h(){let{id:e}=t(),n=r(),[o,s]=(0,p.useState)(null),[h,g]=(0,p.useState)([]),[_,v]=(0,p.useState)(!0),[y,b]=(0,p.useState)(``),[x,S]=(0,p.useState)(!1);(0,p.useEffect)(()=>{let t=!0;return(async()=>{try{let{data:n}=await i.get(`/users/vendedor/${e}`);if(!t)return;s(n.vendedor),g(n.anuncios||[])}catch{t&&b(`Erro ao carregar a montra do vendedor.`)}finally{t&&v(!1)}})(),()=>{t=!1}},[e]);let C=()=>{let e=window.location.href;navigator.clipboard.writeText(e),S(!0),setTimeout(()=>S(!1),2e3)};if(_)return(0,m.jsx)(a,{label:`A carregar vendedor`,detail:`Estamos a preparar a montra pública.`,minHeight:`calc(100vh - 80px)`,tone:`light`});if(y)return(0,m.jsxs)(`div`,{style:{minHeight:`calc(100vh - 80px)`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,background:`#f8fafc`,color:`#0f172a`},children:[(0,m.jsx)(`p`,{style:{color:`#64748b`,marginBottom:`24px`,fontSize:`15px`},children:y}),(0,m.jsx)(`button`,{onClick:()=>n(-1),style:{padding:`12px 24px`,background:`#0f172a`,color:`#fff`,border:`none`,borderRadius:`8px`,fontWeight:700,cursor:`pointer`},children:`Voltar a pesquisa`})]});o?.nome?.charAt(0).toUpperCase();let w=o?.tipo===`admin`;w||o?.premiumAtivo;let T=w?o.nome.toUpperCase().includes(`NOXVELIA`)?o.nome:`NOXVELIA ${o.nome}`:o?.nome,E=o?.tipoConta===`profissional`||w;o?.mostrarTelefonePublico!==!1&&o?.telefone?.replace(/\D/g,``);let D=d(o);return(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(l,{title:`${T} — vendedor na Noxvelia`,description:(o?.bio||`Consulta os anúncios de ${T} na Noxvelia.`).slice(0,160),path:`/vendedor/${e}`,image:o?.avatarUrl||void 0,type:`profile`,jsonLd:{"@context":`https://schema.org`,"@type":E?`Organization`:`Person`,name:T,description:o?.bio,image:o?.avatarUrl,url:c(`/vendedor/${e}`)}}),(0,m.jsx)(`style`,{children:`
      ...
      `}),(0,m.jsxs)(`div`,{className:`pp-root`,children:[(0,m.jsxs)(`div`,{className:`pp-hero`,children:[(0,m.jsx)(`div`,{className:`pp-cover`,children:o?.capaUrl&&(0,m.jsx)(`img`,{src:o.capaUrl,alt:``})}),(0,m.jsxs)(`div`,{className:`pp-hero-content`,children:[(0,m.jsx)(`button`,{onClick:()=>n(-1),className:`pp-back`,children:`Voltar atras`}),(0,m.jsx)(f,{user:o,isOwner:!1,totalImoveis:h.filter(e=>e.tipo===`imovel`).length,totalCarros:h.filter(e=>e.tipo===`carro`).length,links:D,onShare:C,linkCopiado:x}),!1]})]}),(0,m.jsxs)(`div`,{className:`pp-main`,children:[(0,m.jsxs)(`div`,{className:`pp-section-header`,children:[(0,m.jsx)(`h2`,{className:`pp-section-title`,children:`Portfolio de Ativos`}),(0,m.jsxs)(`div`,{className:`pp-count`,children:[h.length,` disponíveis`]})]}),(0,m.jsx)(`div`,{className:`pp-grid`,children:h.map(e=>{let t=e?.utilizador&&typeof e.utilizador==`object`?e.utilizador:o;return(0,m.jsx)(u,{anuncio:{...e,utilizador:t},forceSellerIdentity:!0},e._id)})})]})]})]})}export{h as default};