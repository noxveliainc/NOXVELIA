const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/MapaResultados-Boz2rp45.js","assets/jsx-runtime-On9Szgki.js","assets/index-D7drDp8n.js","assets/index--Ypj7r0Q.css","assets/MapaResultados-CcXJxNtP.css"])))=>i.map(i=>d[i]);
import{g as e,l as t,t as n,u as r,y as i}from"./jsx-runtime-On9Szgki.js";import{D as ee,E as a,S as o,T as s,t as c,w as l}from"./index-D7drDp8n.js";import{Ft as u,T as d,U as f,b as p,bt as te,c as ne,h as re,it as ie,jt as ae,nt as oe,x as se}from"./mdi-CnOwmxTs.js";import{t as ce}from"./Seo-DhJJO7_e.js";import{t as le}from"./AnuncioCard-Cifr09sf.js";import{t as ue}from"./GoogleAdSlot-Dm7V1JRV.js";import{t as de}from"./SponsorBanner-CPzLdeoW.js";import{i as fe,n as pe,r as m,t as me}from"./localizacoes-CvOZjRrK.js";var h=i(e(),1);function he(e,t){let[n,r]=(0,h.useState)(e);return(0,h.useEffect)(()=>{let n=setTimeout(()=>{r(e)},t);return()=>{clearTimeout(n)}},[e,t]),n}var g=u(),_=n(),ge=[`T0`,`T1`,`T2`,`T3`,`T4`,`T5+`],_e=[{value:`apartamento`,label:`Apartamento`},{value:`moradia`,label:`Moradia`},{value:`terreno`,label:`Terreno`},{value:`loja`,label:`Loja`},{value:`escritorio`,label:`Escritorio`}],ve=[`Gasolina`,`Diesel`,`Eléctrico`,`Híbrido`,`GPL`],ye=[`Manual`,`Automático`],be=(0,h.lazy)(()=>c(()=>import(`./MapaResultados-Boz2rp45.js`),__vite__mapDeps([0,1,2,3,4]))),v=e=>String(e||``).split(`,`).map(e=>e.trim()).filter(Boolean);function xe({tipoPadrao:e=`imovel`,seoParams:n=null}){let[i]=ee(),c=t(),u=r(),{signed:xe}=l(),y=c.pathname.includes(`carro`)?`carro`:e||`imovel`,b=i.toString(),x=n?.toString()||``,S=(0,h.useMemo)(()=>({search:new URLSearchParams(b),seo:x?new URLSearchParams(x):null}),[b,x]),C=(0,h.useCallback)(e=>S.seo?.get(e)||S.search.get(e)||``,[S]),Se=C(`marca`),w=y===`carro`&&m.includes(Se)?Se:``,T=C(`q`),E=(0,h.useCallback)(()=>({tipo:y,precoMin:``,precoMax:C(`precoMax`),distrito:C(`distrito`)||`Todos`,cidade:C(`cidade`),marca:w,modelo:C(`modelo`),tiposImovel:v(C(`tipoImovel`)),tipologias:v(C(`tipologia`)),combustiveis:v(C(`combustivel`)),transmissao:v(C(`transmissao`))}),[C,w,y]),D=(0,h.useMemo)(()=>E(),[E]),Ce=o(c,y===`carro`?`/carros`:`/imoveis`),[O,k]=(0,h.useState)([]),[we,Te]=(0,h.useState)([]),[A,Ee]=(0,h.useState)(!1),[De,Oe]=(0,h.useState)(!1),[j,M]=(0,h.useState)(null),[ke,Ae]=(0,h.useState)(0),[N,je]=(0,h.useState)(`relevancia`),[P,F]=(0,h.useState)(T),[I,L]=(0,h.useState)(!1),[Me,R]=(0,h.useState)(!1),[z,Ne]=(0,h.useState)(!0),[B,Pe]=(0,h.useState)(`grelha`),[Fe,Ie]=(0,h.useState)(!1),[V,H]=(0,h.useState)(``),[U,W]=(0,h.useState)(D),Le=(0,h.useRef)(null),G=(0,h.useRef)(!1),K=(0,h.useRef)(1),q=(0,h.useRef)(U),Re=(0,h.useRef)(N),ze=(0,h.useRef)(N),J=(0,h.useRef)(``),Be=(0,h.useRef)(!1),Y=he(P,300);(0,h.useEffect)(()=>{q.current=U},[U]),(0,h.useEffect)(()=>{Re.current=N},[N]),(0,h.useEffect)(()=>{let e=()=>R(e=>!e);return window.addEventListener(`toggle-filtros`,e),()=>window.removeEventListener(`toggle-filtros`,e)},[]);let Ve=(0,h.useCallback)(async()=>{try{let e=q.current,t=J.current,n=e.tipo||y,r=new URLSearchParams;r.set(`tipo`,n),e.distrito&&e.distrito!==`Todos`&&r.set(`distrito`,e.distrito),e.cidade&&r.set(`cidade`,e.cidade),e.tipologias.length&&r.set(`tipologia`,e.tipologias.join(`,`)),e.tiposImovel?.length&&r.set(`tipoImovel`,e.tiposImovel.join(`,`)),e.precoMax&&r.set(`precoMax`,e.precoMax),t&&t.trim()&&r.set(`q`,t.trim()),n===`carro`&&(e.marca&&r.set(`marca`,e.marca),e.modelo&&r.set(`modelo`,e.modelo),e.combustiveis.length&&r.set(`combustivel`,e.combustiveis.join(`,`)),e.transmissao.length&&r.set(`transmissao`,e.transmissao.join(`,`))),n===`imovel`&&e.tipologias.length&&r.set(`tipologia`,e.tipologias.join(`,`)),n===`imovel`&&e.tiposImovel?.length&&r.set(`tipoImovel`,e.tiposImovel.join(`,`));let{data:i}=await s.get(`/anuncios/pesquisa/mapa?${r.toString()}`);Te(Array.isArray(i)?i:[])}catch(e){console.warn(`Erro ao carregar mapa:`,e)}},[y]),X=(0,h.useCallback)(async(t,n=!1,r=null)=>{if(!G.current){G.current=!0,t===1?Ee(!0):Oe(!0),M(null);try{let i=q.current,ee=Re.current,a=J.current,o=new URLSearchParams,l=r||i.tipo;(!l||l===`undefined`)&&(l=c.pathname.includes(`carro`)?`carro`:e||`imovel`),o.set(`tipo`,l),o.set(`page`,t),o.set(`limit`,12),o.set(`sort`,ee),a&&a.trim()&&o.set(`q`,a.trim()),i.precoMax&&o.set(`precoMax`,i.precoMax),i.distrito&&i.distrito!==`Todos`&&o.set(`distrito`,i.distrito),i.cidade&&o.set(`cidade`,i.cidade),l===`carro`&&(i.marca&&o.set(`marca`,i.marca),i.modelo&&o.set(`modelo`,i.modelo),i.combustiveis.length&&o.set(`combustivel`,i.combustiveis.join(`,`)),i.transmissao.length&&o.set(`transmissao`,i.transmissao.join(`,`))),l===`imovel`&&i.tipologias.length&&o.set(`tipologia`,i.tipologias.join(`,`)),l===`imovel`&&i.tiposImovel?.length&&o.set(`tipoImovel`,i.tiposImovel.join(`,`));let{data:u}=await s.get(`/anuncios?${o.toString()}`),d=u.anuncios||(Array.isArray(u)?u:[]),f=u.totalAnuncios===void 0?d.length:u.totalAnuncios;k(n?e=>[...e,...d]:d),Ae(f);let p=d.length===12;L(p),p&&(K.current=t)}catch{M(`Falha ao atualizar dados.`),L(!1)}finally{Ee(!1),Oe(!1),G.current=!1}}},[e,c.pathname]);(0,h.useEffect)(()=>{q.current=D,W(D),R(!1),L(!1),k([]),F(T),J.current=T,K.current=1;let e=setTimeout(()=>{X(1,!1,y)},50);return()=>clearTimeout(e)},[y,D,T,X]),(0,h.useEffect)(()=>{if(ze.current===N)return;ze.current=N;let e=!1,t,n=()=>{if(!e){if(G.current){t=setTimeout(n,80);return}L(!1),k([]),K.current=1,X(1,!1,q.current.tipo)}};return n(),()=>{e=!0,clearTimeout(t)}},[N,X]),(0,h.useEffect)(()=>{if(J.current=Y,!Be.current){Be.current=!0;return}L(!1),k([]),K.current=1,X(1,!1,null)},[Y]),(0,h.useEffect)(()=>{if(B!==`mapa`)return;let e=setTimeout(()=>{Ve()},60);return()=>clearTimeout(e)},[y,U.distrito,U.cidade,U.precoMax,U.marca,U.modelo,U.tiposImovel,U.tipologias,U.combustiveis,U.transmissao,Y,Ve,B]),(0,h.useEffect)(()=>{if(!I||B===`mapa`)return;let e=new IntersectionObserver(e=>{if(e[0].isIntersecting){let e=K.current+1;X(e,!0,q.current.tipo)}},{rootMargin:`200px`,threshold:.1}),t=Le.current;return t&&e.observe(t),()=>e.disconnect()},[I,X,B]);let Z=(e,t)=>{W(n=>{let r=n[e]||[],i=r.includes(t)?r.filter(e=>e!==t):[...r,t];return{...n,[e]:i}})},He=()=>{L(!1),k([]),K.current=1,setTimeout(()=>{X(1,!1,q.current.tipo)},50),R(!1)},Ue=U.marca?fe(U.marca):[],We=U.distrito&&U.distrito!==`Todos`?pe[U.distrito]:[],Q=y===`carro`?`var(--nx-accent-car)`:`var(--nx-accent-home)`,$=[U.precoMax&&`Ate ${Number(U.precoMax).toLocaleString(`pt-PT`)} EUR`,U.distrito!==`Todos`&&U.distrito,U.cidade,U.marca,U.modelo,...(U.tiposImovel||[]).map(e=>_e.find(t=>t.value===e)?.label||e),...U.tipologias,...U.combustiveis,...U.transmissao,P.trim()&&`"${P.trim()}"`].filter(Boolean);return(0,_.jsxs)(_.Fragment,{children:[!n&&(0,_.jsx)(ce,{title:y===`carro`?`Carros usados e novos em Portugal | Noxvelia`:`Imóveis para venda em Portugal | Noxvelia`,description:y===`carro`?`Pesquisa carros usados e novos em Portugal por marca, modelo, preço e localização.`:`Pesquisa apartamentos, moradias e terrenos em Portugal por tipologia, preço e localização.`,path:y===`carro`?`/carros`:`/imoveis`}),(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(`style`,{children:`
        ...
        @media (max-width: 1024px) {
          ...
          .pesquisa-sidebar { position: fixed; top: 0; left: ${Me?`0`:`-100%`}; height: 100vh; max-height: 100vh; border-radius: 0; z-index: 9999; transition: left 0.3s ease; width: 85%; max-width: 360px; opacity: 1; }
          ...
          .sidebar-mobile-overlay { display: ${Me?`block`:`none`}; }
      ...
      `}),(0,_.jsxs)(`div`,{className:`pesquisa-root`,children:[(0,_.jsx)(`div`,{className:`sidebar-mobile-overlay`,onClick:()=>R(!1)}),(0,_.jsxs)(`div`,{className:`pesquisa-layout vista-${B}`,children:[(0,_.jsxs)(`aside`,{className:`pesquisa-sidebar${z?``:` collapsed`}`,children:[(0,_.jsxs)(`div`,{className:`pesquisa-sidebar-header`,children:[(0,_.jsx)(g.Icon,{path:f,size:1}),` Filtros Avançados`]}),(0,_.jsxs)(`div`,{className:`pesquisa-filter-group`,children:[(0,_.jsx)(`div`,{className:`pesquisa-filter-title`,children:`Orçamento Máximo (€)`}),(0,_.jsx)(`input`,{type:`number`,min:`0`,className:`pesquisa-filter-input`,placeholder:`Ex: 120000`,value:U.precoMax,onChange:e=>W(t=>({...t,precoMax:e.target.value}))})]}),(0,_.jsxs)(`div`,{className:`pesquisa-filter-group`,children:[(0,_.jsx)(`div`,{className:`pesquisa-filter-title`,children:`Distrito / Região`}),(0,_.jsxs)(`select`,{className:`pesquisa-filter-input`,value:U.distrito,onChange:e=>W(t=>({...t,distrito:e.target.value,cidade:``})),children:[(0,_.jsx)(`option`,{value:`Todos`,children:`Portugal (Todos)`}),me.map(e=>(0,_.jsx)(`option`,{value:e,children:e},e))]})]}),(0,_.jsxs)(`div`,{className:`pesquisa-filter-group`,children:[(0,_.jsx)(`div`,{className:`pesquisa-filter-title`,children:`Cidade / Concelho`}),(0,_.jsxs)(`select`,{className:`pesquisa-filter-input`,value:U.cidade,onChange:e=>W(t=>({...t,cidade:e.target.value})),disabled:!U.distrito||U.distrito===`Todos`,children:[(0,_.jsx)(`option`,{value:``,children:U.distrito&&U.distrito!==`Todos`?`Todas as Cidades`:`Escolhe o Distrito Primeiro`}),We.map(e=>(0,_.jsx)(`option`,{value:e,children:e},e))]})]}),y===`carro`?(0,_.jsxs)(_.Fragment,{children:[(0,_.jsxs)(`div`,{className:`pesquisa-filter-group`,children:[(0,_.jsx)(`div`,{className:`pesquisa-filter-title`,children:`Marca do Veículo`}),(0,_.jsxs)(`select`,{className:`pesquisa-filter-input`,value:U.marca,onChange:e=>W(t=>({...t,marca:e.target.value,modelo:``})),children:[(0,_.jsx)(`option`,{value:``,children:`Todas as Marcas`}),m.map(e=>(0,_.jsx)(`option`,{value:e,children:e},e))]})]}),(0,_.jsxs)(`div`,{className:`pesquisa-filter-group`,children:[(0,_.jsx)(`div`,{className:`pesquisa-filter-title`,children:`Modelo Específico`}),(0,_.jsxs)(`select`,{className:`pesquisa-filter-input`,value:U.modelo,onChange:e=>W(t=>({...t,modelo:e.target.value})),disabled:!U.marca,children:[(0,_.jsx)(`option`,{value:``,children:U.marca?`Todos os Modelos`:`Escolha a Marca Primeiro`}),Ue.map((e,t)=>{let n=typeof e==`object`?e.modelo||e.nome||``:e;return(0,_.jsx)(`option`,{value:n,children:n},`mod-${t}`)})]})]}),(0,_.jsxs)(`div`,{className:`pesquisa-filter-group`,children:[(0,_.jsx)(`div`,{className:`pesquisa-filter-title`,children:`Combustível`}),(0,_.jsx)(`div`,{className:`pesquisa-tags`,children:ve.map(e=>(0,_.jsx)(`button`,{type:`button`,className:`pesquisa-tag ${U.combustiveis.includes(e)?`active`:``}`,onClick:()=>Z(`combustiveis`,e),children:e},e))})]}),(0,_.jsxs)(`div`,{className:`pesquisa-filter-group`,children:[(0,_.jsx)(`div`,{className:`pesquisa-filter-title`,children:`Caixa / Transmissão`}),(0,_.jsx)(`div`,{className:`pesquisa-tags`,children:ye.map(e=>(0,_.jsx)(`button`,{type:`button`,className:`pesquisa-tag ${U.transmissao.includes(e)?`active`:``}`,onClick:()=>Z(`transmissao`,e),children:e},e))})]})]}):(0,_.jsxs)(_.Fragment,{children:[(0,_.jsxs)(`div`,{className:`pesquisa-filter-group`,children:[(0,_.jsx)(`div`,{className:`pesquisa-filter-title`,children:`Tipo de imovel`}),(0,_.jsx)(`div`,{className:`pesquisa-tags`,children:_e.map(e=>(0,_.jsx)(`button`,{type:`button`,className:`pesquisa-tag ${(U.tiposImovel||[]).includes(e.value)?`active`:``}`,onClick:()=>Z(`tiposImovel`,e.value),children:e.label},e.value))})]}),(0,_.jsxs)(`div`,{className:`pesquisa-filter-group`,children:[(0,_.jsx)(`div`,{className:`pesquisa-filter-title`,children:`Tipologias disponíveis`}),(0,_.jsx)(`div`,{className:`pesquisa-tags`,children:ge.map(e=>(0,_.jsx)(`button`,{type:`button`,className:`pesquisa-tag ${U.tipologias.includes(e)?`active`:``}`,onClick:()=>Z(`tipologias`,e),children:e},e))})]})]}),(0,_.jsx)(`button`,{type:`button`,className:`pesquisa-apply-btn`,onClick:He,children:`Aplicar Filtros`})]}),(0,_.jsx)(`button`,{type:`button`,className:`pesquisa-sidebar-toggle`,onClick:()=>Ne(e=>!e),title:z?`Ocultar filtros`:`Mostrar filtros`,children:(0,_.jsx)(g.Icon,{path:z?p:se,size:.9})}),(0,_.jsxs)(`main`,{className:`pesquisa-main-content`,children:[(0,_.jsxs)(`div`,{className:`pesquisa-search-row`,children:[(0,_.jsxs)(`button`,{type:`button`,className:`pesquisa-mobile-filter-btn`,onClick:()=>R(!0),children:[(0,_.jsx)(g.Icon,{path:f,size:.8}),`Filtros`]}),(0,_.jsxs)(`div`,{className:`pesquisa-omnibar-wrapper`,children:[(0,_.jsx)(g.Icon,{path:oe,size:.9,color:`var(--nx-text-sub)`,style:{marginRight:`12px`}}),(0,_.jsx)(`input`,{type:`text`,placeholder:y===`carro`?`Pesquisar por marca, modelo, versão...`:`Pesquisar por título, características...`,value:P,onChange:e=>F(e.target.value)}),A&&(0,_.jsx)(g.Icon,{path:`M12,4V2A10,10 0 0,0 2,12H4A8,8 0 0,1 12,4Z`,size:.9,color:Q,className:`animate-spin`})]})]}),(0,_.jsx)(`div`,{className:`pesquisa-active-row`,children:$.length>0?(0,_.jsxs)(_.Fragment,{children:[$.slice(0,7).map(e=>(0,_.jsxs)(`span`,{className:`pesquisa-active-chip`,children:[(0,_.jsx)(g.Icon,{path:te,size:.55}),` `,e]},e)),$.length>7&&(0,_.jsxs)(`span`,{className:`pesquisa-active-chip`,children:[`+`,$.length-7]}),(0,_.jsxs)(`button`,{type:`button`,className:`pesquisa-clear-btn`,onClick:()=>{let e={tipo:y,precoMin:``,precoMax:``,distrito:`Todos`,cidade:``,marca:``,modelo:``,tiposImovel:[],tipologias:[],combustiveis:[],transmissao:[]};q.current=e,W(e),F(``),J.current=``,L(!1),k([]),K.current=1,setTimeout(()=>{X(1,!1,y)},50)},children:[(0,_.jsx)(g.Icon,{path:d,size:.6}),` Limpar`]})]}):(0,_.jsxs)(`span`,{className:`pesquisa-active-chip`,style:{background:`#f8fafc`,color:`#64748b`,borderColor:`#e2e8f0`},children:[(0,_.jsx)(g.Icon,{path:re,size:.6}),` Exploração livre`]})}),j&&(0,_.jsx)(`div`,{style:{color:`var(--nx-danger)`,padding:`16px`,background:`rgba(239, 68, 68, 0.1)`,borderRadius:`8px`,fontSize:`14px`,fontWeight:500,border:`1px solid rgba(239, 68, 68, 0.2)`,marginBottom:`24px`},children:j}),(0,_.jsxs)(`div`,{className:`pesquisa-topbar`,children:[(0,_.jsx)(`div`,{className:`pesquisa-results-count`,children:A&&O.length===0?`A procurar...`:`${ke} registos`}),(0,_.jsxs)(`div`,{className:`pesquisa-view-tools`,children:[(0,_.jsxs)(`div`,{className:`pesquisa-view-switch`,"aria-label":`Alternar vista`,children:[(0,_.jsxs)(`button`,{type:`button`,className:B===`grelha`?`active`:``,onClick:()=>Pe(`grelha`),children:[(0,_.jsx)(g.Icon,{path:ae,size:.72}),` Grelha`]}),(0,_.jsxs)(`button`,{type:`button`,className:B===`mapa`?`active`:``,onClick:()=>Pe(`mapa`),children:[(0,_.jsx)(g.Icon,{path:ie,size:.72}),` Mapa`]})]}),(0,_.jsxs)(`button`,{type:`button`,className:`pesquisa-alert-btn`,onClick:async()=>{if(!xe){u(`/login`,{state:{from:`${c.pathname}${c.search}`}});return}Ie(!0),H(``);try{await s.post(`/alertas`,{tipo:y,filtros:{q:P.trim(),precoMax:U.precoMax,distrito:U.distrito,cidade:U.cidade,marca:U.marca,modelo:U.modelo,tipoImovel:U.tiposImovel,tipologias:U.tipologias,combustiveis:U.combustiveis,transmissao:U.transmissao}}),H(`Alerta criado. Vais receber notificacoes quando surgirem anuncios compativeis.`)}catch(e){H(e.response?.data?.erro||`Nao foi possivel guardar este alerta.`)}finally{Ie(!1)}},disabled:Fe,children:[(0,_.jsx)(g.Icon,{path:ne,size:.72}),Fe?`A guardar...`:`Criar alerta`]}),(0,_.jsxs)(`select`,{className:`pesquisa-sort`,value:N,onChange:e=>je(e.target.value),children:[(0,_.jsx)(`option`,{value:`relevancia`,style:{background:`var(--nx-bg-2)`},children:`Relevância`}),(0,_.jsx)(`option`,{value:`preco_asc`,style:{background:`var(--nx-bg-2)`},children:`Preço: Mais Baixo`}),(0,_.jsx)(`option`,{value:`preco_desc`,style:{background:`var(--nx-bg-2)`},children:`Preço: Mais Alto`})]})]})]}),V&&(0,_.jsx)(`div`,{className:`pesquisa-active-row`,style:{marginTop:`-12px`},children:(0,_.jsx)(`span`,{className:`pesquisa-alert-feedback`,children:V})}),(0,_.jsx)(de,{placement:`search_results_top`,vertical:y,className:`!my-6 !px-0`,fallback:(0,_.jsx)(ue,{placement:`search_results_top`,className:`!my-6 !px-0`,minHeight:96})}),B===`mapa`?(0,_.jsxs)(`div`,{className:`pesquisa-map-shell`,children:[(0,_.jsx)(h.Suspense,{fallback:(0,_.jsx)(`div`,{className:`pesquisa-map-loading`,children:`A carregar mapa...`}),children:(0,_.jsx)(be,{anuncios:we,tipo:y})}),we.length===0&&!A&&(0,_.jsx)(`div`,{className:`pesquisa-map-empty`,children:`Sem resultados com coordenadas para mostrar no mapa.`})]}):(0,_.jsxs)(`div`,{className:`pesquisa-grid`,children:[O.map(e=>(0,_.jsx)(le,{anuncio:e,showStatus:!1},e._id)),I&&!A&&O.length>0&&(0,_.jsxs)(`div`,{ref:Le,className:`infinite-spinner-container`,children:[(0,_.jsx)(`div`,{className:`infinite-dot-pulse`}),(0,_.jsx)(`div`,{className:`infinite-dot-pulse`}),(0,_.jsx)(`div`,{className:`infinite-dot-pulse`})]})]}),B===`grelha`&&De&&(0,_.jsxs)(`div`,{className:`infinite-spinner-container`,style:{marginTop:`24px`},children:[(0,_.jsx)(`div`,{className:`infinite-dot-pulse`}),(0,_.jsx)(`div`,{className:`infinite-dot-pulse`}),(0,_.jsx)(`div`,{className:`infinite-dot-pulse`})]}),B===`grelha`&&!A&&O.length===0&&(0,_.jsxs)(`div`,{className:`pesquisa-empty`,children:[(0,_.jsx)(`div`,{style:{fontSize:`32px`,color:`var(--nx-text-muted)`,marginBottom:`16px`},children:`∅`}),(0,_.jsx)(`h3`,{style:{fontFamily:`var(--nx-font-display)`,fontSize:`18px`,fontWeight:700,color:`var(--nx-text)`,margin:`0 0 8px 0`},children:y===`carro`?`Ainda não há carros ativos no Drive`:`Ainda não há imóveis ativos no Estate`}),(0,_.jsx)(`p`,{style:{fontSize:`14px`,margin:0},children:$.length>0?`Tenta limpar alguns filtros na barra lateral.`:`Quando houver anúncios ativos, aparecem aqui automaticamente.`}),(0,_.jsx)(a,{to:`/publicar`,state:Ce,className:`pesquisa-empty-action`,children:`Publicar anúncio`})]})]})]})]})]})]})}export{xe as t};