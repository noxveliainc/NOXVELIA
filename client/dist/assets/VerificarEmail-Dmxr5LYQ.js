import{d as e,g as t,t as n,y as r}from"./jsx-runtime-On9Szgki.js";import{E as i,T as a}from"./index-Bz-rM6TO.js";var o=r(t(),1),s=n();function c(){let{token:t}=e(),[n,r]=(0,o.useState)(`a_verificar`),[c,l]=(0,o.useState)(``);return(0,o.useEffect)(()=>{t&&(async()=>{try{let e=await a.get(`/auth/verify-email/${t}`);l(e.data?.mensagem||`Email verificado com sucesso!`),r(`sucesso`)}catch(e){l(e.response?.data?.erro||`Não foi possível verificar o teu email.`),r(`erro`)}})()},[t]),(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(`style`,{children:`
        .auth-root {
