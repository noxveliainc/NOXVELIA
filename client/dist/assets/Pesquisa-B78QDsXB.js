const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/MapaResultados-CoCyCQ0n.js","assets/jsx-runtime-On9Szgki.js","assets/index-Bm6yTU-b.js","assets/index-Cfo_4t-H.css","assets/MapaResultados-CcXJxNtP.css"])))=>i.map(i=>d[i]);
import{g as e,l as t,t as n,y as r}from"./jsx-runtime-On9Szgki.js";import{b as i,t as a,v as o}from"./index-Bm6yTU-b.js";import{L as s,Q as c,X as l,b as u,bt as d,dt as f,h as p,w as m,wt as h,x as ee}from"./mdi-CgcECdTh.js";import{t as te}from"./Seo-O6tS4bdd.js";import{t as ne}from"./AnuncioCard-D-njPkos.js";import{t as re}from"./GoogleAdSlot-LAswSfy6.js";import{t as ie}from"./SponsorBanner-BcZgD6f7.js";import{n as ae,t as g}from"./marcasModelos-CRXT0e16.js";import{n as oe,t as se}from"./localizacoes-9zKfqZul.js";var _=r(e(),1);function ce(e,t){let[n,r]=(0,_.useState)(e);return(0,_.useEffect)(()=>{let n=setTimeout(()=>{r(e)},t);return()=>{clearTimeout(n)}},[e,t]),n}var v=h(),y=n(),le=[`T0`,`T1`,`T2`,`T3`,`T4`,`T5+`],ue=[`Gasolina`,`Diesel`,`Eléctrico`,`Híbrido`,`GPL`],de=[`Manual`,`Automático`],fe=(0,_.lazy)(()=>a(()=>import(`./MapaResultados-CoCyCQ0n.js`),__vite__mapDeps([0,1,2,3,4])));function b({tipoPadrao:e=`imovel`,seoParams:n=null}){let[r]=i(),a=t(),h=a.pathname.includes(`carro`)?`carro`:e||`imovel`,b=r.get(`tipo`)||h,x=e=>n?.get(e)||r.get(e)||``,pe=x(`marca`),S=h===`carro`&&g.includes(pe)?pe:``,[C,w]=(0,_.useState)([]),[T,me]=(0,_.useState)([]),[E,he]=(0,_.useState)(!1),[ge,D]=(0,_.useState)(!1),[O,k]=(0,_.useState)(null),[_e,ve]=(0,_.useState)(0),[A,ye]=(0,_.useState)(`relevancia`),[j,M]=(0,_.useState)(``),[N,P]=(0,_.useState)(!1),[F,I]=(0,_.useState)(!1),[L,be]=(0,_.useState)(!0),[R,z]=(0,_.useState)(`grelha`),[B,V]=(0,_.useState)({tipo:b,precoMin:``,precoMax:``,distrito:`Todos`,cidade:x(`cidade`),marca:S,modelo:x(`modelo`),tipologias:x(`tipologia`)?[x(`tipologia`)]:[],combustiveis:[],transmissao:[]}),H=(0,_.useRef)(null),U=(0,_.useRef)(!1),W=(0,_.useRef)(1),G=(0,_.useRef)(B),K=(0,_.useRef)(A),xe=(0,_.useRef)(A),q=(0,_.useRef)(``),J=(0,_.useRef)(!1),Y=ce(j,300);(0,_.useEffect)(()=>{G.current=B},[B]),(0,_.useEffect)(()=>{K.current=A},[A]),(0,_.useEffect)(()=>{let e=()=>I(e=>!e);return window.addEventListener(`toggle-filtros`,e),()=>window.removeEventListener(`toggle-filtros`,e)},[]);let Se=(0,_.useCallback)(async()=>{try{let e=G.current,t=q.current,n=e.tipo||h,r=new URLSearchParams;r.set(`tipo`,n),e.distrito&&e.distrito!==`Todos`&&r.set(`distrito`,e.distrito),e.cidade&&r.set(`cidade`,e.cidade),e.tipologias.length&&r.set(`tipologia`,e.tipologias.join(`,`)),e.precoMax&&r.set(`precoMax`,e.precoMax),t&&t.trim()&&r.set(`q`,t.trim()),n===`carro`&&(e.marca&&r.set(`marca`,e.marca),e.modelo&&r.set(`modelo`,e.modelo),e.combustiveis.length&&r.set(`combustivel`,e.combustiveis.join(`,`)),e.transmissao.length&&r.set(`transmissao`,e.transmissao.join(`,`))),n===`imovel`&&e.tipologias.length&&r.set(`tipologia`,e.tipologias.join(`,`));let{data:i}=await o.get(`/anuncios/pesquisa/mapa?${r.toString()}`);me(Array.isArray(i)?i:[])}catch(e){console.warn(`Erro ao carregar mapa:`,e)}},[h]),X=(0,_.useCallback)(async(t,n=!1,r=null)=>{if(!U.current){U.current=!0,t===1?he(!0):D(!0),k(null);try{let i=G.current,s=K.current,c=q.current,l=new URLSearchParams,u=r||i.tipo;(!u||u===`undefined`)&&(u=a.pathname.includes(`carro`)?`carro`:e||`imovel`),l.set(`tipo`,u),l.set(`page`,t),l.set(`limit`,12),l.set(`sort`,s),c&&c.trim()&&l.set(`q`,c.trim()),i.precoMax&&l.set(`precoMax`,i.precoMax),i.distrito&&i.distrito!==`Todos`&&l.set(`distrito`,i.distrito),i.cidade&&l.set(`cidade`,i.cidade),u===`carro`&&(i.marca&&l.set(`marca`,i.marca),i.modelo&&l.set(`modelo`,i.modelo),i.combustiveis.length&&l.set(`combustivel`,i.combustiveis.join(`,`)),i.transmissao.length&&l.set(`transmissao`,i.transmissao.join(`,`))),u===`imovel`&&i.tipologias.length&&l.set(`tipologia`,i.tipologias.join(`,`));let{data:d}=await o.get(`/anuncios?${l.toString()}`),f=d.anuncios||(Array.isArray(d)?d:[]),p=d.totalAnuncios===void 0?f.length:d.totalAnuncios;w(n?e=>[...e,...f]:f),ve(p);let m=f.length===12;P(m),m&&(W.current=t)}catch{k(`Falha ao atualizar dados.`),P(!1)}finally{he(!1),D(!1),U.current=!1}}},[e,a.pathname]);(0,_.useEffect)(()=>{let e={...G.current,tipo:h,marca:S,modelo:``,cidade:``,tipologias:[],combustiveis:[],transmissao:[]};G.current=e,V(e),I(!1),P(!1),w([]),M(``),q.current=``,W.current=1;let t=setTimeout(()=>{X(1,!1,h)},50);return()=>clearTimeout(t)},[h,S,X]),(0,_.useEffect)(()=>{if(xe.current===A)return;xe.current=A;let e=!1,t,n=()=>{if(!e){if(U.current){t=setTimeout(n,80);return}P(!1),w([]),W.current=1,X(1,!1,G.current.tipo)}};return n(),()=>{e=!0,clearTimeout(t)}},[A,X]),(0,_.useEffect)(()=>{if(q.current=Y,!J.current){J.current=!0;return}P(!1),w([]),W.current=1,X(1,!1,null)},[Y]),(0,_.useEffect)(()=>{if(R!==`mapa`)return;let e=setTimeout(()=>{Se()},60);return()=>clearTimeout(e)},[h,B.distrito,B.cidade,B.precoMax,B.marca,B.modelo,B.tipologias,B.combustiveis,B.transmissao,Y,Se,R]),(0,_.useEffect)(()=>{if(!N||R===`mapa`)return;let e=new IntersectionObserver(e=>{if(e[0].isIntersecting){let e=W.current+1;X(e,!0,G.current.tipo)}},{rootMargin:`200px`,threshold:.1}),t=H.current;return t&&e.observe(t),()=>e.disconnect()},[N,X,R]);let Z=(e,t)=>{V(n=>{let r=n[e]||[],i=r.includes(t)?r.filter(e=>e!==t):[...r,t];return{...n,[e]:i}})},Ce=()=>{P(!1),w([]),W.current=1,setTimeout(()=>{X(1,!1,G.current.tipo)},50),I(!1)},we=B.marca?ae(B.marca):[],Te=B.distrito&&B.distrito!==`Todos`?oe[B.distrito]:[],Q=h===`carro`?`var(--nx-accent-car)`:`var(--nx-accent-home)`,$=[B.precoMax&&`Ate ${Number(B.precoMax).toLocaleString(`pt-PT`)} EUR`,B.distrito!==`Todos`&&B.distrito,B.cidade,B.marca,B.modelo,...B.tipologias,...B.combustiveis,...B.transmissao,j.trim()&&`"${j.trim()}"`].filter(Boolean);return(0,y.jsxs)(y.Fragment,{children:[!n&&(0,y.jsx)(te,{title:h===`carro`?`Carros usados e novos em Portugal | Noxvelia`:`Imóveis para venda em Portugal | Noxvelia`,description:h===`carro`?`Pesquisa carros usados e novos em Portugal por marca, modelo, preço e localização.`:`Pesquisa apartamentos, moradias e terrenos em Portugal por tipologia, preço e localização.`,path:h===`carro`?`/carros`:`/imoveis`}),(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(`style`,{children:`
        ...
        @media (max-width: 1024px) {
          ...
          .pesquisa-sidebar { position: fixed; top: 0; left: ${F?`0`:`-100%`}; height: 100vh; max-height: 100vh; border-radius: 0; z-index: 9999; transition: left 0.3s ease; width: 85%; max-width: 360px; opacity: 1; }
