const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/MapaResultados-DoWCFgSc.js","assets/index-ChZw1uni.js","assets/index-CriyruYp.css","assets/images-io1S19E8.js","assets/MapaResultados-CcXJxNtP.css"])))=>i.map(i=>d[i]);
import{A as e,O as t,S as n,T as r,b as i,g as a,t as o,v as s,w as c,x as l,y as u}from"./index-ChZw1uni.js";import{C as d,Gt as f,O as p,Y as m,Yt as ee,ft as te,jt as ne,u as re,ut as ie,v as ae,w as oe}from"./mdi-SlS1KNfZ.js";import{t as se}from"./Seo-Cb0KkxFj.js";import{t as ce}from"./AnuncioCard-DUMRGzKN.js";import{t as le}from"./GoogleAdSlot-BpuWYwrB.js";import{i as ue,n as de,r as fe,t as pe}from"./localizacoes-CvOZjRrK.js";import{t as me}from"./funnelAnalytics-B2xZb7rD.js";var h=e(t(),1);function he(e,t){let[n,r]=(0,h.useState)(e);return(0,h.useEffect)(()=>{let n=setTimeout(()=>{r(e)},t);return()=>{clearTimeout(n)}},[e,t]),n}var g=ee(),_=u(),ge=[`T0`,`T1`,`T2`,`T3`,`T4`,`T5+`],_e=[{value:`apartamento`,label:`Apartamento`},{value:`moradia`,label:`Moradia`},{value:`terreno`,label:`Terreno`},{value:`loja`,label:`Loja`},{value:`escritorio`,label:`Escritorio`}],ve=[`Gasolina`,`Diesel`,`Eléctrico`,`Híbrido`,`GPL`],ye=[`Manual`,`Automático`],be=(0,h.lazy)(()=>o(()=>import(`./MapaResultados-DoWCFgSc.js`),__vite__mapDeps([0,1,2,3,4]))),v=e=>String(e||``).split(`,`).map(e=>e.trim()).filter(Boolean);function y({tipoPadrao:e=`imovel`,seoParams:t=null}){let[o]=n(),u=c(),ee=r(),{signed:y}=s(),b=u.pathname.includes(`carro`)?`carro`:e||`imovel`,x=o.toString(),S=t?.toString()||``,C=(0,h.useMemo)(()=>({search:new URLSearchParams(x),seo:S?new URLSearchParams(S):null}),[x,S]),w=(0,h.useCallback)(e=>C.seo?.get(e)||C.search.get(e)||``,[C]),xe=w(`marca`),Se=b===`carro`&&fe.includes(xe)?xe:``,T=w(`q`),Ce=(0,h.useCallback)(()=>({tipo:b,precoMin:``,precoMax:w(`precoMax`),distrito:w(`distrito`)||`Todos`,cidade:w(`cidade`),marca:Se,modelo:w(`modelo`),tiposImovel:v(w(`tipoImovel`)),tipologias:v(w(`tipologia`)),combustiveis:v(w(`combustivel`)),transmissao:v(w(`transmissao`))}),[w,Se,b]),E=(0,h.useMemo)(()=>Ce(),[Ce]),we=a(u,b===`carro`?`/carros`:`/imoveis`),[D,O]=(0,h.useState)([]),[k,Te]=(0,h.useState)([]),[A,j]=(0,h.useState)(!1),[Ee,De]=(0,h.useState)(!1),[M,Oe]=(0,h.useState)(null),[ke,Ae]=(0,h.useState)(0),[N,je]=(0,h.useState)(`relevancia`),[P,F]=(0,h.useState)(T),[I,L]=(0,h.useState)(!1),[R,z]=(0,h.useState)(!1),[B,Me]=(0,h.useState)(!0),[Ne,Pe]=(0,h.useState)(!1),[V,Fe]=(0,h.useState)(`grelha`),[Ie,Le]=(0,h.useState)(!1),[Re,H]=(0,h.useState)(``),[U,W]=(0,h.useState)(E),ze=(0,h.useRef)(null),G=(0,h.useRef)(!1),K=(0,h.useRef)(1),q=(0,h.useRef)(U),Be=(0,h.useRef)(N),Ve=(0,h.useRef)(N),J=(0,h.useRef)(``),He=(0,h.useRef)(!1),Y=he(P,300);(0,h.useEffect)(()=>{q.current=U},[U]),(0,h.useEffect)(()=>{Be.current=N},[N]),(0,h.useEffect)(()=>{let e=()=>z(e=>!e);return window.addEventListener(`toggle-filtros`,e),()=>window.removeEventListener(`toggle-filtros`,e)},[]),(0,h.useEffect)(()=>{let e=window.matchMedia(`(max-width: 1024px)`),t=()=>Pe(e.matches);return t(),e.addEventListener(`change`,t),()=>e.removeEventListener(`change`,t)},[]),(0,h.useEffect)(()=>{if(!R)return;let e=e=>{e.key===`Escape`&&z(!1)},t=document.body.style.overflow;return document.body.style.overflow=`hidden`,window.addEventListener(`keydown`,e),()=>{document.body.style.overflow=t,window.removeEventListener(`keydown`,e)}},[R]);let Ue=(0,h.useCallback)(async()=>{try{let e=q.current,t=J.current,n=e.tipo||b,r=new URLSearchParams;r.set(`tipo`,n),e.distrito&&e.distrito!==`Todos`&&r.set(`distrito`,e.distrito),e.cidade&&r.set(`cidade`,e.cidade),e.tipologias.length&&r.set(`tipologia`,e.tipologias.join(`,`)),e.tiposImovel?.length&&r.set(`tipoImovel`,e.tiposImovel.join(`,`)),e.precoMax&&r.set(`precoMax`,e.precoMax),t&&t.trim()&&r.set(`q`,t.trim()),n===`carro`&&(e.marca&&r.set(`marca`,e.marca),e.modelo&&r.set(`modelo`,e.modelo),e.combustiveis.length&&r.set(`combustivel`,e.combustiveis.join(`,`)),e.transmissao.length&&r.set(`transmissao`,e.transmissao.join(`,`))),n===`imovel`&&e.tipologias.length&&r.set(`tipologia`,e.tipologias.join(`,`)),n===`imovel`&&e.tiposImovel?.length&&r.set(`tipoImovel`,e.tiposImovel.join(`,`));let{data:a}=await i.get(`/anuncios/pesquisa/mapa?${r.toString()}`);Te(Array.isArray(a)?a:[])}catch(e){console.warn(`Erro ao carregar mapa:`,e)}},[b]),X=(0,h.useCallback)(async(t,n=!1,r=null)=>{if(!G.current){G.current=!0,t===1?j(!0):De(!0),Oe(null);try{let a=q.current,o=Be.current,s=J.current,c=new URLSearchParams,l=r||a.tipo;(!l||l===`undefined`)&&(l=u.pathname.includes(`carro`)?`carro`:e||`imovel`),c.set(`tipo`,l),c.set(`page`,t),c.set(`limit`,12),c.set(`sort`,o),s&&s.trim()&&c.set(`q`,s.trim()),a.precoMax&&c.set(`precoMax`,a.precoMax),a.distrito&&a.distrito!==`Todos`&&c.set(`distrito`,a.distrito),a.cidade&&c.set(`cidade`,a.cidade),l===`carro`&&(a.marca&&c.set(`marca`,a.marca),a.modelo&&c.set(`modelo`,a.modelo),a.combustiveis.length&&c.set(`combustivel`,a.combustiveis.join(`,`)),a.transmissao.length&&c.set(`transmissao`,a.transmissao.join(`,`))),l===`imovel`&&a.tipologias.length&&c.set(`tipologia`,a.tipologias.join(`,`)),l===`imovel`&&a.tiposImovel?.length&&c.set(`tipoImovel`,a.tiposImovel.join(`,`));let{data:d}=await i.get(`/anuncios?${c.toString()}`),f=d.anuncios||(Array.isArray(d)?d:[]),p=d.totalAnuncios===void 0?f.length:d.totalAnuncios;O(n?e=>[...e,...f]:f),Ae(p);let m=f.length===12;L(m),m&&(K.current=t)}catch{Oe(`Não conseguimos carregar novos anúncios neste momento.`),L(!1)}finally{j(!1),De(!1),G.current=!1}}},[e,u.pathname]);(0,h.useEffect)(()=>{q.current=E,W(E),z(!1),L(!1),O([]),F(T),J.current=T,K.current=1;let e=setTimeout(()=>{X(1,!1,b)},50);return()=>clearTimeout(e)},[b,E,T,X]),(0,h.useEffect)(()=>{if(Ve.current===N)return;Ve.current=N;let e=!1,t,n=()=>{if(!e){if(G.current){t=setTimeout(n,80);return}L(!1),O([]),K.current=1,X(1,!1,q.current.tipo)}};return n(),()=>{e=!0,clearTimeout(t)}},[N,X]),(0,h.useEffect)(()=>{if(J.current=Y,!He.current){He.current=!0;return}L(!1),O([]),K.current=1,X(1,!1,null)},[Y]),(0,h.useEffect)(()=>{if(V!==`mapa`)return;let e=setTimeout(()=>{Ue()},60);return()=>clearTimeout(e)},[b,U.distrito,U.cidade,U.precoMax,U.marca,U.modelo,U.tiposImovel,U.tipologias,U.combustiveis,U.transmissao,Y,Ue,V]),(0,h.useEffect)(()=>{if(!I||V===`mapa`)return;let e=new IntersectionObserver(e=>{if(e[0].isIntersecting){let e=K.current+1;X(e,!0,q.current.tipo)}},{rootMargin:`200px`,threshold:.1}),t=ze.current;return t&&e.observe(t),()=>e.disconnect()},[I,X,V]);let Z=(e,t)=>{W(n=>{let r=n[e]||[],i=r.includes(t)?r.filter(e=>e!==t):[...r,t];return{...n,[e]:i}})},We=()=>{me(`search_start`,{vertical:b}),L(!1),O([]),K.current=1,setTimeout(()=>{X(1,!1,q.current.tipo)},50),z(!1)},Ge=U.marca?ue(U.marca):[],Ke=U.distrito&&U.distrito!==`Todos`?de[U.distrito]:[],Q=b===`carro`?`var(--nx-accent-car)`:`var(--nx-accent-home)`,qe=Ne?!R:!B,$=[U.precoMax&&`Ate ${Number(U.precoMax).toLocaleString(`pt-PT`)} EUR`,U.distrito!==`Todos`&&U.distrito,U.cidade,U.marca,U.modelo,...(U.tiposImovel||[]).map(e=>_e.find(t=>t.value===e)?.label||e),...U.tipologias,...U.combustiveis,...U.transmissao,P.trim()&&`"${P.trim()}"`].filter(Boolean);return(0,_.jsxs)(_.Fragment,{children:[!t&&(0,_.jsx)(se,{title:b===`carro`?`Carros usados e novos em Portugal | Noxvelia`:`Imóveis para venda em Portugal | Noxvelia`,description:b===`carro`?`Pesquisa carros usados e novos em Portugal por marca, modelo, preço e localização.`:`Pesquisa apartamentos, moradias e terrenos em Portugal por tipologia, preço e localização.`,path:b===`carro`?`/carros`:`/imoveis`}),(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(`style`,{children:`
      ...
      `}),(0,_.jsxs)(`div`,{className:`pesquisa-root`,children:[(0,_.jsx)(`div`,{className:`sidebar-mobile-overlay`,onClick:()=>z(!1),"aria-hidden":`true`}),(0,_.jsxs)(`div`,{className:`pesquisa-layout vista-${V}`,children:[(0,_.jsxs)(`aside`,{className:`pesquisa-sidebar${B?``:` collapsed`}`,role:R?`dialog`:void 0,"aria-label":`Filtros de pesquisa`,"aria-modal":R?`true`:void 0,"aria-hidden":qe,inert:qe?``:void 0,children:[(0,_.jsxs)(`div`,{className:`pesquisa-sidebar-header`,children:[(0,_.jsxs)(`span`,{className:`pesquisa-sidebar-title`,children:[(0,_.jsx)(g.Icon,{path:m,size:1}),` Filtros`]}),(0,_.jsxs)(`button`,{type:`button`,className:`pesquisa-sidebar-close`,onClick:()=>z(!1),"aria-label":`Fechar filtros`,children:[(0,_.jsx)(g.Icon,{path:p,size:.85}),` Fechar`]})]}),(0,_.jsxs)(`div`,{className:`pesquisa-filter-group`,children:[(0,_.jsx)(`div`,{className:`pesquisa-filter-title`,children:`Orçamento Máximo (€)`}),(0,_.jsx)(`input`,{type:`number`,min:`0`,className:`pesquisa-filter-input`,placeholder:`Ex: 120000`,value:U.precoMax,onChange:e=>W(t=>({...t,precoMax:e.target.value}))})]}),(0,_.jsxs)(`div`,{className:`pesquisa-filter-group`,children:[(0,_.jsx)(`div`,{className:`pesquisa-filter-title`,children:`Distrito / Região`}),(0,_.jsxs)(`select`,{className:`pesquisa-filter-input`,value:U.distrito,onChange:e=>W(t=>({...t,distrito:e.target.value,cidade:``})),children:[(0,_.jsx)(`option`,{value:`Todos`,children:`Portugal (Todos)`}),pe.map(e=>(0,_.jsx)(`option`,{value:e,children:e},e))]})]}),(0,_.jsxs)(`div`,{className:`pesquisa-filter-group`,children:[(0,_.jsx)(`div`,{className:`pesquisa-filter-title`,children:`Cidade / Concelho`}),(0,_.jsxs)(`select`,{className:`pesquisa-filter-input`,value:U.cidade,onChange:e=>W(t=>({...t,cidade:e.target.value})),disabled:!U.distrito||U.distrito===`Todos`,children:[(0,_.jsx)(`option`,{value:``,children:U.distrito&&U.distrito!==`Todos`?`Todas as Cidades`:`Escolhe o Distrito Primeiro`}),Ke.map(e=>(0,_.jsx)(`option`,{value:e,children:e},e))]})]}),b===`carro`?(0,_.jsxs)(_.Fragment,{children:[(0,_.jsxs)(`div`,{className:`pesquisa-filter-group`,children:[(0,_.jsx)(`div`,{className:`pesquisa-filter-title`,children:`Marca do Veículo`}),(0,_.jsxs)(`select`,{className:`pesquisa-filter-input`,value:U.marca,onChange:e=>W(t=>({...t,marca:e.target.value,modelo:``})),children:[(0,_.jsx)(`option`,{value:``,children:`Todas as Marcas`}),fe.map(e=>(0,_.jsx)(`option`,{value:e,children:e},e))]})]}),(0,_.jsxs)(`div`,{className:`pesquisa-filter-group`,children:[(0,_.jsx)(`div`,{className:`pesquisa-filter-title`,children:`Modelo Específico`}),(0,_.jsxs)(`select`,{className:`pesquisa-filter-input`,value:U.modelo,onChange:e=>W(t=>({...t,modelo:e.target.value})),disabled:!U.marca,children:[(0,_.jsx)(`option`,{value:``,children:U.marca?`Todos os Modelos`:`Escolha a Marca Primeiro`}),Ge.map((e,t)=>{let n=typeof e==`object`?e.modelo||e.nome||``:e;return(0,_.jsx)(`option`,{value:n,children:n},`mod-${t}`)})]})]}),(0,_.jsxs)(`div`,{className:`pesquisa-filter-group`,children:[(0,_.jsx)(`div`,{className:`pesquisa-filter-title`,children:`Combustível`}),(0,_.jsx)(`div`,{className:`pesquisa-tags`,children:ve.map(e=>(0,_.jsx)(`button`,{type:`button`,className:`pesquisa-tag ${U.combustiveis.includes(e)?`active`:``}`,onClick:()=>Z(`combustiveis`,e),children:e},e))})]}),(0,_.jsxs)(`div`,{className:`pesquisa-filter-group`,children:[(0,_.jsx)(`div`,{className:`pesquisa-filter-title`,children:`Caixa / Transmissão`}),(0,_.jsx)(`div`,{className:`pesquisa-tags`,children:ye.map(e=>(0,_.jsx)(`button`,{type:`button`,className:`pesquisa-tag ${U.transmissao.includes(e)?`active`:``}`,onClick:()=>Z(`transmissao`,e),children:e},e))})]})]}):(0,_.jsxs)(_.Fragment,{children:[(0,_.jsxs)(`div`,{className:`pesquisa-filter-group`,children:[(0,_.jsx)(`div`,{className:`pesquisa-filter-title`,children:`Tipo de imovel`}),(0,_.jsx)(`div`,{className:`pesquisa-tags`,children:_e.map(e=>(0,_.jsx)(`button`,{type:`button`,className:`pesquisa-tag ${(U.tiposImovel||[]).includes(e.value)?`active`:``}`,onClick:()=>Z(`tiposImovel`,e.value),children:e.label},e.value))})]}),(0,_.jsxs)(`div`,{className:`pesquisa-filter-group`,children:[(0,_.jsx)(`div`,{className:`pesquisa-filter-title`,children:`Tipologias disponíveis`}),(0,_.jsx)(`div`,{className:`pesquisa-tags`,children:ge.map(e=>(0,_.jsx)(`button`,{type:`button`,className:`pesquisa-tag ${U.tipologias.includes(e)?`active`:``}`,onClick:()=>Z(`tipologias`,e),children:e},e))})]})]}),(0,_.jsx)(`button`,{type:`button`,className:`pesquisa-apply-btn`,onClick:We,children:`Aplicar Filtros`})]}),(0,_.jsx)(`button`,{type:`button`,className:`pesquisa-sidebar-toggle`,onClick:()=>Me(e=>!e),title:B?`Ocultar filtros`:`Mostrar filtros`,children:(0,_.jsx)(g.Icon,{path:B?d:oe,size:.9})}),(0,_.jsxs)(`main`,{className:`pesquisa-main-content`,children:[(0,_.jsxs)(`div`,{className:`pesquisa-search-row`,children:[(0,_.jsxs)(`button`,{type:`button`,className:`pesquisa-mobile-filter-btn`,onClick:()=>z(!0),children:[(0,_.jsx)(g.Icon,{path:m,size:.8}),`Filtros`]}),(0,_.jsxs)(`div`,{className:`pesquisa-omnibar-wrapper`,children:[(0,_.jsx)(g.Icon,{path:ie,size:.9,color:`var(--nx-text-sub)`,style:{marginRight:`12px`}}),(0,_.jsx)(`input`,{type:`text`,placeholder:b===`carro`?`Pesquisar por marca, modelo, versão...`:`Pesquisar por título, características...`,value:P,onChange:e=>F(e.target.value)}),A&&(0,_.jsx)(g.Icon,{path:`M12,4V2A10,10 0 0,0 2,12H4A8,8 0 0,1 12,4Z`,size:.9,color:Q,className:`animate-spin`})]})]}),(0,_.jsx)(`div`,{className:`pesquisa-active-row`,children:$.length>0?(0,_.jsxs)(_.Fragment,{children:[$.slice(0,7).map(e=>(0,_.jsxs)(`span`,{className:`pesquisa-active-chip`,children:[(0,_.jsx)(g.Icon,{path:ne,size:.55}),` `,e]},e)),$.length>7&&(0,_.jsxs)(`span`,{className:`pesquisa-active-chip`,children:[`+`,$.length-7]}),(0,_.jsxs)(`button`,{type:`button`,className:`pesquisa-clear-btn`,onClick:()=>{let e={tipo:b,precoMin:``,precoMax:``,distrito:`Todos`,cidade:``,marca:``,modelo:``,tiposImovel:[],tipologias:[],combustiveis:[],transmissao:[]};q.current=e,W(e),F(``),J.current=``,L(!1),O([]),K.current=1,setTimeout(()=>{X(1,!1,b)},50)},children:[(0,_.jsx)(g.Icon,{path:p,size:.6}),` Limpar`]})]}):(0,_.jsxs)(`span`,{className:`pesquisa-active-chip`,style:{background:`#f8fafc`,color:`#64748b`,borderColor:`#e2e8f0`},children:[(0,_.jsx)(g.Icon,{path:ae,size:.6}),` Exploração livre`]})}),M&&(0,_.jsx)(`div`,{style:{color:`#92400e`,padding:`16px`,background:`rgba(245, 158, 11, 0.1)`,borderRadius:`8px`,fontSize:`14px`,fontWeight:600,border:`1px solid rgba(245, 158, 11, 0.22)`,marginBottom:`24px`},children:M}),(0,_.jsxs)(`div`,{className:`pesquisa-topbar`,children:[(0,_.jsx)(`div`,{className:`pesquisa-results-count`,children:A&&D.length===0?`A procurar...`:`${ke} registos`}),(0,_.jsxs)(`div`,{className:`pesquisa-view-tools`,children:[(0,_.jsxs)(`div`,{className:`pesquisa-view-switch`,"aria-label":`Alternar vista`,children:[(0,_.jsxs)(`button`,{type:`button`,className:V===`grelha`?`active`:``,onClick:()=>Fe(`grelha`),children:[(0,_.jsx)(g.Icon,{path:f,size:.72}),` Grelha`]}),(0,_.jsxs)(`button`,{type:`button`,className:V===`mapa`?`active`:``,onClick:()=>Fe(`mapa`),children:[(0,_.jsx)(g.Icon,{path:te,size:.72}),` Mapa`]})]}),(0,_.jsxs)(`button`,{type:`button`,className:`pesquisa-alert-btn`,onClick:async()=>{if(!y){ee(`/login`,{state:{from:`${u.pathname}${u.search}`}});return}Le(!0),H(``);try{await i.post(`/alertas`,{tipo:b,filtros:{q:P.trim(),precoMax:U.precoMax,distrito:U.distrito,cidade:U.cidade,marca:U.marca,modelo:U.modelo,tipoImovel:U.tiposImovel,tipologias:U.tipologias,combustiveis:U.combustiveis,transmissao:U.transmissao}}),H(`Alerta criado. Vais receber notificacoes quando surgirem anuncios compativeis.`)}catch(e){H(e.response?.data?.erro||`Nao foi possivel guardar este alerta.`)}finally{Le(!1)}},disabled:Ie,children:[(0,_.jsx)(g.Icon,{path:re,size:.72}),Ie?`A guardar...`:`Criar alerta`]}),(0,_.jsxs)(`select`,{className:`pesquisa-sort`,value:N,onChange:e=>je(e.target.value),children:[(0,_.jsx)(`option`,{value:`relevancia`,style:{background:`var(--nx-bg-2)`},children:`Relevância`}),(0,_.jsx)(`option`,{value:`preco_asc`,style:{background:`var(--nx-bg-2)`},children:`Preço: Mais Baixo`}),(0,_.jsx)(`option`,{value:`preco_desc`,style:{background:`var(--nx-bg-2)`},children:`Preço: Mais Alto`})]})]})]}),Re&&(0,_.jsx)(`div`,{className:`pesquisa-active-row`,style:{marginTop:`-12px`},children:(0,_.jsx)(`span`,{className:`pesquisa-alert-feedback`,children:Re})}),(0,_.jsx)(le,{placement:`search_results_top`,className:`!my-6 !px-0`,minHeight:96}),V===`mapa`?(0,_.jsxs)(`div`,{className:`pesquisa-map-shell`,children:[(0,_.jsx)(h.Suspense,{fallback:(0,_.jsx)(`div`,{className:`pesquisa-map-loading`,children:`A carregar mapa...`}),children:(0,_.jsx)(be,{anuncios:k,tipo:b})}),k.length===0&&!A&&(0,_.jsx)(`div`,{className:`pesquisa-map-empty`,children:`Sem resultados com coordenadas para mostrar no mapa.`})]}):(0,_.jsxs)(`div`,{className:`pesquisa-grid`,children:[D.map(e=>(0,_.jsx)(ce,{anuncio:e,showStatus:!1},e._id)),I&&!A&&D.length>0&&(0,_.jsxs)(`div`,{ref:ze,className:`infinite-spinner-container`,children:[(0,_.jsx)(`div`,{className:`infinite-dot-pulse`}),(0,_.jsx)(`div`,{className:`infinite-dot-pulse`}),(0,_.jsx)(`div`,{className:`infinite-dot-pulse`})]})]}),V===`grelha`&&Ee&&(0,_.jsxs)(`div`,{className:`infinite-spinner-container`,style:{marginTop:`24px`},children:[(0,_.jsx)(`div`,{className:`infinite-dot-pulse`}),(0,_.jsx)(`div`,{className:`infinite-dot-pulse`}),(0,_.jsx)(`div`,{className:`infinite-dot-pulse`})]}),V===`grelha`&&!A&&D.length===0&&(0,_.jsxs)(`div`,{className:`pesquisa-empty`,children:[(0,_.jsx)(`div`,{style:{fontSize:`32px`,color:`var(--nx-text-muted)`,marginBottom:`16px`},children:`∅`}),(0,_.jsx)(`h3`,{style:{fontFamily:`var(--nx-font-display)`,fontSize:`18px`,fontWeight:700,color:`var(--nx-text)`,margin:`0 0 8px 0`},children:M?`Pesquisa temporariamente indisponível`:b===`carro`?`Ainda não há carros publicados`:`Ainda não há imóveis publicados`}),(0,_.jsx)(`p`,{style:{fontSize:`14px`,margin:0},children:M?`Tenta novamente daqui a instantes.`:$.length>0?`Tenta limpar alguns filtros.`:`Assim que entrarem anúncios, aparecem aqui.`}),M?(0,_.jsx)(`button`,{type:`button`,className:`pesquisa-empty-action`,onClick:()=>X(1,!1,b),children:`Tentar novamente`}):(0,_.jsx)(l,{to:`/publicar`,state:we,className:`pesquisa-empty-action`,children:`Publicar anúncio`})]})]})]})]})]})]})}export{y as t};