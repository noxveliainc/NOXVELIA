import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{A as t,C as n,M as r,S as i,T as a}from"./index-kkI1nqHu.js";var o=e(r(),1),s=i();function c(){let{token:e}=t(),[r,i]=(0,o.useState)(`a_verificar`),[c,l]=(0,o.useState)(``);return(0,o.useEffect)(()=>{e&&(async()=>{try{let t=await n.get(`/auth/verify-email/${e}`);l(t.data?.mensagem||`Email verificado com sucesso!`),i(`sucesso`)}catch(e){l(e.response?.data?.erro||`Não foi possível verificar o teu email.`),i(`erro`)}})()},[e]),(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(`style`,{children:`
        .auth-root {
