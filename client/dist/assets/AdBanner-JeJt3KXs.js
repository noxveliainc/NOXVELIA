import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{n as t,t as n}from"./jsx-runtime-BX1tsrJU.js";import{S as r,a as i,i as a,l as o,n as s,o as c,r as l,s as u,u as d,w as f}from"./index-Dovl1ubN.js";var p=e(t(),1);function m(){let[e,t]=(0,p.useState)(()=>d());return(0,p.useEffect)(()=>{let e=e=>{t(e?.detail||d())},n=e=>{e.key===`noxvelia_cookies_accepted`&&t(d())};return window.addEventListener(o,e),window.addEventListener(`storage`,n),()=>{window.removeEventListener(o,e),window.removeEventListener(`storage`,n)}},[]),e}var h=n();function g({placement:e,adsensePlacement:t=e,vertical:n=``,mode:o=`hybrid`,className:d=``,minHeight:g=96,mobileMinHeight:v=Math.min(g,56),format:y=`auto`,variant:b=`full`,showEmpty:x=!0}){let S=m(),C=(0,p.useRef)(null),w=(0,p.useRef)(null),T=(0,p.useRef)(!1),E=(0,p.useRef)(``),[D,O]=(0,p.useState)(null),[k,A]=(0,p.useState)(o!==`adsense`),[j,M]=(0,p.useState)(!1),N=c(t),P=(0,p.useMemo)(()=>{let t=new URLSearchParams;return e&&t.set(`posicao`,e),n&&t.set(`vertical`,n),`/patrocinios${t.toString()?`?${t.toString()}`:``}`},[e,n]),F=o!==`adsense`&&e,I=o!==`direct`&&u&&N&&S?.external===!0&&!a()&&!D&&!k;(0,p.useEffect)(()=>{if(!F){A(!1),O(null);return}let t=new AbortController;return A(!0),r.get(`/banners/ativo`,{params:{posicao:e,vertical:n},signal:t.signal}).then(({data:e})=>O(e?.banner||null)).catch(e=>{e.name!==`CanceledError`&&e.code!==`ERR_CANCELED`&&O(null)}).finally(()=>{t.signal.aborted||A(!1)}),()=>t.abort()},[F,e,n]),(0,p.useEffect)(()=>{T.current=!1,M(!1)},[t,e,N]),(0,p.useEffect)(()=>{if(!I||T.current)return;let e=!1;return i().then(()=>{if(!(e||T.current||!C.current))try{window.adsbygoogle=window.adsbygoogle||[],window.adsbygoogle.push({}),T.current=!0}catch{M(!0)}}).catch(()=>{e||M(!0)}),()=>{e=!0}},[I,t,e,N]),(0,p.useEffect)(()=>{if(!D?._id||!w.current)return;let e=w.current,t=()=>{E.current!==D._id&&(E.current=D._id,r.post(`/banners/${D._id}/impressao`).catch(()=>{}))};if(!(`IntersectionObserver`in window)){t();return}let n=new IntersectionObserver(e=>{e.some(e=>e.isIntersecting&&e.intersectionRatio>=.35)&&(t(),n.disconnect())},{threshold:[.35]});return n.observe(e),()=>n.disconnect()},[D?._id]);let L={"--nx-ad-min-height":`${g}px`,"--nx-ad-mobile-min-height":`${v}px`},R=e===`landing_between_highlights`,z=[`nx-ad-banner`,`nx-ad-banner--${b}`,R?`nx-ad-banner--landing`:``,d].filter(Boolean).join(` `),B=(0,p.useMemo)(()=>{let t=String(e||``),r=String(n||``),i=r===`carro`||t.includes(`carros`),a=r===`imovel`||t.includes(`imoveis`),o=i?`automóveis`:a?`imóveis`:`Noxvelia`;return R?{label:`Parcerias`,eyebrow:`Espaço patrocinado`,title:`Preço de lançamento para parceiros da Noxvelia.`,body:`Uma oportunidade simples para testar presença no site desde cedo, por 7, 14 ou 30 dias.`,cta:`Ver planos`}:b===`sidebar`||t.includes(`detalhe_sidebar`)?{label:`Publicidade`,eyebrow:`Junto ao anúncio`,title:`A tua marca perto do contacto.`,body:`Aparece na página de detalhe de ${o}, numa zona de decisão do visitante.`,cta:`Reservar lateral`}:b===`inline`||t.includes(`feed_pesquisa`)?{label:`Publicidade`,eyebrow:`Entre resultados`,title:`Patrocina o feed de ${o}.`,body:`Uma presença curta e visível sem interromper a pesquisa.`,cta:`Reservar espaço`}:t.includes(`topo`)?{label:`Publicidade`,eyebrow:`Topo da listagem`,title:`Preço de lançamento no topo de ${o}.`,body:`Bom para parceiros locais que querem testar visibilidade sem investimento pesado.`,cta:`Ver preços`}:t.includes(`fundo`)||t.includes(`sugestoes`)?{label:`Publicidade`,eyebrow:`Fim da página`,title:`Aparece quando o visitante continua a comparar opções.`,body:`Uma posição discreta para reforçar a tua marca sem pesar no site.`,cta:`Patrocinar`}:{label:`Publicidade`,eyebrow:`Espaço disponível`,title:`Anuncia neste espaço.`,body:`Escolhe a posição, adiciona imagem ou GIF e define a duração da campanha.`,cta:`Ver condições`}},[R,e,n,b]);return D?(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(_,{}),(0,h.jsx)(`aside`,{ref:w,className:z,style:L,"aria-label":`Publicidade`,children:(0,h.jsxs)(`a`,{className:`nx-ad-banner-card nx-ad-banner-direct`,href:D.linkDestino,target:`_blank`,rel:`noopener noreferrer sponsored`,onClick:()=>{D?._id&&r.post(`/banners/${D._id}/clique`).catch(()=>{})},children:[(0,h.jsx)(`span`,{className:`nx-ad-banner-label`,children:`Publicidade`}),(0,h.jsx)(`img`,{src:D.imagemUrl,alt:D.titulo,loading:`lazy`}),(0,h.jsxs)(`span`,{className:`nx-ad-banner-caption`,children:[(0,h.jsx)(`strong`,{children:D.titulo}),(0,h.jsx)(`span`,{children:`Patrocínio direto`})]})]})})]}):!I||j?!x||k?null:(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(_,{}),(0,h.jsx)(`aside`,{className:z,style:L,"aria-label":`Publicidade disponível`,children:(0,h.jsxs)(f,{className:`nx-ad-banner-card nx-ad-banner-empty${R?` nx-ad-banner-empty-landing`:``}`,to:P,children:[(0,h.jsx)(`span`,{className:`nx-ad-banner-label`,children:B.label}),(0,h.jsxs)(`span`,{className:`nx-ad-empty-layout`,children:[(0,h.jsxs)(`span`,{className:`nx-ad-empty-copy`,children:[(0,h.jsx)(`span`,{className:`nx-ad-empty-eyebrow`,children:B.eyebrow}),(0,h.jsx)(`strong`,{children:B.title}),(0,h.jsx)(`span`,{className:`nx-ad-empty-body`,children:B.body})]}),(0,h.jsxs)(`span`,{className:`nx-ad-empty-preview`,"aria-hidden":`true`,children:[(0,h.jsx)(`span`,{className:`nx-ad-preview-badge`,children:`Campanha local`}),(0,h.jsx)(`span`,{className:`nx-ad-preview-title`,children:`Imagem, GIF ou banner próprio`}),(0,h.jsx)(`span`,{className:`nx-ad-preview-meta`,children:`7, 14 ou 30 dias`})]}),(0,h.jsx)(`span`,{className:`nx-ad-empty-cta`,children:B.cta})]})]})})]}):(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(_,{}),(0,h.jsx)(`aside`,{className:z,style:L,"aria-label":`Publicidade`,children:(0,h.jsxs)(`div`,{className:`nx-ad-banner-card nx-ad-banner-adsense`,children:[(0,h.jsx)(`div`,{className:`nx-ad-banner-label`,children:`Publicidade`}),(0,h.jsx)(`ins`,{ref:C,className:`adsbygoogle`,style:{display:`block`,minHeight:`var(--nx-ad-min-height)`},"data-ad-client":s,"data-ad-slot":N,"data-ad-format":y,"data-full-width-responsive":`true`,"data-adtest":l?`on`:void 0})]})})]})}function _(){return(0,h.jsx)(`style`,{children:`
      .nx-ad-banner {
        width: 100%;
        max-width: 1180px;
        margin: 24px auto;
