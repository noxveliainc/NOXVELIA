import{g as e,t,u as n,y as r}from"./jsx-runtime-On9Szgki.js";import{E as i,T as a,y as o}from"./index-C2IHgY_r.js";import{Q as s,Rt as c,a as l,ot as u}from"./mdi-zXrJVqZY.js";import{t as d}from"./AnuncioCard-kwYtbWYg.js";var f=r(e(),1),p=c(),m=t();function h(){let[e,t]=(0,f.useState)([]),[r,c]=(0,f.useState)(!0),[h,g]=(0,f.useState)(``),_=n(),v=(localStorage.getItem(`@App:contexto_visual`)||`carro`)===`carro`,y=v?`/carros`:`/imoveis`,b=v?`automóveis`:`imóveis`;return(0,f.useEffect)(()=>{(async()=>{try{let{data:e}=await a.get(`/anuncios/favoritos`);t(e||[])}catch(e){console.error(e),g(`Não foi possível carregar a tua lista de favoritos.`)}finally{c(!1)}})()},[]),r?(0,m.jsx)(o,{label:`A carregar favoritos`,detail:`Estamos a reunir os anúncios que guardaste.`,minHeight:`calc(100vh - 72px)`,tone:`light`}):(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(`style`,{children:`
        .fav-outer {
          background: #ffffff;
