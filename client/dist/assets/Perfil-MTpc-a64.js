import{g as e,t,u as n,y as r}from"./jsx-runtime-On9Szgki.js";import{T as i,_ as a,g as o,w as s,y as c}from"./index-CqwHinB_.js";import{Ft as l,H as u,I as d,It as f,Lt as p,Ot as m,Rt as h,dt as g,h as _,it as v,nt as y,x as b}from"./mdi-zXrJVqZY.js";import{t as x}from"./AnuncioCard-Bt9cs1Q4.js";import{n as ee,t as te}from"./ProfileView-CEJ_XGDj.js";var S=r(e(),1),C=h(),w=t(),T=[{value:`website`,label:`Website`,icon:l,placeholder:`Ex: https://www.teusite.pt`},{value:`instagram`,label:`Instagram`,icon:y,placeholder:`Ex: https://instagram.com/oteuperfil`},{value:`facebook`,label:`Facebook`,icon:u,placeholder:`Ex: https://facebook.com/oteuperfil`},{value:`linkedin`,label:`LinkedIn`,icon:v,placeholder:`Ex: https://linkedin.com/in/oteuperfil`},{value:`youtube`,label:`YouTube`,icon:p,placeholder:`Ex: https://youtube.com/@oteucanal`},{value:`tiktok`,label:`TikTok`,icon:g,placeholder:`Ex: https://tiktok.com/@oteuperfil`},{value:`whatsapp`,label:`WhatsApp`,icon:f,placeholder:`Ex: 912345678 ou https://wa.me/351912345678`},{value:`outro`,label:`Outro`,icon:d,placeholder:`Ex: https://www.outrolink.pt`}],E=()=>({tipo:`website`,url:``}),ne=e=>T.find(t=>t.value===e)||T[T.length-1],re=(e,t)=>{let n=Array.isArray(e)?e.filter(e=>e?.url).slice(0,3):[];return n.length>0?n.map(e=>({tipo:e.tipo||`outro`,url:e.url||``})):t?[{tipo:`website`,url:t}]:[E()]};function D(){let{user:e,signed:t,atualizarAvatar:r,atualizarUser:l,logout:u}=s(),d=n(),f=(0,S.useRef)(null),p=(0,S.useRef)(null),h=localStorage.getItem(`@App:contexto_visual`)||`imovel`,[g,v]=(0,S.useState)(null),[y,D]=(0,S.useState)([]),[O,k]=(0,S.useState)(h),[A,j]=(0,S.useState)(!0),[M,N]=(0,S.useState)(!1),[P,F]=(0,S.useState)(!1),[ie,I]=(0,S.useState)(!1),[L,ae]=(0,S.useState)(null),[oe,R]=(0,S.useState)(!1),[z,B]=(0,S.useState)(null),[V,H]=(0,S.useState)(null),[U,W]=(0,S.useState)(!1),[G,K]=(0,S.useState)({nomeEmpresa:``,nif:``,website:``}),[se,q]=(0,S.useState)(!1),[J,Y]=(0,S.useState)({bio:``,website:``,localidade:``,mostrarTelefonePublico:!0,linksPerfil:[E()]}),ce=O===`carro`?`/carros`:`/imoveis`,le=O===`carro`?`Automóveis`:`Imóveis`;(0,S.useEffect)(()=>{if(!t){d(`/login`);return}e&&v(e);let n=!0;return(async()=>{try{let[e,t]=await Promise.all([i.get(`/users/me`),i.get(`/users/me/anuncios`)]);if(!n)return;v(e.data),D(t.data),j(!1)}catch(e){if(!n)return;e.response?.status===401||e.response?.status===403?(u(),d(`/login`)):(ae(`Não foi possível carregar os teus dados.`),j(!1))}})(),()=>{n=!1}},[d,t,e,u]);let ue=()=>{u(),d(`/`,{replace:!0})},de=async e=>{let t=e.target.files[0];if(t){F(!0);try{let e=new FormData;e.append(`imagens`,t),e.append(`kind`,`avatar`);let n=await i.post(`/upload/imagens`,e,{headers:{"Content-Type":`multipart/form-data`}}),s=a(n.data)[0],c=o(s,`large`)||n.data.url,l=await i.put(`/users/me`,{avatarUrl:c});r&&r(c),v(l.data)}catch{alert(`Erro ao processar a imagem do avatar.`)}finally{F(!1)}}},fe=async e=>{let t=e.target.files[0];if(t){I(!0);try{let e=new FormData;e.append(`imagens`,t),e.append(`kind`,`cover`);let n=await i.post(`/upload/imagens`,e,{headers:{"Content-Type":`multipart/form-data`}}),r=a(n.data)[0],s=o(r,`large`)||n.data.url,c=await i.put(`/users/me`,{capaUrl:s});v(c.data),l&&l(c.data)}catch{alert(`Erro ao processar a imagem de capa.`)}finally{I(!1)}}},pe=async e=>{if(e.preventDefault(),!G.nomeEmpresa){alert(`O Nome da Empresa é obrigatório.`);return}try{W(!1),N(!0);let e=await i.put(`/users/me`,{tipoConta:`profissional`,nome:G.nomeEmpresa,nif:G.nif,website:G.website});v(e.data),l&&l(e.data),alert(`A tua conta foi evoluída para Profissional com sucesso.`)}catch{alert(`Ocorreu um erro ao evoluir a tua conta.`)}finally{N(!1)}},me=()=>{Y({bio:g?.bio||``,website:g?.website||``,localidade:g?.localidade||``,mostrarTelefonePublico:g?.mostrarTelefonePublico!==!1,linksPerfil:re(g?.linksPerfil,g?.website)}),q(!0)},X=(e,t,n)=>{Y(r=>({...r,linksPerfil:r.linksPerfil.map((r,i)=>i===e?{...r,[t]:n}:r)}))},he=()=>{Y(e=>e.linksPerfil.length>=3?e:{...e,linksPerfil:[...e.linksPerfil,E()]})},Z=e=>{Y(t=>{let n=t.linksPerfil.filter((t,n)=>n!==e);return{...t,linksPerfil:n.length?n:[E()]}})},ge=async e=>{e.preventDefault();let t=J.linksPerfil.map(e=>({tipo:e.tipo||`outro`,url:(e.url||``).trim()})).filter(e=>e.url).slice(0,3),n=t.find(e=>e.tipo===`website`)?.url||``;try{N(!0),q(!1);let e=await i.put(`/users/me`,{bio:J.bio,localidade:J.localidade,mostrarTelefonePublico:J.mostrarTelefonePublico,website:n,linksPerfil:t});v(e.data),l&&l(e.data)}catch{alert(`Erro ao guardar as alterações do perfil.`)}finally{N(!1)}},_e=async e=>{if(z===e){B(null),H(null);return}B(e);try{let{data:t}=await i.get(`/analytics/anuncio/${e}`);H(t)}catch{alert(`Erro ao carregar dados.`),B(null)}},ve=e=>{N(!0),D(t=>t.filter(t=>t._id!==e)),setTimeout(()=>N(!1),800)},ye=()=>{let e=`${window.location.origin}/vendedor/${g._id}`;navigator.clipboard.writeText(e),R(!0),setTimeout(()=>R(!1),2e3)},be=y.filter(e=>e.tipo===O),Q=y.filter(e=>e.tipo===`imovel`).length,$=y.filter(e=>e.tipo===`carro`).length,xe=ee(g);return A?(0,w.jsx)(c,{label:`A carregar perfil`,detail:`Estamos a preparar a tua área NOXVELIA.`,minHeight:`100vh`,tone:`light`}):(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(`style`,{children:`
