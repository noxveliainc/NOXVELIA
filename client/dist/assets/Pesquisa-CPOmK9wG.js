...
import{B as e,G as t,J as n,K as r,Q as i,U as a,W as ee,et as o,t as s}from"./index-ZR8_NIi2.js";import{C as c,D as l,Gt as u,J as d,S as f,Xt as p,_ as te,ft as ne,jt as re,ut as ie}from"./mdi-CKYwxC2C.js";import{t as ae}from"./Seo-DUANen9h.js";import{t as oe}from"./AnuncioCard-CbJwxZbd.js";import{t as se}from"./GoogleAdSlot-DLeLpRlk.js";import{n as ce,t as le}from"./marcasModelos-CRXT0e16.js";import{n as ue,t as de}from"./localizacoes-9zKfqZul.js";import{t as fe}from"./funnelAnalytics-DBPJQm_q.js";var m=o(i(),1);function pe(e,t){let[n,r]=(0,m.useState)(e);return(0,m.useEffect)(()=>{let n=setTimeout(()=>{r(e)},t);return()=>{clearTimeout(n)}},[e,t]),n}var h=p(),g=a(),me=[`T0`,`T1`,`T2`,`T3`,`T4`,`T5+`],he=[{value:`apartamento`,label:`Apartamento`},{value:`moradia`,label:`Moradia`},{value:`terreno`,label:`Terreno`},{value:`loja`,label:`Loja`},{value:`escritorio`,label:`Escritorio`}],ge=[`Gasolina`,`Diesel`,`Eléctrico`,`Híbrido`,`GPL`],_e=[`Manual`,`Automático`],ve=[{value:`citadino`,label:`Citadino`},{value:`utilitario`,label:`Utilitário`},{value:`sedan`,label:`Sedan`},{value:`carrinha`,label:`Carrinha`},{value:`suv`,label:`SUV`},{value:`crossover`,label:`Crossover`},{value:`coupe`,label:`Coupé`},{value:`cabrio`,label:`Cabrio`},{value:`monovolume`,label:`Monovolume`},{value:`pickup`,label:`Pick-up`},{value:`comercial`,label:`Comercial`}],ye=(0,m.lazy)(()=>s(()=>import(`./MapaResultados-CpU2TNIw.js`),__vite__mapDeps([0,1,2,3,4]))),_=e=>String(e||``).split(`,`).map(e=>e.trim()).filter(Boolean),v=e=>Number(e).toLocaleString(`pt-PT`);function y({tipoPadrao:i=`imovel`,seoParams:a=null}){let[o]=r(),s=n(),p=s.pathname.includes(`carro`)?`carro`:i||`imovel`,y=o.toString(),b=a?.toString()||``,x=(0,m.useMemo)(()=>({search:new URLSearchParams(y),seo:b?new URLSearchParams(b):null}),[y,b]),S=(0,m.useCallback)(e=>x.seo?.get(e)||x.search.get(e)||``,[x]),be=S(`marca`),xe=p===`carro`&&le.includes(be)?be:``,C=S(`q`),Se=(0,m.useCallback)(()=>({tipo:p,precoMin:S(`precoMin`),precoMax:S(`precoMax`),distrito:S(`distrito`)||`Todos`,cidade:S(`cidade`),marca:xe,modelo:S(`modelo`),tiposImovel:_(S(`tipoImovel`)),tipologias:_(S(`tipologia`)),combustiveis:_(S(`combustivel`)),transmissao:_(S(`transmissao`)),tipoVeiculo:_(S(`tipoVeiculo`)),anoMin:S(`anoMin`),anoMax:S(`anoMax`),kmMax:S(`kmMax`),potenciaMin:S(`potenciaMin`),potenciaMax:S(`potenciaMax`),areaMin:S(`areaMin`),quartosMin:S(`quartosMin`),garantia:S(`garantia`)===`true`,aceitaRetoma:S(`aceitaRetoma`)===`true`,garagem:S(`garagem`)===`true`,tipoAnunciante:S(`tipoAnunciante`)}),[S,xe,p]),w=(0,m.useMemo)(()=>Se(),[Se]),Ce=e(s,p===`carro`?`/carros`:`/imoveis`),[T,E]=(0,m.useState)([]),[D,we]=(0,m.useState)([]),[O,k]=(0,m.useState)(!1),[Te,A]=(0,m.useState)(!1),[j,Ee]=(0,m.useState)(null),[De,Oe]=(0,m.useState)(0),[M,ke]=(0,m.useState)(`relevancia`),[N,P]=(0,m.useState)(C),[F,I]=(0,m.useState)(!1),[L,R]=(0,m.useState)(!1),[z,Ae]=(0,m.useState)(!0),[je,Me]=(0,m.useState)(!1),[B,Ne]=(0,m.useState)(`grelha`),[V,H]=(0,m.useState)(w),Pe=(0,m.useRef)(null),U=(0,m.useRef)(!1),W=(0,m.useRef)(1),G=(0,m.useRef)(V),Fe=(0,m.useRef)(M),Ie=(0,m.useRef)(M),K=(0,m.useRef)(``),q=(0,m.useRef)(!1),J=pe(N,300);(0,m.useEffect)(()=>{G.current=V},[V]),(0,m.useEffect)(()=>{Fe.current=M},[M]),(0,m.useEffect)(()=>{let e=()=>R(e=>!e);return window.addEventListener(`toggle-filtros`,e),()=>window.removeEventListener(`toggle-filtros`,e)},[]),(0,m.useEffect)(()=>{let e=window.matchMedia(`(max-width: 1024px)`),t=()=>Me(e.matches);return t(),e.addEventListener(`change`,t),()=>e.removeEventListener(`change`,t)},[]),(0,m.useEffect)(()=>{if(!L)return;let e=e=>{e.key===`Escape`&&R(!1)},t=document.body.style.overflow;return document.body.style.overflow=`hidden`,window.addEventListener(`keydown`,e),()=>{document.body.style.overflow=t,window.removeEventListener(`keydown`,e)}},[L]);let Y=(0,m.useCallback)((e,t,n)=>{t.precoMin&&e.set(`precoMin`,t.precoMin),t.precoMax&&e.set(`precoMax`,t.precoMax),t.distrito&&t.distrito!==`Todos`&&e.set(`distrito`,t.distrito),t.cidade&&e.set(`cidade`,t.cidade),t.garantia&&e.set(`garantia`,`true`),t.aceitaRetoma&&e.set(`aceitaRetoma`,`true`),t.tipoAnunciante&&e.set(`tipoAnunciante`,t.tipoAnunciante),n===`carro`&&(t.marca&&e.set(`marca`,t.marca),t.modelo&&e.set(`modelo`,t.modelo),t.combustiveis.length&&e.set(`combustivel`,t.combustiveis.join(`,`)),t.transmissao.length&&e.set(`transmissao`,t.transmissao.join(`,`)),t.tipoVeiculo.length&&e.set(`tipoVeiculo`,t.tipoVeiculo.join(`,`)),t.anoMin&&e.set(`anoMin`,t.anoMin),t.anoMax&&e.set(`anoMax`,t.anoMax),t.kmMax&&e.set(`kmMax`,t.kmMax),t.potenciaMin&&e.set(`potenciaMin`,t.potenciaMin),t.potenciaMax&&e.set(`potenciaMax`,t.potenciaMax)),n===`imovel`&&(t.tipologias.length&&e.set(`tipologia`,t.tipologias.join(`,`)),t.tiposImovel?.length&&e.set(`tipoImovel`,t.tiposImovel.join(`,`)),t.areaMin&&e.set(`areaMin`,t.areaMin),t.quartosMin&&e.set(`quartosMin`,t.quartosMin),t.garagem&&e.set(`garagem`,`true`))},[]),Le=(0,m.useCallback)(async()=>{try{let e=G.current,t=K.current,n=e.tipo||p,r=new URLSearchParams;r.set(`tipo`,n),Y(r,e,n),t&&t.trim()&&r.set(`q`,t.trim());let{data:i}=await ee.get(`/anuncios/pesquisa/mapa?${r.toString()}`);we(Array.isArray(i)?i:[])}catch(e){console.warn(`Erro ao carregar mapa:`,e)}},[Y,p]),X=(0,m.useCallback)(async(e,t=!1,n=null)=>{if(!U.current){U.current=!0,e===1?k(!0):A(!0),Ee(null);try{let r=G.current,a=Fe.current,o=K.current,c=new URLSearchParams,l=n||r.tipo;(!l||l===`undefined`)&&(l=s.pathname.includes(`carro`)?`carro`:i||`imovel`),c.set(`tipo`,l),c.set(`page`,e),c.set(`limit`,12),c.set(`sort`,a),Y(c,r,l),o&&o.trim()&&c.set(`q`,o.trim());let{data:u}=await ee.get(`/anuncios?${c.toString()}`),d=u.anuncios||(Array.isArray(u)?u:[]),f=u.totalAnuncios===void 0?d.length:u.totalAnuncios;E(t?e=>[...e,...d]:d),Oe(f);let p=d.length===12;I(p),p&&(W.current=e)}catch{Ee(`Não conseguimos carregar novos anúncios neste momento.`),I(!1)}finally{k(!1),A(!1),U.current=!1}}},[Y,i,s.pathname]);(0,m.useEffect)(()=>{G.current=w,H(w),R(!1),I(!1),E([]),P(C),K.current=C,W.current=1;let e=setTimeout(()=>{X(1,!1,p)},50);return()=>clearTimeout(e)},[p,w,C,X]),(0,m.useEffect)(()=>{if(Ie.current===M)return;Ie.current=M;let e=!1,t,n=()=>{if(!e){if(U.current){t=setTimeout(n,80);return}I(!1),E([]),W.current=1,X(1,!1,G.current.tipo)}};return n(),()=>{e=!0,clearTimeout(t)}},[M,X]),(0,m.useEffect)(()=>{if(K.current=J,!q.current){q.current=!0;return}I(!1),E([]),W.current=1,X(1,!1,null)},[J]),(0,m.useEffect)(()=>{if(B!==`mapa`)return;let e=setTimeout(()=>{Le()},60);return()=>clearTimeout(e)},[p,V.precoMin,V.precoMax,V.distrito,V.cidade,V.marca,V.modelo,V.tiposImovel,V.tipologias,V.combustiveis,V.transmissao,V.tipoVeiculo,V.anoMin,V.anoMax,V.kmMax,V.potenciaMin,V.potenciaMax,V.areaMin,V.quartosMin,V.garantia,V.aceitaRetoma,V.garagem,V.tipoAnunciante,J,Le,B]),(0,m.useEffect)(()=>{if(!F||B===`mapa`)return;let e=new IntersectionObserver(e=>{if(e[0].isIntersecting){let e=W.current+1;X(e,!0,G.current.tipo)}},{rootMargin:`200px`,threshold:.1}),t=Pe.current;return t&&e.observe(t),()=>e.disconnect()},[F,X,B]);let Z=(e,t)=>{H(n=>{let r=n[e]||[],i=r.includes(t)?r.filter(e=>e!==t):[...r,t];return{...n,[e]:i}})},Re=()=>{fe(`search_start`,{vertical:p}),I(!1),E([]),W.current=1,setTimeout(()=>{X(1,!1,G.current.tipo)},50),R(!1)},ze=V.marca?ce(V.marca):[],Be=V.distrito&&V.distrito!==`Todos`?ue[V.distrito]:[],Q=`var(--nx-gold)`,Ve=je?!L:!z,$=[V.precoMin&&`Desde ${v(V.precoMin)} EUR`,V.precoMax&&`Até ${v(V.precoMax)} EUR`,V.distrito!==`Todos`&&V.distrito,V.cidade,V.marca,V.modelo,...(V.tiposImovel||[]).map(e=>he.find(t=>t.value===e)?.label||e),...V.tipologias,...V.combustiveis,...V.transmissao,...(V.tipoVeiculo||[]).map(e=>ve.find(t=>t.value===e)?.label||e),V.anoMin&&`Ano desde ${V.anoMin}`,V.anoMax&&`Ano até ${V.anoMax}`,V.kmMax&&`Até ${v(V.kmMax)} km`,V.potenciaMin&&`Desde ${V.potenciaMin} cv`,V.potenciaMax&&`Até ${V.potenciaMax} cv`,V.areaMin&&`Desde ${v(V.areaMin)} m²`,V.quartosMin&&`${V.quartosMin}+ quartos`,V.garantia&&`Com garantia`,V.aceitaRetoma&&`Aceita retoma`,V.garagem&&`Com garagem`,V.tipoAnunciante===`profissional`&&`Profissional`,V.tipoAnunciante===`particular`&&`Particular`,N.trim()&&`"${N.trim()}"`].filter(Boolean);return(0,g.jsxs)(g.Fragment,{children:[!a&&(0,g.jsx)(ae,{title:p===`carro`?`Carros usados e novos em Portugal | Noxvelia`:`Imóveis para venda em Portugal | Noxvelia`,description:p===`carro`?`Pesquisa carros usados e novos em Portugal por marca, modelo, preço e localização.`:`Pesquisa apartamentos, moradias e terrenos em Portugal por tipologia, preço e localização.`,path:p===`carro`?`/carros`:`/imoveis`}),(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(`style`,{children:`
        ...
        .pesquisa-tag.active { background: ${Q}; color: #071326; border-color: ${Q}; }
        ...
        .pesquisa-omnibar-wrapper:focus-within { border-color: ${Q}; box-shadow: 0 0 0 3px rgba(217,196,156,0.18); }
        ...
        .pesquisa-alert-btn:hover:not(:disabled) { transform: translateY(-1px); border-color: ${Q}; background: rgba(217,196,156,.06); }
