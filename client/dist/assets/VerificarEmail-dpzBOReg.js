import{A as e,C as t,M as n,P as r,S as i,T as a}from"./index-YAop2Ko_.js";var o=r(n(),1),s=i();function c(){let{token:n}=e(),[r,i]=(0,o.useState)(`a_verificar`),[c,l]=(0,o.useState)(``);return(0,o.useEffect)(()=>{n&&(async()=>{try{let e=await t.get(`/auth/verify-email/${n}`);l(e.data?.mensagem||`Email verificado com sucesso!`),i(`sucesso`)}catch(e){l(e.response?.data?.erro||`Não foi possível verificar o teu email.`),i(`erro`)}})()},[n]),(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(`style`,{children:`
        .auth-root {
