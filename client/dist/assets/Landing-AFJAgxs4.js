import{g as e,l as t,t as n,u as r,y as i}from"./jsx-runtime-On9Szgki.js";import{S as a,b as o,f as s,h as c,p as l,v as u,x as d}from"./index-Bu5J1B10.js";import{W as f,b as p,ct as m,dt as h,et as g,f as _,i as v,nt as y,ot as b,v as x,wt as S,x as C,z as w}from"./mdi-CgcECdTh.js";import{r as T}from"./seo-BmrZTbI5.js";import{t as E}from"./Seo-B0yVsgzj.js";import{t as ee}from"./GoogleAdSlot-y9DjdYBg.js";import{t as te}from"./SponsorBanner-Dub1kJiA.js";import{i as ne,r as D,t as O}from"./localizacoes-CvOZjRrK.js";var k=S(),A=i(e(),1),j=n();function M(){let{user:e,signed:n,logout:r}=o(),i=t(),[s,d]=(0,A.useState)(!1),[f,p]=(0,A.useState)(!1),m=(0,A.useRef)(null),h=(0,A.useRef)(null);(0,A.useEffect)(()=>{let e=e=>{m.current&&!m.current.contains(e.target)&&d(!1),h.current&&!h.current.contains(e.target)&&p(!1)},t=e=>{e.key===`Escape`&&(d(!1),p(!1))};return window.addEventListener(`click`,e),window.addEventListener(`keydown`,t),()=>{window.removeEventListener(`click`,e),window.removeEventListener(`keydown`,t)}},[]),(0,A.useEffect)(()=>{d(!1),p(!1)},[i.pathname]);let g=e||(()=>{try{let e=sessionStorage.getItem(`@App:user`);return e?JSON.parse(e):null}catch{return null}})(),_=g?.avatarUrl||g?.avatar,v=g?.nome?.charAt(0).toUpperCase()||`U`,y=g?.nome?.split(` `)[0]||``,b=n?`/publicar`:`/login`,x=n?void 0:u(i,`/`);return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(`style`,{children:`
        .nl-root,
        .nl-root * {
