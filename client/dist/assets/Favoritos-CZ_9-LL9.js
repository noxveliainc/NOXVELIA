import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{C as t,O as n,S as r,g as i,j as a,w as o}from"./index-CIYLZE4E.js";import{Xt as s,et as c,o as l,ut as u}from"./mdi-DyiGATAD.js";import{t as d}from"./AnuncioCard-BAqOTKsL.js";var f=e(a(),1),p=s(),m=r();function h(){let[e,r]=(0,f.useState)([]),[a,s]=(0,f.useState)(!0),[h,g]=(0,f.useState)(``),_=n(),v=(localStorage.getItem(`@App:contexto_visual`)||`carro`)===`carro`,y=v?`/carros`:`/imoveis`,b=v?`automóveis`:`imóveis`;return(0,f.useEffect)(()=>{(async()=>{try{let{data:e}=await t.get(`/anuncios/favoritos`);r(e||[])}catch(e){console.error(e),g(`Não foi possível carregar a tua lista de favoritos.`)}finally{s(!1)}})()},[]),a?(0,m.jsx)(i,{label:`A carregar favoritos`,detail:`Estamos a reunir os anúncios que guardaste.`,minHeight:`calc(100vh - 72px)`,tone:`light`}):(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(`style`,{children:`
        .fav-outer {
          background: #ffffff;
