import{g as e,t,u as n,y as r}from"./jsx-runtime-On9Szgki.js";import{c as i,s as a}from"./index-CJvlEbxj.js";import{Ct as o,F as s,J as c,K as l,St as u,b as d,ht as f,j as p,m,tt as h,wt as g,xt as _}from"./mdi-CgcECdTh.js";import{t as v}from"./AnuncioCard-C_NSPb_3.js";import{n as y,t as b}from"./ProfileView-BUyMB-D8.js";var x=r(e(),1),S=r(g(),1),C=t(),w=[{value:`website`,label:`Website`,icon:_,placeholder:`Ex: https://www.teusite.pt`},{value:`instagram`,label:`Instagram`,icon:l,placeholder:`Ex: https://instagram.com/oteuperfil`},{value:`facebook`,label:`Facebook`,icon:s,placeholder:`Ex: https://facebook.com/oteuperfil`},{value:`linkedin`,label:`LinkedIn`,icon:c,placeholder:`Ex: https://linkedin.com/in/oteuperfil`},{value:`youtube`,label:`YouTube`,icon:o,placeholder:`Ex: https://youtube.com/@oteucanal`},{value:`tiktok`,label:`TikTok`,icon:h,placeholder:`Ex: https://tiktok.com/@oteuperfil`},{value:`whatsapp`,label:`WhatsApp`,icon:u,placeholder:`Ex: 912345678 ou https://wa.me/351912345678`},{value:`outro`,label:`Outro`,icon:p,placeholder:`Ex: https://www.outrolink.pt`}],T=()=>({tipo:`website`,url:``}),E=e=>w.find(t=>t.value===e)||w[w.length-1],D=(e,t)=>{let n=Array.isArray(e)?e.filter(e=>e?.url).slice(0,3):[];return n.length>0?n.map(e=>({tipo:e.tipo||`outro`,url:e.url||``})):t?[{tipo:`website`,url:t}]:[T()]};function O(){let{user:e,signed:t,atualizarAvatar:r,atualizarUser:o,logout:s}=a(),c=n(),l=(0,x.useRef)(null),u=(0,x.useRef)(null),p=localStorage.getItem(`@App:contexto_visual`)||`imovel`,[h,g]=(0,x.useState)(null),[_,O]=(0,x.useState)([]),[k,A]=(0,x.useState)(p),[ee,j]=(0,x.useState)(!0),[M,N]=(0,x.useState)(!1),[te,P]=(0,x.useState)(!1),[F,I]=(0,x.useState)(!1),[ne,re]=(0,x.useState)(null),[ie,L]=(0,x.useState)(!1),[R,z]=(0,x.useState)(null),[B,V]=(0,x.useState)(null),[H,U]=(0,x.useState)(!1),[W,G]=(0,x.useState)({nomeEmpresa:``,nif:``,website:``}),[K,q]=(0,x.useState)(!1),[J,Y]=(0,x.useState)({bio:``,website:``,localidade:``,linksPerfil:[T()]}),ae=k===`carro`?`/carros`:`/imoveis`,oe=k===`carro`?`Automóveis`:`Imóveis`;(0,x.useEffect)(()=>{if(!t){c(`/login`);return}e&&g(e);let n=!0;return(async()=>{try{let[e,t]=await Promise.all([i.get(`/users/me`),i.get(`/users/me/anuncios`)]);if(!n)return;g(e.data),O(t.data),j(!1)}catch(e){if(!n)return;e.response?.status===401||e.response?.status===403?(s(),c(`/login`)):(re(`Não foi possível carregar os teus dados.`),j(!1))}})(),()=>{n=!1}},[c,t,e,s]);let se=()=>{s(),c(`/`,{replace:!0})},ce=async e=>{let t=e.target.files[0];if(t){P(!0);try{let e=new FormData;e.append(`imagens`,t);let n=await i.post(`/upload/imagens`,e,{headers:{"Content-Type":`multipart/form-data`}}),a=Array.isArray(n.data.urls)?n.data.urls[0]:n.data.url,o=await i.put(`/users/me`,{avatarUrl:a});r&&r(a),g(o.data)}catch{alert(`Erro ao processar a imagem do avatar.`)}finally{P(!1)}}},le=async e=>{let t=e.target.files[0];if(t){I(!0);try{let e=new FormData;e.append(`imagens`,t);let n=await i.post(`/upload/imagens`,e,{headers:{"Content-Type":`multipart/form-data`}}),r=Array.isArray(n.data.urls)?n.data.urls[0]:n.data.url,a=await i.put(`/users/me`,{capaUrl:r});g(a.data),o&&o(a.data)}catch{alert(`Erro ao processar a imagem de capa.`)}finally{I(!1)}}},ue=async e=>{if(e.preventDefault(),!W.nomeEmpresa){alert(`O Nome da Empresa é obrigatório.`);return}try{U(!1),N(!0);let e=await i.put(`/users/me`,{tipoConta:`profissional`,nome:W.nomeEmpresa,nif:W.nif,website:W.website});g(e.data),o&&o(e.data),alert(`A tua conta foi evoluída para Profissional com sucesso.`)}catch{alert(`Ocorreu um erro ao evoluir a tua conta.`)}finally{N(!1)}},de=()=>{Y({bio:h?.bio||``,website:h?.website||``,localidade:h?.localidade||``,linksPerfil:D(h?.linksPerfil,h?.website)}),q(!0)},X=(e,t,n)=>{Y(r=>({...r,linksPerfil:r.linksPerfil.map((r,i)=>i===e?{...r,[t]:n}:r)}))},fe=()=>{Y(e=>e.linksPerfil.length>=3?e:{...e,linksPerfil:[...e.linksPerfil,T()]})},pe=e=>{Y(t=>{let n=t.linksPerfil.filter((t,n)=>n!==e);return{...t,linksPerfil:n.length?n:[T()]}})},me=async e=>{e.preventDefault();let t=J.linksPerfil.map(e=>({tipo:e.tipo||`outro`,url:(e.url||``).trim()})).filter(e=>e.url).slice(0,3),n=t.find(e=>e.tipo===`website`)?.url||``;try{N(!0),q(!1);let e=await i.put(`/users/me`,{bio:J.bio,localidade:J.localidade,website:n,linksPerfil:t});g(e.data),o&&o(e.data)}catch{alert(`Erro ao guardar as alterações do perfil.`)}finally{N(!1)}},he=async e=>{if(R===e){z(null),V(null);return}z(e);try{let{data:t}=await i.get(`/analytics/anuncio/${e}`);V(t)}catch{alert(`Erro ao carregar dados.`),z(null)}},Z=e=>{N(!0),O(t=>t.filter(t=>t._id!==e)),setTimeout(()=>N(!1),800)},ge=()=>{let e=`${window.location.origin}/vendedor/${h._id}`;navigator.clipboard.writeText(e),L(!0),setTimeout(()=>L(!1),2e3)},_e=_.filter(e=>e.tipo===k),Q=_.filter(e=>e.tipo===`imovel`).length,$=_.filter(e=>e.tipo===`carro`).length,ve=y(h);return ee?(0,C.jsx)(`div`,{style:{height:`100vh`,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`#f8fafc`},children:(0,C.jsx)(`div`,{className:`nx-spinner`,style:{borderColor:`rgba(42, 193, 180, 0.2)`,borderTopColor:`#2ac1b4`}})}):(0,C.jsxs)(C.Fragment,{children:[(0,C.jsx)(`style`,{children:`
      ...
      `}),H&&(0,C.jsx)(`div`,{className:`modal-overlay`,children:(0,C.jsxs)(`div`,{className:`modal-card`,children:[(0,C.jsx)(`button`,{className:`modal-close`,onClick:()=>U(!1),children:(0,C.jsx)(S.default,{path:`M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z`,size:1})}),(0,C.jsxs)(`h2`,{className:`modal-title`,children:[(0,C.jsx)(S.default,{path:`M18,15H16V17H18M18,11H16V13H18M20,19H12V17H14V15H12V13H14V11H12V9H20M10,7H8V5H10M10,11H8V9H10M10,15H8V13H10M10,19H8V17H10M6,7H4V5H6M6,11H4V9H6M6,15H4V13H6M6,19H4V17H6M12,7V3H2V21H22V7H12Z`,size:1.2,color:`#3b82f6`}),` Evolução de Conta`]}),(0,C.jsx)(`p`,{className:`modal-desc`,children:`Transforma a tua conta num perfil empresarial. Terás direito a uma montra exclusiva com links para o teu website e contactos diretos.`}),(0,C.jsxs)(`form`,{onSubmit:ue,children:[(0,C.jsxs)(`div`,{className:`modal-form-group`,children:[(0,C.jsx)(`label`,{children:`Nome do Stand / Agência *`}),(0,C.jsx)(`input`,{className:`modal-input`,type:`text`,placeholder:`Ex: Stand Vale do Sousa`,value:W.nomeEmpresa,onChange:e=>G({...W,nomeEmpresa:e.target.value}),required:!0})]}),(0,C.jsxs)(`div`,{className:`modal-form-group`,children:[(0,C.jsx)(`label`,{children:`NIF da Empresa (Opcional)`}),(0,C.jsx)(`input`,{className:`modal-input`,type:`text`,placeholder:`Ex: 501234567`,value:W.nif,onChange:e=>G({...W,nif:e.target.value})})]}),(0,C.jsxs)(`div`,{className:`modal-form-group`,children:[(0,C.jsx)(`label`,{children:`Website (Opcional)`}),(0,C.jsx)(`input`,{className:`modal-input`,type:`url`,placeholder:`Ex: https://www.omeustand.pt`,value:W.website,onChange:e=>G({...W,website:e.target.value})})]}),(0,C.jsx)(`button`,{className:`modal-btn-submit`,type:`submit`,children:`Confirmar Evolução`})]})]})}),K&&(0,C.jsx)(`div`,{className:`modal-overlay`,children:(0,C.jsxs)(`div`,{className:`modal-card`,children:[(0,C.jsx)(`button`,{className:`modal-close`,onClick:()=>q(!1),children:(0,C.jsx)(S.default,{path:`M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z`,size:1})}),(0,C.jsxs)(`h2`,{className:`modal-title`,children:[(0,C.jsx)(S.default,{path:`M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z`,size:1.2,color:`#3b82f6`}),` Editar Perfil`]}),(0,C.jsx)(`p`,{className:`modal-desc`,children:`Personaliza a tua presença na plataforma. Adiciona uma biografia para que os compradores saibam quem és.`}),(0,C.jsxs)(`form`,{onSubmit:me,children:[(0,C.jsxs)(`div`,{className:`modal-form-group`,children:[(0,C.jsx)(`label`,{children:`Biografia do Perfil (Máx 800 Carateres)`}),(0,C.jsx)(`textarea`,{className:`modal-input`,placeholder:`Escreve um pouco sobre ti ou sobre o teu stand...`,value:J.bio,onChange:e=>Y({...J,bio:e.target.value}),maxLength:800})]}),(0,C.jsxs)(`div`,{className:`modal-form-group`,children:[(0,C.jsxs)(`div`,{className:`links-editor-header`,children:[(0,C.jsx)(`label`,{children:`Links do Perfil`}),(0,C.jsxs)(`span`,{className:`links-editor-count`,children:[J.linksPerfil.filter(e=>e.url).length,`/3`]})]}),(0,C.jsx)(`div`,{className:`link-editor-list`,children:J.linksPerfil.map((e,t)=>{let n=E(e.tipo);return(0,C.jsxs)(`div`,{className:`link-editor-row`,children:[(0,C.jsx)(`div`,{className:`modal-select-wrap`,children:(0,C.jsx)(`select`,{className:`modal-select`,value:e.tipo,onChange:e=>X(t,`tipo`,e.target.value),children:w.map(e=>(0,C.jsx)(`option`,{value:e.value,children:e.label},e.value))})}),(0,C.jsx)(`input`,{className:`modal-input`,type:`text`,inputMode:`url`,placeholder:n.placeholder,value:e.url,onChange:e=>X(t,`url`,e.target.value)}),(0,C.jsx)(`button`,{type:`button`,className:`link-remove-btn`,onClick:()=>pe(t),"aria-label":`Remover link`,children:(0,C.jsx)(S.default,{path:`M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z`,size:.72})})]},t)})}),(0,C.jsxs)(`button`,{type:`button`,className:`link-add-btn`,onClick:fe,disabled:J.linksPerfil.length>=3,children:[(0,C.jsx)(S.default,{path:`M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z`,size:.65}),` Adicionar Link`]})]}),(0,C.jsx)(`button`,{className:`modal-btn-submit`,type:`submit`,children:`Guardar Alterações`})]})]})}),(0,C.jsx)(`div`,{className:`perfil-outer`,children:(0,C.jsxs)(`div`,{className:`perfil-moldura`,children:[M&&(0,C.jsx)(`div`,{className:`perfil-loading-overlay`,children:(0,C.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:`16px`},children:[(0,C.jsx)(`div`,{className:`nx-spinner`,style:{borderColor:`rgba(42, 193, 180, 0.2)`,borderTopColor:`#2ac1b4`}}),(0,C.jsx)(`span`,{style:{fontFamily:`var(--nx-font-body)`,fontWeight:600,color:`#0f172a`,fontSize:`14px`},children:`A processar...`})]})}),(0,C.jsxs)(`button`,{onClick:()=>c(ae),className:`perfil-back`,children:[(0,C.jsx)(S.default,{path:d,size:.7}),` `,oe]}),(0,C.jsx)(b,{user:h,isOwner:!0,totalImoveis:Q,totalCarros:$,links:ve,onEditProfile:de,onShare:ge,onLogout:se,onUpgrade:()=>U(!0),onAvatarChange:ce,onCapaChange:le,fileInputAvatarRef:l,fileInputCapaRef:u,uploadingAvatar:te,uploadingCapa:F,linkCopiado:ie}),!1,(0,C.jsxs)(`div`,{className:`tabs-row`,children:[(0,C.jsxs)(`button`,{className:`tab-btn${k===`imovel`?` active-imovel`:``}`,onClick:()=>A(`imovel`),children:[`Imóveis `,Q>0&&`(${Q})`]}),(0,C.jsxs)(`button`,{className:`tab-btn${k===`carro`?` active-carro`:``}`,onClick:()=>A(`carro`),children:[`Automóveis `,$>0&&`(${$})`]})]}),(0,C.jsx)(`div`,{className:`cards-grid`,children:_e.map(e=>(0,C.jsxs)(`div`,{className:`card-wrapper`,children:[(0,C.jsx)(v,{anuncio:e,showStatus:!0,onAnuncioEliminado:Z}),e.destacado?(0,C.jsxs)(`div`,{className:`badge-destacado`,children:[(0,C.jsx)(S.default,{path:f,size:.6}),` Destaque Ativo`]}):(0,C.jsx)(`button`,{className:`btn-destacar`,onClick:()=>c(`/sucesso/`+e._id),children:`Promover Anúncio (1.99€)`}),(0,C.jsxs)(`button`,{className:`analytics-trigger-btn`,onClick:()=>he(e._id),children:[(0,C.jsx)(S.default,{path:m,size:.7}),` `,R===e._id?`Ocultar Relatório`:`Ver Performance`]}),R===e._id&&B&&(0,C.jsxs)(`div`,{className:`analytics-panel`,children:[(0,C.jsxs)(`div`,{className:`stat-grid`,children:[(0,C.jsxs)(`div`,{className:`stat-box`,children:[(0,C.jsx)(`div`,{className:`stat-box-val`,children:B.totalVisitas}),(0,C.jsx)(`div`,{className:`stat-box-lbl`,children:`Visitas`})]}),(0,C.jsxs)(`div`,{className:`stat-box`,style:{borderLeft:`1px solid #e2e8f0`,borderRight:`1px solid #e2e8f0`},children:[(0,C.jsx)(`div`,{className:`stat-box-val`,style:{color:`#3b82f6`},children:B.guardadoEmFavoritos}),(0,C.jsx)(`div`,{className:`stat-box-lbl`,children:`Favoritos`})]}),(0,C.jsxs)(`div`,{className:`stat-box`,children:[(0,C.jsx)(`div`,{className:`stat-box-val`,style:{color:`#2ac1b4`},children:B.contactosGerados}),(0,C.jsx)(`div`,{className:`stat-box-lbl`,children:`Mensagens`})]})]}),(0,C.jsx)(`div`,{className:`chart-row`,children:B.graficoSeteDias.map((e,t)=>(0,C.jsxs)(`div`,{className:`chart-bar-wrap`,children:[(0,C.jsx)(`div`,{className:`chart-bar`,style:{height:`${Math.max(e.visitas/Math.max(...B.graficoSeteDias.map(e=>e.visitas),10)*100,5)}%`,opacity:e.visitas===0?.3:1}}),(0,C.jsx)(`div`,{className:`chart-day`,children:e.dataLabel})]},t))})]})]},e._id))})]})})]})}export{O as default};