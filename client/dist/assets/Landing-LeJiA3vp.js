import{A as e,O as t,T as n,b as r,d as i,f as a,g as o,l as s,u as c,v as l,w as u,x as d,y as f}from"./index-DbfBO2YU.js";import{r as p}from"./images-io1S19E8.js";import{r as m}from"./seo-BmrZTbI5.js";import{t as h}from"./Seo-B5XEctXw.js";import{t as g}from"./GoogleAdSlot-Bc3R9Pmu.js";import{i as _,r as v,t as y}from"./localizacoes-CvOZjRrK.js";import{t as b}from"./funnelAnalytics-DMAJlJBj.js";var x=e(t(),1),S=f();function C(){let{user:e,signed:t,logout:n}=l(),r=u(),[i,s]=(0,x.useState)(!1),[c,f]=(0,x.useState)(!1),p=(0,x.useRef)(null),m=(0,x.useRef)(null);(0,x.useEffect)(()=>{let e=e=>{p.current&&!p.current.contains(e.target)&&s(!1),m.current&&!m.current.contains(e.target)&&f(!1)},t=e=>{e.key===`Escape`&&(s(!1),f(!1))};return window.addEventListener(`click`,e),window.addEventListener(`keydown`,t),()=>{window.removeEventListener(`click`,e),window.removeEventListener(`keydown`,t)}},[]),(0,x.useEffect)(()=>{s(!1),f(!1)},[r.pathname]);let h=e||(()=>{try{let e=sessionStorage.getItem(`@App:user`);return e?JSON.parse(e):null}catch{return null}})(),g=h?.avatarUrl||h?.avatar,_=h?.nome?.charAt(0).toUpperCase()||`U`,v=h?.nome?.split(` `)[0]||``,y=t?`/publicar`:`/login`,b=t?void 0:o(r,`/`);return(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(`style`,{children:`
        .nl-root,
        .nl-root * {
