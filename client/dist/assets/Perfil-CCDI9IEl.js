import{g as e,t,u as n,y as r}from"./jsx-runtime-On9Szgki.js";import{T as i,_ as a,v as o,w as s}from"./index-D7drDp8n.js";import{B as c,Ft as l,Mt as u,Nt as d,P as f,Pt as p,Q as m,Tt as h,b as ee,et as g,m as te,st as _}from"./mdi-CnOwmxTs.js";import{t as v}from"./AnuncioCard-Cifr09sf.js";import{n as ne,t as y}from"./ProfileView-CWHQ3P14.js";var b=r(e(),1),x=l(),S=t(),C=[{value:`website`,label:`Website`,icon:u,placeholder:`Ex: https://www.teusite.pt`},{value:`instagram`,label:`Instagram`,icon:m,placeholder:`Ex: https://instagram.com/oteuperfil`},{value:`facebook`,label:`Facebook`,icon:c,placeholder:`Ex: https://facebook.com/oteuperfil`},{value:`linkedin`,label:`LinkedIn`,icon:g,placeholder:`Ex: https://linkedin.com/in/oteuperfil`},{value:`youtube`,label:`YouTube`,icon:p,placeholder:`Ex: https://youtube.com/@oteucanal`},{value:`tiktok`,label:`TikTok`,icon:_,placeholder:`Ex: https://tiktok.com/@oteuperfil`},{value:`whatsapp`,label:`WhatsApp`,icon:d,placeholder:`Ex: 912345678 ou https://wa.me/351912345678`},{value:`outro`,label:`Outro`,icon:f,placeholder:`Ex: https://www.outrolink.pt`}],w=()=>({tipo:`website`,url:``}),re=e=>C.find(t=>t.value===e)||C[C.length-1],ie=(e,t)=>{let n=Array.isArray(e)?e.filter(e=>e?.url).slice(0,3):[];return n.length>0?n.map(e=>({tipo:e.tipo||`outro`,url:e.url||``})):t?[{tipo:`website`,url:t}]:[w()]};function T(){let{user:e,signed:t,atualizarAvatar:r,atualizarUser:c,logout:l}=s(),u=n(),d=(0,b.useRef)(null),f=(0,b.useRef)(null),p=localStorage.getItem(`@App:contexto_visual`)||`imovel`,[m,g]=(0,b.useState)(null),[_,T]=(0,b.useState)([]),[E,D]=(0,b.useState)(p),[O,k]=(0,b.useState)(!0),[ae,A]=(0,b.useState)(!1),[j,M]=(0,b.useState)(!1),[N,P]=(0,b.useState)(!1),[F,I]=(0,b.useState)(null),[oe,L]=(0,b.useState)(!1),[R,z]=(0,b.useState)(null),[B,V]=(0,b.useState)(null),[H,U]=(0,b.useState)(!1),[W,G]=(0,b.useState)({nomeEmpresa:``,nif:``,website:``}),[K,q]=(0,b.useState)(!1),[J,Y]=(0,b.useState)({bio:``,website:``,localidade:``,mostrarTelefonePublico:!0,linksPerfil:[w()]}),se=E===`carro`?`/carros`:`/imoveis`,ce=E===`carro`?`Automóveis`:`Imóveis`;(0,b.useEffect)(()=>{if(!t){u(`/login`);return}e&&g(e);let n=!0;return(async()=>{try{let[e,t]=await Promise.all([i.get(`/users/me`),i.get(`/users/me/anuncios`)]);if(!n)return;g(e.data),T(t.data),k(!1)}catch(e){if(!n)return;e.response?.status===401||e.response?.status===403?(l(),u(`/login`)):(I(`Não foi possível carregar os teus dados.`),k(!1))}})(),()=>{n=!1}},[u,t,e,l]);let le=()=>{l(),u(`/`,{replace:!0})},ue=async e=>{let t=e.target.files[0];if(t){M(!0);try{let e=new FormData;e.append(`imagens`,t),e.append(`kind`,`avatar`);let n=await i.post(`/upload/imagens`,e,{headers:{"Content-Type":`multipart/form-data`}}),s=o(n.data)[0],c=a(s,`large`)||n.data.url,l=await i.put(`/users/me`,{avatarUrl:c});r&&r(c),g(l.data)}catch{alert(`Erro ao processar a imagem do avatar.`)}finally{M(!1)}}},de=async e=>{let t=e.target.files[0];if(t){P(!0);try{let e=new FormData;e.append(`imagens`,t),e.append(`kind`,`cover`);let n=await i.post(`/upload/imagens`,e,{headers:{"Content-Type":`multipart/form-data`}}),r=o(n.data)[0],s=a(r,`large`)||n.data.url,l=await i.put(`/users/me`,{capaUrl:s});g(l.data),c&&c(l.data)}catch{alert(`Erro ao processar a imagem de capa.`)}finally{P(!1)}}},fe=async e=>{if(e.preventDefault(),!W.nomeEmpresa){alert(`O Nome da Empresa é obrigatório.`);return}try{U(!1),A(!0);let e=await i.put(`/users/me`,{tipoConta:`profissional`,nome:W.nomeEmpresa,nif:W.nif,website:W.website});g(e.data),c&&c(e.data),alert(`A tua conta foi evoluída para Profissional com sucesso.`)}catch{alert(`Ocorreu um erro ao evoluir a tua conta.`)}finally{A(!1)}},pe=()=>{Y({bio:m?.bio||``,website:m?.website||``,localidade:m?.localidade||``,mostrarTelefonePublico:m?.mostrarTelefonePublico!==!1,linksPerfil:ie(m?.linksPerfil,m?.website)}),q(!0)},X=(e,t,n)=>{Y(r=>({...r,linksPerfil:r.linksPerfil.map((r,i)=>i===e?{...r,[t]:n}:r)}))},me=()=>{Y(e=>e.linksPerfil.length>=3?e:{...e,linksPerfil:[...e.linksPerfil,w()]})},he=e=>{Y(t=>{let n=t.linksPerfil.filter((t,n)=>n!==e);return{...t,linksPerfil:n.length?n:[w()]}})},Z=async e=>{e.preventDefault();let t=J.linksPerfil.map(e=>({tipo:e.tipo||`outro`,url:(e.url||``).trim()})).filter(e=>e.url).slice(0,3),n=t.find(e=>e.tipo===`website`)?.url||``;try{A(!0),q(!1);let e=await i.put(`/users/me`,{bio:J.bio,localidade:J.localidade,mostrarTelefonePublico:J.mostrarTelefonePublico,website:n,linksPerfil:t});g(e.data),c&&c(e.data)}catch{alert(`Erro ao guardar as alterações do perfil.`)}finally{A(!1)}},ge=async e=>{if(R===e){z(null),V(null);return}z(e);try{let{data:t}=await i.get(`/analytics/anuncio/${e}`);V(t)}catch{alert(`Erro ao carregar dados.`),z(null)}},_e=e=>{A(!0),T(t=>t.filter(t=>t._id!==e)),setTimeout(()=>A(!1),800)},ve=()=>{let e=`${window.location.origin}/vendedor/${m._id}`;navigator.clipboard.writeText(e),L(!0),setTimeout(()=>L(!1),2e3)},ye=_.filter(e=>e.tipo===E),Q=_.filter(e=>e.tipo===`imovel`).length,$=_.filter(e=>e.tipo===`carro`).length,be=ne(m);return O?(0,S.jsx)(`div`,{style:{height:`100vh`,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`#f8fafc`},children:(0,S.jsx)(`div`,{className:`nx-spinner`,style:{borderColor:`rgba(42, 193, 180, 0.2)`,borderTopColor:`#2ac1b4`}})}):(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(`style`,{children:`
