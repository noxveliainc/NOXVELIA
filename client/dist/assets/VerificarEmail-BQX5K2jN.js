import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{C as t,S as n,j as r,k as i,w as a}from"./index-CIYLZE4E.js";var o=e(r(),1),s=n();function c(){let{token:e}=i(),[n,r]=(0,o.useState)(`a_verificar`),[c,l]=(0,o.useState)(``);return(0,o.useEffect)(()=>{e&&(async()=>{try{let n=await t.get(`/auth/verify-email/${e}`);l(n.data?.mensagem||`Email verificado com sucesso!`),r(`sucesso`)}catch(e){l(e.response?.data?.erro||`Não foi possível verificar o teu email.`),r(`erro`)}})()},[e]),(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(`style`,{children:`
        .auth-root {
