import{A as e,O as t,T as n,b as r,p as i,v as a,y as o}from"./index-C4H3Y4wR.js";import{i as s,r as c}from"./images-io1S19E8.js";import{Ft as l,H as u,I as d,It as f,Lt as p,Ot as m,Rt as h,dt as g,h as _,it as v,nt as y,x as b}from"./mdi-BBApqC-c.js";import{t as x}from"./AnuncioCard-CTTu4HRU.js";import{n as ee,t as te}from"./ProfileView-Cre1f5fB.js";var S=e(t(),1),C=h(),w=o(),T=[{value:`website`,label:`Website`,icon:l,placeholder:`Ex: https://www.teusite.pt`},{value:`instagram`,label:`Instagram`,icon:y,placeholder:`Ex: https://instagram.com/oteuperfil`},{value:`facebook`,label:`Facebook`,icon:u,placeholder:`Ex: https://facebook.com/oteuperfil`},{value:`linkedin`,label:`LinkedIn`,icon:v,placeholder:`Ex: https://linkedin.com/in/oteuperfil`},{value:`youtube`,label:`YouTube`,icon:p,placeholder:`Ex: https://youtube.com/@oteucanal`},{value:`tiktok`,label:`TikTok`,icon:g,placeholder:`Ex: https://tiktok.com/@oteuperfil`},{value:`whatsapp`,label:`WhatsApp`,icon:f,placeholder:`Ex: 912345678 ou https://wa.me/351912345678`},{value:`outro`,label:`Outro`,icon:d,placeholder:`Ex: https://www.outrolink.pt`}],E=()=>({tipo:`website`,url:``}),ne=e=>T.find(t=>t.value===e)||T[T.length-1],re=(e,t)=>{let n=Array.isArray(e)?e.filter(e=>e?.url).slice(0,3):[];return n.length>0?n.map(e=>({tipo:e.tipo||`outro`,url:e.url||``})):t?[{tipo:`website`,url:t}]:[E()]};function D(){let{user:e,signed:t,atualizarAvatar:o,atualizarUser:l,logout:u}=a(),d=n(),f=(0,S.useRef)(null),p=(0,S.useRef)(null),h=localStorage.getItem(`@App:contexto_visual`)||`imovel`,[g,v]=(0,S.useState)(null),[y,D]=(0,S.useState)([]),[O,k]=(0,S.useState)(h),[A,j]=(0,S.useState)(!0),[M,N]=(0,S.useState)(!1),[P,F]=(0,S.useState)(!1),[ie,I]=(0,S.useState)(!1),[L,ae]=(0,S.useState)(null),[oe,R]=(0,S.useState)(!1),[z,B]=(0,S.useState)(null),[V,H]=(0,S.useState)(null),[U,W]=(0,S.useState)(!1),[G,K]=(0,S.useState)({nomeEmpresa:``,nif:``,website:``}),[se,q]=(0,S.useState)(!1),[J,Y]=(0,S.useState)({bio:``,website:``,localidade:``,mostrarTelefonePublico:!0,linksPerfil:[E()]}),ce=O===`carro`?`/carros`:`/imoveis`,le=O===`carro`?`Automóveis`:`Imóveis`;(0,S.useEffect)(()=>{if(!t){d(`/login`);return}e&&v(e);let n=!0;return(async()=>{try{let[e,t]=await Promise.all([r.get(`/users/me`),r.get(`/users/me/anuncios`)]);if(!n)return;v(e.data),D(t.data),j(!1)}catch(e){if(!n)return;e.response?.status===401||e.response?.status===403?(u(),d(`/login`)):(ae(`Não foi possível carregar os teus dados.`),j(!1))}})(),()=>{n=!1}},[d,t,e,u]);let ue=()=>{u(),d(`/`,{replace:!0})},de=async e=>{let t=e.target.files[0];if(t){F(!0);try{let e=new FormData;e.append(`imagens`,t),e.append(`kind`,`avatar`);let n=await r.post(`/upload/imagens`,e,{headers:{"Content-Type":`multipart/form-data`}}),i=s(n.data)[0],a=c(i,`large`)||n.data.url,l=await r.put(`/users/me`,{avatarUrl:a});o&&o(a),v(l.data)}catch{alert(`Erro ao processar a imagem do avatar.`)}finally{F(!1)}}},fe=async e=>{let t=e.target.files[0];if(t){I(!0);try{let e=new FormData;e.append(`imagens`,t),e.append(`kind`,`cover`);let n=await r.post(`/upload/imagens`,e,{headers:{"Content-Type":`multipart/form-data`}}),i=s(n.data)[0],a=c(i,`large`)||n.data.url,o=await r.put(`/users/me`,{capaUrl:a});v(o.data),l&&l(o.data)}catch{alert(`Erro ao processar a imagem de capa.`)}finally{I(!1)}}},pe=async e=>{if(e.preventDefault(),!G.nomeEmpresa){alert(`O Nome da Empresa é obrigatório.`);return}try{W(!1),N(!0);let e=await r.put(`/users/me`,{tipoConta:`profissional`,nome:G.nomeEmpresa,nif:G.nif,website:G.website});v(e.data),l&&l(e.data),alert(`A tua conta foi evoluída para Profissional com sucesso.`)}catch{alert(`Ocorreu um erro ao evoluir a tua conta.`)}finally{N(!1)}},me=()=>{Y({bio:g?.bio||``,website:g?.website||``,localidade:g?.localidade||``,mostrarTelefonePublico:g?.mostrarTelefonePublico!==!1,linksPerfil:re(g?.linksPerfil,g?.website)}),q(!0)},X=(e,t,n)=>{Y(r=>({...r,linksPerfil:r.linksPerfil.map((r,i)=>i===e?{...r,[t]:n}:r)}))},he=()=>{Y(e=>e.linksPerfil.length>=3?e:{...e,linksPerfil:[...e.linksPerfil,E()]})},Z=e=>{Y(t=>{let n=t.linksPerfil.filter((t,n)=>n!==e);return{...t,linksPerfil:n.length?n:[E()]}})},ge=async e=>{e.preventDefault();let t=J.linksPerfil.map(e=>({tipo:e.tipo||`outro`,url:(e.url||``).trim()})).filter(e=>e.url).slice(0,3),n=t.find(e=>e.tipo===`website`)?.url||``;try{N(!0),q(!1);let e=await r.put(`/users/me`,{bio:J.bio,localidade:J.localidade,mostrarTelefonePublico:J.mostrarTelefonePublico,website:n,linksPerfil:t});v(e.data),l&&l(e.data)}catch{alert(`Erro ao guardar as alterações do perfil.`)}finally{N(!1)}},_e=async e=>{if(z===e){B(null),H(null);return}B(e);try{let{data:t}=await r.get(`/analytics/anuncio/${e}`);H(t)}catch{alert(`Erro ao carregar dados.`),B(null)}},ve=e=>{N(!0),D(t=>t.filter(t=>t._id!==e)),setTimeout(()=>N(!1),800)},ye=()=>{let e=`${window.location.origin}/vendedor/${g._id}`;navigator.clipboard.writeText(e),R(!0),setTimeout(()=>R(!1),2e3)},be=y.filter(e=>e.tipo===O),Q=y.filter(e=>e.tipo===`imovel`).length,$=y.filter(e=>e.tipo===`carro`).length,xe=ee(g);return A?(0,w.jsx)(i,{label:`A carregar perfil`,detail:`Estamos a preparar a tua área NOXVELIA.`,minHeight:`100vh`,tone:`light`}):(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(`style`,{children:`
      ...
      `}),U&&(0,w.jsx)(`div`,{className:`modal-overlay`,children:(0,w.jsxs)(`div`,{className:`modal-card`,children:[(0,w.jsx)(`button`,{className:`modal-close`,onClick:()=>W(!1),children:(0,w.jsx)(C.Icon,{path:`M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z`,size:1})}),(0,w.jsxs)(`h2`,{className:`modal-title`,children:[(0,w.jsx)(C.Icon,{path:`M18,15H16V17H18M18,11H16V13H18M20,19H12V17H14V15H12V13H14V11H12V9H20M10,7H8V5H10M10,11H8V9H10M10,15H8V13H10M10,19H8V17H10M6,7H4V5H6M6,11H4V9H6M6,15H4V13H6M6,19H4V17H6M12,7V3H2V21H22V7H12Z`,size:1.2,color:`#3b82f6`}),` Evolução de Conta`]}),(0,w.jsx)(`p`,{className:`modal-desc`,children:`Transforma a tua conta num perfil empresarial. Terás direito a uma montra exclusiva com links para o teu website e contactos diretos.`}),(0,w.jsxs)(`form`,{onSubmit:pe,children:[(0,w.jsxs)(`div`,{className:`modal-form-group`,children:[(0,w.jsx)(`label`,{children:`Nome do Stand / Agência *`}),(0,w.jsx)(`input`,{className:`modal-input`,type:`text`,placeholder:`Ex: Stand Vale do Sousa`,value:G.nomeEmpresa,onChange:e=>K({...G,nomeEmpresa:e.target.value}),required:!0})]}),(0,w.jsxs)(`div`,{className:`modal-form-group`,children:[(0,w.jsx)(`label`,{children:`NIF da Empresa (Opcional)`}),(0,w.jsx)(`input`,{className:`modal-input`,type:`text`,placeholder:`Ex: 501234567`,value:G.nif,onChange:e=>K({...G,nif:e.target.value})})]}),(0,w.jsxs)(`div`,{className:`modal-form-group`,children:[(0,w.jsx)(`label`,{children:`Website (Opcional)`}),(0,w.jsx)(`input`,{className:`modal-input`,type:`url`,placeholder:`Ex: https://www.omeustand.pt`,value:G.website,onChange:e=>K({...G,website:e.target.value})})]}),(0,w.jsx)(`button`,{className:`modal-btn-submit`,type:`submit`,children:`Confirmar Evolução`})]})]})}),se&&(0,w.jsx)(`div`,{className:`modal-overlay`,children:(0,w.jsxs)(`div`,{className:`modal-card`,children:[(0,w.jsx)(`button`,{className:`modal-close`,onClick:()=>q(!1),children:(0,w.jsx)(C.Icon,{path:`M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z`,size:1})}),(0,w.jsxs)(`h2`,{className:`modal-title`,children:[(0,w.jsx)(C.Icon,{path:`M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z`,size:1.2,color:`#3b82f6`}),` Editar Perfil`]}),(0,w.jsx)(`p`,{className:`modal-desc`,children:`Personaliza a tua presença na plataforma. Adiciona uma biografia para que os compradores saibam quem és.`}),(0,w.jsxs)(`form`,{onSubmit:ge,children:[(0,w.jsxs)(`div`,{className:`modal-form-group`,children:[(0,w.jsx)(`label`,{children:`Biografia do Perfil (Máx 800 Carateres)`}),(0,w.jsx)(`textarea`,{className:`modal-input`,placeholder:`Escreve um pouco sobre ti ou sobre o teu stand...`,value:J.bio,onChange:e=>Y({...J,bio:e.target.value}),maxLength:800})]}),(0,w.jsxs)(`div`,{className:`modal-form-group`,children:[(0,w.jsxs)(`div`,{className:`links-editor-header`,children:[(0,w.jsx)(`label`,{children:`Links do Perfil`}),(0,w.jsxs)(`span`,{className:`links-editor-count`,children:[J.linksPerfil.filter(e=>e.url).length,`/3`]})]}),(0,w.jsx)(`div`,{className:`link-editor-list`,children:J.linksPerfil.map((e,t)=>{let n=ne(e.tipo);return(0,w.jsxs)(`div`,{className:`link-editor-row`,children:[(0,w.jsx)(`div`,{className:`modal-select-wrap`,children:(0,w.jsx)(`select`,{className:`modal-select`,value:e.tipo,onChange:e=>X(t,`tipo`,e.target.value),children:T.map(e=>(0,w.jsx)(`option`,{value:e.value,children:e.label},e.value))})}),(0,w.jsx)(`input`,{className:`modal-input`,type:`text`,inputMode:`url`,placeholder:n.placeholder,value:e.url,onChange:e=>X(t,`url`,e.target.value)}),(0,w.jsx)(`button`,{type:`button`,className:`link-remove-btn`,onClick:()=>Z(t),"aria-label":`Remover link`,children:(0,w.jsx)(C.Icon,{path:`M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z`,size:.72})})]},t)})}),(0,w.jsxs)(`button`,{type:`button`,className:`link-add-btn`,onClick:he,disabled:J.linksPerfil.length>=3,children:[(0,w.jsx)(C.Icon,{path:`M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z`,size:.65}),` Adicionar Link`]})]}),(0,w.jsx)(`div`,{className:`modal-form-group`,children:(0,w.jsxs)(`label`,{className:`privacy-toggle`,children:[(0,w.jsx)(`input`,{type:`checkbox`,checked:J.mostrarTelefonePublico,onChange:e=>Y({...J,mostrarTelefonePublico:e.target.checked})}),(0,w.jsxs)(`span`,{children:[(0,w.jsx)(`span`,{className:`privacy-toggle-title`,children:`Mostrar o meu telemóvel nos anúncios e no perfil`}),(0,w.jsx)(`span`,{className:`privacy-toggle-text`,children:`Se desligares esta opção, o perfil público e os anúncios apresentam apenas o email.`})]})]})}),(0,w.jsx)(`button`,{className:`modal-btn-submit`,type:`submit`,children:`Guardar Alterações`})]})]})}),(0,w.jsx)(`div`,{className:`perfil-outer`,children:(0,w.jsxs)(`div`,{className:`perfil-moldura`,children:[L&&(0,w.jsx)(`div`,{style:{background:`#fef2f2`,border:`1px solid #fecaca`,color:`#b91c1c`,padding:`14px 16px`,borderRadius:12,marginBottom:24,fontSize:14,fontWeight:600},children:L}),M&&(0,w.jsx)(`div`,{className:`perfil-loading-overlay`,children:(0,w.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:`16px`},children:[(0,w.jsx)(`div`,{className:`nx-spinner`,style:{borderColor:`rgba(42, 193, 180, 0.2)`,borderTopColor:`#2ac1b4`}}),(0,w.jsx)(`span`,{style:{fontFamily:`var(--nx-font-body)`,fontWeight:600,color:`#0f172a`,fontSize:`14px`},children:`A processar...`})]})}),(0,w.jsxs)(`button`,{onClick:()=>d(ce),className:`perfil-back`,children:[(0,w.jsx)(C.Icon,{path:b,size:.7}),` `,le]}),(0,w.jsx)(te,{user:g,isOwner:!0,totalImoveis:Q,totalCarros:$,links:xe,onEditProfile:me,onShare:ye,onLogout:ue,onUpgrade:()=>W(!0),onAvatarChange:de,onCapaChange:fe,fileInputAvatarRef:f,fileInputCapaRef:p,uploadingAvatar:P,uploadingCapa:ie,linkCopiado:oe}),!1,(0,w.jsxs)(`div`,{className:`tabs-row`,children:[(0,w.jsxs)(`button`,{className:`tab-btn${O===`imovel`?` active-imovel`:``}`,onClick:()=>k(`imovel`),children:[`Imóveis `,Q>0&&`(${Q})`]}),(0,w.jsxs)(`button`,{className:`tab-btn${O===`carro`?` active-carro`:``}`,onClick:()=>k(`carro`),children:[`Automóveis `,$>0&&`(${$})`]})]}),(0,w.jsx)(`div`,{className:`cards-grid`,children:be.map(e=>(0,w.jsxs)(`div`,{className:`card-wrapper`,children:[(0,w.jsx)(x,{anuncio:e,showStatus:!0,onAnuncioEliminado:ve}),e.destacado?(0,w.jsxs)(`div`,{className:`badge-destacado`,children:[(0,w.jsx)(C.Icon,{path:m,size:.6}),` Destaque Ativo`]}):(0,w.jsx)(`button`,{className:`btn-destacar`,onClick:()=>d(`/sucesso/`+e._id),children:`Promover Anúncio (1.99€)`}),(0,w.jsxs)(`button`,{className:`analytics-trigger-btn`,onClick:()=>_e(e._id),children:[(0,w.jsx)(C.Icon,{path:_,size:.7}),` `,z===e._id?`Ocultar Relatório`:`Ver Performance`]}),z===e._id&&V&&(0,w.jsxs)(`div`,{className:`analytics-panel`,children:[(0,w.jsxs)(`div`,{className:`stat-grid`,children:[(0,w.jsxs)(`div`,{className:`stat-box`,children:[(0,w.jsx)(`div`,{className:`stat-box-val`,children:V.totalVisitas}),(0,w.jsx)(`div`,{className:`stat-box-lbl`,children:`Visitas`})]}),(0,w.jsxs)(`div`,{className:`stat-box`,style:{borderLeft:`1px solid #e2e8f0`,borderRight:`1px solid #e2e8f0`},children:[(0,w.jsx)(`div`,{className:`stat-box-val`,style:{color:`#3b82f6`},children:V.guardadoEmFavoritos}),(0,w.jsx)(`div`,{className:`stat-box-lbl`,children:`Favoritos`})]}),(0,w.jsxs)(`div`,{className:`stat-box`,children:[(0,w.jsx)(`div`,{className:`stat-box-val`,style:{color:`#2ac1b4`},children:V.contactosGerados}),(0,w.jsx)(`div`,{className:`stat-box-lbl`,children:`Mensagens`})]})]}),(0,w.jsx)(`div`,{className:`chart-row`,children:V.graficoSeteDias.map((e,t)=>(0,w.jsxs)(`div`,{className:`chart-bar-wrap`,children:[(0,w.jsx)(`div`,{className:`chart-bar`,style:{height:`${Math.max(e.visitas/Math.max(...V.graficoSeteDias.map(e=>e.visitas),10)*100,5)}%`,opacity:e.visitas===0?.3:1}}),(0,w.jsx)(`div`,{className:`chart-day`,children:e.dataLabel})]},t))})]})]},e._id))})]})})]})}export{D as default};