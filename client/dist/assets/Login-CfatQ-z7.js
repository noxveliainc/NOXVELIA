import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{n as t,t as n}from"./jsx-runtime-BX1tsrJU.js";import{D as r,O as i,_ as a,g as o,w as s,x as c}from"./index-BoKioywp.js";import{i as l,n as u,r as d,t as f}from"./TurnstileWidget-B6r7_idl.js";var p=e(t(),1),m=n();function h(){let[e,t]=(0,p.useState)(``),[n,h]=(0,p.useState)(``),[g,_]=(0,p.useState)(!1),[v,y]=(0,p.useState)(!1),[b,x]=(0,p.useState)(``),[S,C]=(0,p.useState)(!1),[w,T]=(0,p.useState)(``),E=i(),D=r(),{login:O,loginGoogle:k}=c(),A=D.state?.mensagemRegisto,j=o(D.state,localStorage.getItem(`@App:contexto_visual`)===`carro`?`/carros`:`/imoveis`),M=()=>{C(!0),setTimeout(()=>{if(JSON.parse(sessionStorage.getItem(`@App:user`)||`{}`)?.tipo===`admin`){E(`/admin`,{replace:!0});return}let e=localStorage.getItem(`@App:contexto_visual`)===`carro`?`/carros`:`/imoveis`,t=a(D.state,e);E(t,{replace:!0})},700)};return(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(`style`,{children:`
        .auth-root {
          position: relative;
          overflow: hidden;
