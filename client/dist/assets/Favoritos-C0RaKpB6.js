import{A as e,O as t,T as n,b as r,p as i,x as a,y as o}from"./index-C4H3Y4wR.js";import{Q as s,Rt as c,a as l,ot as u}from"./mdi-BBApqC-c.js";import{t as d}from"./AnuncioCard-CTTu4HRU.js";var f=e(t(),1),p=c(),m=o();function h(){let[e,t]=(0,f.useState)([]),[o,c]=(0,f.useState)(!0),[h,g]=(0,f.useState)(``),_=n(),v=(localStorage.getItem(`@App:contexto_visual`)||`carro`)===`carro`,y=v?`/carros`:`/imoveis`,b=v?`automóveis`:`imóveis`;return(0,f.useEffect)(()=>{(async()=>{try{let{data:e}=await r.get(`/anuncios/favoritos`);t(e||[])}catch(e){console.error(e),g(`Não foi possível carregar a tua lista de favoritos.`)}finally{c(!1)}})()},[]),o?(0,m.jsx)(i,{label:`A carregar favoritos`,detail:`Estamos a reunir os anúncios que guardaste.`,minHeight:`calc(100vh - 72px)`,tone:`light`}):(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(`style`,{children:`
        .fav-outer {
          background: #ffffff;
