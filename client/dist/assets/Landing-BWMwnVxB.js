import{n as e,r as t,t as n}from"./search-qQbh3dK2.js";import{C as r,D as i,N as a,O as o,S as s,d as c,f as l,h as u,j as d,l as f,m as p,p as m,u as h,w as g,x as _,y as v}from"./index-BZ3_kmjJ.js";import{t as y}from"./localizacoes-9zKfqZul.js";import{r as b}from"./images-io1S19E8.js";import{a as x,i as S,o as ee}from"./seo-BZnLo9Qd.js";import{t as te}from"./Seo-Coi3ub98.js";import{t as ne}from"./GoogleAdSlot-B4YxxSYl.js";import{n as re,t as C}from"./marcasModelos-CRXT0e16.js";import{t as w}from"./funnelAnalytics-BpEMxuQX.js";var T=p(`arrow-right`,[[`path`,{d:`M5 12h14`,key:`1ays0h`}],[`path`,{d:`m12 5 7 7-7 7`,key:`xquz4c`}]]),ie=p(`shield-check`,[[`path`,{d:`M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z`,key:`oel41y`}],[`path`,{d:`m9 12 2 2 4-4`,key:`dzmm74`}]]),E=a(d(),1),D=s();function O(){let{user:e,signed:t,logout:n}=_(),r=i(),[a,o]=(0,E.useState)(!1),[s,c]=(0,E.useState)(!1),l=(0,E.useRef)(null),d=(0,E.useRef)(null);(0,E.useEffect)(()=>{let e=e=>{l.current&&!l.current.contains(e.target)&&o(!1),d.current&&!d.current.contains(e.target)&&c(!1)},t=e=>{e.key===`Escape`&&(o(!1),c(!1))};return window.addEventListener(`click`,e),window.addEventListener(`keydown`,t),()=>{window.removeEventListener(`click`,e),window.removeEventListener(`keydown`,t)}},[]),(0,E.useEffect)(()=>{o(!1),c(!1)},[r.pathname]);let f=e||(()=>{try{let e=sessionStorage.getItem(`@App:user`);return e?JSON.parse(e):null}catch{return null}})(),p=f?.avatarUrl||f?.avatar,m=f?.nome?.charAt(0).toUpperCase()||`U`,h=f?.nome?.split(` `)[0]||``,y=t?`/publicar`:`/login`,b=t?void 0:v(r,`/`);return(0,D.jsxs)(D.Fragment,{children:[(0,D.jsx)(`style`,{children:`
        .nl-root,
        .nl-root * {
