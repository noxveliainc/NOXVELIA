import{C as e,E as t,M as n,P as r,S as i,k as a,x as o}from"./index-YAop2Ko_.js";var s=r(n(),1),c=i(),l=()=>(0,c.jsx)(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2.5`,children:(0,c.jsx)(`path`,{d:`M20 6L9 17l-5-5`})}),u=()=>(0,c.jsx)(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2.5`,className:`pl-spinner`,children:(0,c.jsx)(`path`,{d:`M21 12a9 9 0 1 1-6.219-8.56`})});function d(){let n=a(),[r]=t(),{sincronizarUser:i,user:d}=o(),[f,p]=(0,s.useState)(!1),[m,h]=(0,s.useState)(!1),g=!!(d?.stripeCustomerId||d?.stripeSubscriptionId),_=!!(d?.premiumAtivo&&!g);return(0,s.useEffect)(()=>{r.get(`premium`)===`sucesso`&&(h(!0),i().finally(()=>h(!1)))},[r]),(0,s.useEffect)(()=>{if(!(d?._id||d?.id))return;let e=!0;return h(!0),i().finally(()=>{e&&h(!1)}),()=>{e=!1}},[d?._id,d?.id]),(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(`style`,{children:`
