const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/MapaResultados-CYekfCYa.js","assets/jsx-runtime-On9Szgki.js","assets/index-CkpIGOBr.js","assets/index-wdmsMpKu.css","assets/MapaResultados-CcXJxNtP.css"])))=>i.map(i=>d[i]);
import{g as e,l as t,t as n,u as r,y as i}from"./jsx-runtime-On9Szgki.js";import{C as ee,S as a,b as o,t as s,v as c,x as l}from"./index-CkpIGOBr.js";import{C as u,E as d,It as f,Mt as p,S as te,W as ne,_ as re,at as ie,c as ae,rt as oe,xt as se}from"./mdi-DrYWHjW4.js";import{t as ce}from"./Seo-CQHxwcTI.js";import{t as le}from"./AnuncioCard-DMpwTRcH.js";import{t as ue}from"./GoogleAdSlot-CI7QlVzF.js";import{t as de}from"./SponsorBanner-1YfO4fjU.js";import{i as fe,n as pe,r as m,t as me}from"./localizacoes-CvOZjRrK.js";var h=i(e(),1);function he(e,t){let[n,r]=(0,h.useState)(e);return(0,h.useEffect)(()=>{let n=setTimeout(()=>{r(e)},t);return()=>{clearTimeout(n)}},[e,t]),n}var g=f(),_=n(),ge=[`T0`,`T1`,`T2`,`T3`,`T4`,`T5+`],_e=[{value:`apartamento`,label:`Apartamento`},{value:`moradia`,label:`Moradia`},{value:`terreno`,label:`Terreno`},{value:`loja`,label:`Loja`},{value:`escritorio`,label:`Escritorio`}],ve=[`Gasolina`,`Diesel`,`Eléctrico`,`Híbrido`,`GPL`],ye=[`Manual`,`Automático`],be=(0,h.lazy)(()=>s(()=>import(`./MapaResultados-CYekfCYa.js`),__vite__mapDeps([0,1,2,3,4]))),v=e=>String(e||``).split(`,`).map(e=>e.trim()).filter(Boolean);function xe({tipoPadrao:e=`imovel`,seoParams:n=null}){let[i]=ee(),s=t(),f=r(),{signed:xe}=o(),y=s.pathname.includes(`carro`)?`carro`:e||`imovel`,b=i.toString(),x=n?.toString()||``,S=(0,h.useMemo)(()=>({search:new URLSearchParams(b),seo:x?new URLSearchParams(x):null}),[b,x]),C=(0,h.useCallback)(e=>S.seo?.get(e)||S.search.get(e)||``,[S]),Se=C(`marca`),w=y===`carro`&&m.includes(Se)?Se:``,T=C(`q`),E=(0,h.useCallback)(()=>({tipo:y,precoMin:``,precoMax:C(`precoMax`),distrito:C(`distrito`)||`Todos`,cidade:C(`cidade`),marca:w,modelo:C(`modelo`),tiposImovel:v(C(`tipoImovel`)),tipologias:v(C(`tipologia`)),combustiveis:v(C(`combustivel`)),transmissao:v(C(`transmissao`))}),[C,w,y]),D=(0,h.useMemo)(()=>E(),[E]),Ce=c(s,y===`carro`?`/carros`:`/imoveis`),[O,k]=(0,h.useState)([]),[we,Te]=(0,h.useState)([]),[A,Ee]=(0,h.useState)(!1),[De,Oe]=(0,h.useState)(!1),[j,M]=(0,h.useState)(null),[ke,Ae]=(0,h.useState)(0),[N,je]=(0,h.useState)(`relevancia`),[P,F]=(0,h.useState)(T),[I,L]=(0,h.useState)(!1),[Me,R]=(0,h.useState)(!1),[z,Ne]=(0,h.useState)(!0),[B,Pe]=(0,h.useState)(`grelha`),[Fe,V]=(0,h.useState)(!1),[Ie,H]=(0,h.useState)(``),[U,W]=(0,h.useState)(D),Le=(0,h.useRef)(null),G=(0,h.useRef)(!1),K=(0,h.useRef)(1),q=(0,h.useRef)(U),Re=(0,h.useRef)(N),ze=(0,h.useRef)(N),J=(0,h.useRef)(``),Be=(0,h.useRef)(!1),Y=he(P,300);(0,h.useEffect)(()=>{q.current=U},[U]),(0,h.useEffect)(()=>{Re.current=N},[N]),(0,h.useEffect)(()=>{let e=()=>R(e=>!e);return window.addEventListener(`toggle-filtros`,e),()=>window.removeEventListener(`toggle-filtros`,e)},[]);let Ve=(0,h.useCallback)(async()=>{try{let e=q.current,t=J.current,n=e.tipo||y,r=new URLSearchParams;r.set(`tipo`,n),e.distrito&&e.distrito!==`Todos`&&r.set(`distrito`,e.distrito),e.cidade&&r.set(`cidade`,e.cidade),e.tipologias.length&&r.set(`tipologia`,e.tipologias.join(`,`)),e.tiposImovel?.length&&r.set(`tipoImovel`,e.tiposImovel.join(`,`)),e.precoMax&&r.set(`precoMax`,e.precoMax),t&&t.trim()&&r.set(`q`,t.trim()),n===`carro`&&(e.marca&&r.set(`marca`,e.marca),e.modelo&&r.set(`modelo`,e.modelo),e.combustiveis.length&&r.set(`combustivel`,e.combustiveis.join(`,`)),e.transmissao.length&&r.set(`transmissao`,e.transmissao.join(`,`))),n===`imovel`&&e.tipologias.length&&r.set(`tipologia`,e.tipologias.join(`,`)),n===`imovel`&&e.tiposImovel?.length&&r.set(`tipoImovel`,e.tiposImovel.join(`,`));let{data:i}=await l.get(`/anuncios/pesquisa/mapa?${r.toString()}`);Te(Array.isArray(i)?i:[])}catch(e){console.warn(`Erro ao carregar mapa:`,e)}},[y]),X=(0,h.useCallback)(async(t,n=!1,r=null)=>{if(!G.current){G.current=!0,t===1?Ee(!0):Oe(!0),M(null);try{let i=q.current,ee=Re.current,a=J.current,o=new URLSearchParams,c=r||i.tipo;(!c||c===`undefined`)&&(c=s.pathname.includes(`carro`)?`carro`:e||`imovel`),o.set(`tipo`,c),o.set(`page`,t),o.set(`limit`,12),o.set(`sort`,ee),a&&a.trim()&&o.set(`q`,a.trim()),i.precoMax&&o.set(`precoMax`,i.precoMax),i.distrito&&i.distrito!==`Todos`&&o.set(`distrito`,i.distrito),i.cidade&&o.set(`cidade`,i.cidade),c===`carro`&&(i.marca&&o.set(`marca`,i.marca),i.modelo&&o.set(`modelo`,i.modelo),i.combustiveis.length&&o.set(`combustivel`,i.combustiveis.join(`,`)),i.transmissao.length&&o.set(`transmissao`,i.transmissao.join(`,`))),c===`imovel`&&i.tipologias.length&&o.set(`tipologia`,i.tipologias.join(`,`)),c===`imovel`&&i.tiposImovel?.length&&o.set(`tipoImovel`,i.tiposImovel.join(`,`));let{data:u}=await l.get(`/anuncios?${o.toString()}`),d=u.anuncios||(Array.isArray(u)?u:[]),f=u.totalAnuncios===void 0?d.length:u.totalAnuncios;k(n?e=>[...e,...d]:d),Ae(f);let p=d.length===12;L(p),p&&(K.current=t)}catch{M(`Falha ao atualizar dados.`),L(!1)}finally{Ee(!1),Oe(!1),G.current=!1}}},[e,s.pathname]);(0,h.useEffect)(()=>{q.current=D,W(D),R(!1),L(!1),k([]),F(T),J.current=T,K.current=1;let e=setTimeout(()=>{X(1,!1,y)},50);return()=>clearTimeout(e)},[y,D,T,X]),(0,h.useEffect)(()=>{if(ze.current===N)return;ze.current=N;let e=!1,t,n=()=>{if(!e){if(G.current){t=setTimeout(n,80);return}L(!1),k([]),K.current=1,X(1,!1,q.current.tipo)}};return n(),()=>{e=!0,clearTimeout(t)}},[N,X]),(0,h.useEffect)(()=>{if(J.current=Y,!Be.current){Be.current=!0;return}L(!1),k([]),K.current=1,X(1,!1,null)},[Y]),(0,h.useEffect)(()=>{if(B!==`mapa`)return;let e=setTimeout(()=>{Ve()},60);return()=>clearTimeout(e)},[y,U.distrito,U.cidade,U.precoMax,U.marca,U.modelo,U.tiposImovel,U.tipologias,U.combustiveis,U.transmissao,Y,Ve,B]),(0,h.useEffect)(()=>{if(!I||B===`mapa`)return;let e=new IntersectionObserver(e=>{if(e[0].isIntersecting){let e=K.current+1;X(e,!0,q.current.tipo)}},{rootMargin:`200px`,threshold:.1}),t=Le.current;return t&&e.observe(t),()=>e.disconnect()},[I,X,B]);let Z=(e,t)=>{W(n=>{let r=n[e]||[],i=r.includes(t)?r.filter(e=>e!==t):[...r,t];return{...n,[e]:i}})},He=()=>{L(!1),k([]),K.current=1,setTimeout(()=>{X(1,!1,q.current.tipo)},50),R(!1)},Ue=U.marca?fe(U.marca):[],We=U.distrito&&U.distrito!==`Todos`?pe[U.distrito]:[],Q=y===`carro`?`var(--nx-accent-car)`:`var(--nx-accent-home)`,$=[U.precoMax&&`Ate ${Number(U.precoMax).toLocaleString(`pt-PT`)} EUR`,U.distrito!==`Todos`&&U.distrito,U.cidade,U.marca,U.modelo,...(U.tiposImovel||[]).map(e=>_e.find(t=>t.value===e)?.label||e),...U.tipologias,...U.combustiveis,...U.transmissao,P.trim()&&`"${P.trim()}"`].filter(Boolean);return(0,_.jsxs)(_.Fragment,{children:[!n&&(0,_.jsx)(ce,{title:y===`carro`?`Carros usados e novos em Portugal | Noxvelia`:`Imóveis para venda em Portugal | Noxvelia`,description:y===`carro`?`Pesquisa carros usados e novos em Portugal por marca, modelo, preço e localização.`:`Pesquisa apartamentos, moradias e terrenos em Portugal por tipologia, preço e localização.`,path:y===`carro`?`/carros`:`/imoveis`}),(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(`style`,{children:`
