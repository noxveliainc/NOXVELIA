import{g as e,t,y as n}from"./jsx-runtime-On9Szgki.js";import{S as r,b as i,x as a}from"./index-CkpIGOBr.js";import{It as o}from"./mdi-DrYWHjW4.js";import{r as s}from"./seo-BmrZTbI5.js";var c=n(e(),1),l=o(),u=t();function d({anuncio:e,showStatus:t=!1,onAnuncioEliminado:n,forceSellerIdentity:o=!1}){let{user:d,signed:f}=i(),[p,m]=(0,c.useState)(!1),[h,g]=(0,c.useState)(!1),_=e?.preco?new Intl.NumberFormat(`pt-PT`,{style:`currency`,currency:`EUR`,maximumFractionDigits:0}).format(e.preco):`Sob Consulta`,v=e?.utilizador?.nome?.charAt(0).toUpperCase()||`?`,y={ativo:{bg:`rgba(16,185,129,.12)`,color:`#10b981`,border:`rgba(16,185,129,.2)`,label:`Activo`},pausado:{bg:`rgba(239,68,68,.12)`,color:`#ef4444`,border:`rgba(239,68,68,.2)`,label:`Pausado`},expirado:{bg:`rgba(245,158,11,.12)`,color:`#f59e0b`,border:`rgba(245,158,11,.2)`,label:`A expirar`},pendente:{bg:`rgba(59,130,246,.12)`,color:`#3b82f6`,border:`rgba(59,130,246,.2)`,label:`Pendente`}},b=y[e?.estado]||y.pendente,x=e?.utilizador?._id||e?.utilizador?.id||e?.utilizador,S=d?._id||d?.id,C=!o&&f&&(x&&S&&String(x)===String(S)||!!n),w=e?.destacado===!0,T=e?.utilizador?.tipo===`admin`||e?.utilizador?.premiumAtivo===!0,E=e?.tipo===`carro`,D=e?.precoAnalise,O=Number(e?.scoreQualidade||0),k=Math.max(0,Math.min(100,Math.round(O/10*100))),A=(E?[{label:`Quilometros`,value:e?.carro?.km==null?null:`${new Intl.NumberFormat(`pt-PT`).format(e.carro.km)} km`},{label:`Combustivel`,value:(e=>e?{gasolina:`Gasolina`,diesel:`Diesel`,eletrico:`Eletrico`,hibrido:`Hibrido`,gpl:`GPL`}[String(e).toLowerCase()]||e:null)(e?.carro?.combustivel)},{label:`Cilindrada`,value:e?.carro?.cilindrada?`${new Intl.NumberFormat(`pt-PT`).format(e.carro.cilindrada)} cc`:null}]:[{label:`Tipo`,value:e?.imovel?.tipologia||e?.imovel?.tipoImovel},{label:`Area`,value:e?.imovel?.area?`${e.imovel.area} m2`:null},{label:`Quartos`,value:e?.imovel?.quartos==null?null:`${e.imovel.quartos}`},{label:`Zona`,value:e?.localizacao?.cidade}]).filter(e=>e.value).slice(0,3),j=e=>{e.preventDefault(),e.stopPropagation(),g(!0)},M=e=>{e?.preventDefault(),e?.stopPropagation(),g(!1)};return(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(`style`,{children:`
        /* ── CARD ── */
        .nxc-wrap {
          display: flex;
