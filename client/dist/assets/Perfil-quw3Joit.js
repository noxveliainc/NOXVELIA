import{g as e,t,u as n,y as r}from"./jsx-runtime-On9Szgki.js";import{_ as i,g as a}from"./index-u74lpmsb.js";import{Ct as o,F as s,J as c,K as l,St as u,b as d,ht as ee,j as f,m as p,tt as m,wt as h,xt as g}from"./mdi-CgcECdTh.js";import{t as te}from"./AnuncioCard-DUeSOB5s.js";import{n as _,t as ne}from"./ProfileView-Dkp9liQs.js";var v=r(e(),1),y=h(),b=t(),x=[{value:`website`,label:`Website`,icon:g,placeholder:`Ex: https://www.teusite.pt`},{value:`instagram`,label:`Instagram`,icon:l,placeholder:`Ex: https://instagram.com/oteuperfil`},{value:`facebook`,label:`Facebook`,icon:s,placeholder:`Ex: https://facebook.com/oteuperfil`},{value:`linkedin`,label:`LinkedIn`,icon:c,placeholder:`Ex: https://linkedin.com/in/oteuperfil`},{value:`youtube`,label:`YouTube`,icon:o,placeholder:`Ex: https://youtube.com/@oteucanal`},{value:`tiktok`,label:`TikTok`,icon:m,placeholder:`Ex: https://tiktok.com/@oteuperfil`},{value:`whatsapp`,label:`WhatsApp`,icon:u,placeholder:`Ex: 912345678 ou https://wa.me/351912345678`},{value:`outro`,label:`Outro`,icon:f,placeholder:`Ex: https://www.outrolink.pt`}],S=()=>({tipo:`website`,url:``}),C=e=>x.find(t=>t.value===e)||x[x.length-1],w=(e,t)=>{let n=Array.isArray(e)?e.filter(e=>e?.url).slice(0,3):[];return n.length>0?n.map(e=>({tipo:e.tipo||`outro`,url:e.url||``})):t?[{tipo:`website`,url:t}]:[S()]};function T(){let{user:e,signed:t,atualizarAvatar:r,atualizarUser:o,logout:s}=a(),c=n(),l=(0,v.useRef)(null),u=(0,v.useRef)(null),f=localStorage.getItem(`@App:contexto_visual`)||`imovel`,[m,h]=(0,v.useState)(null),[g,T]=(0,v.useState)([]),[E,D]=(0,v.useState)(f),[re,O]=(0,v.useState)(!0),[k,A]=(0,v.useState)(!1),[j,M]=(0,v.useState)(!1),[N,P]=(0,v.useState)(!1),[F,I]=(0,v.useState)(null),[ie,L]=(0,v.useState)(!1),[R,z]=(0,v.useState)(null),[B,V]=(0,v.useState)(null),[H,U]=(0,v.useState)(!1),[W,G]=(0,v.useState)({nomeEmpresa:``,nif:``,website:``}),[K,q]=(0,v.useState)(!1),[J,Y]=(0,v.useState)({bio:``,website:``,localidade:``,linksPerfil:[S()]}),ae=E===`carro`?`/carros`:`/imoveis`,oe=E===`carro`?`Automóveis`:`Imóveis`;(0,v.useEffect)(()=>{if(!t){c(`/login`);return}e&&h(e);let n=!0;return(async()=>{try{let[e,t]=await Promise.all([i.get(`/users/me`),i.get(`/users/me/anuncios`)]);if(!n)return;h(e.data),T(t.data),O(!1)}catch(e){if(!n)return;e.response?.status===401||e.response?.status===403?(s(),c(`/login`)):(I(`Não foi possível carregar os teus dados.`),O(!1))}})(),()=>{n=!1}},[c,t,e,s]);let se=()=>{s(),c(`/`,{replace:!0})},ce=async e=>{let t=e.target.files[0];if(t){M(!0);try{let e=new FormData;e.append(`imagens`,t);let n=await i.post(`/upload/imagens`,e,{headers:{"Content-Type":`multipart/form-data`}}),a=Array.isArray(n.data.urls)?n.data.urls[0]:n.data.url,o=await i.put(`/users/me`,{avatarUrl:a});r&&r(a),h(o.data)}catch{alert(`Erro ao processar a imagem do avatar.`)}finally{M(!1)}}},le=async e=>{let t=e.target.files[0];if(t){P(!0);try{let e=new FormData;e.append(`imagens`,t);let n=await i.post(`/upload/imagens`,e,{headers:{"Content-Type":`multipart/form-data`}}),r=Array.isArray(n.data.urls)?n.data.urls[0]:n.data.url,a=await i.put(`/users/me`,{capaUrl:r});h(a.data),o&&o(a.data)}catch{alert(`Erro ao processar a imagem de capa.`)}finally{P(!1)}}},ue=async e=>{if(e.preventDefault(),!W.nomeEmpresa){alert(`O Nome da Empresa é obrigatório.`);return}try{U(!1),A(!0);let e=await i.put(`/users/me`,{tipoConta:`profissional`,nome:W.nomeEmpresa,nif:W.nif,website:W.website});h(e.data),o&&o(e.data),alert(`A tua conta foi evoluída para Profissional com sucesso.`)}catch{alert(`Ocorreu um erro ao evoluir a tua conta.`)}finally{A(!1)}},de=()=>{Y({bio:m?.bio||``,website:m?.website||``,localidade:m?.localidade||``,linksPerfil:w(m?.linksPerfil,m?.website)}),q(!0)},X=(e,t,n)=>{Y(r=>({...r,linksPerfil:r.linksPerfil.map((r,i)=>i===e?{...r,[t]:n}:r)}))},fe=()=>{Y(e=>e.linksPerfil.length>=3?e:{...e,linksPerfil:[...e.linksPerfil,S()]})},pe=e=>{Y(t=>{let n=t.linksPerfil.filter((t,n)=>n!==e);return{...t,linksPerfil:n.length?n:[S()]}})},me=async e=>{e.preventDefault();let t=J.linksPerfil.map(e=>({tipo:e.tipo||`outro`,url:(e.url||``).trim()})).filter(e=>e.url).slice(0,3),n=t.find(e=>e.tipo===`website`)?.url||``;try{A(!0),q(!1);let e=await i.put(`/users/me`,{bio:J.bio,localidade:J.localidade,website:n,linksPerfil:t});h(e.data),o&&o(e.data)}catch{alert(`Erro ao guardar as alterações do perfil.`)}finally{A(!1)}},he=async e=>{if(R===e){z(null),V(null);return}z(e);try{let{data:t}=await i.get(`/analytics/anuncio/${e}`);V(t)}catch{alert(`Erro ao carregar dados.`),z(null)}},Z=e=>{A(!0),T(t=>t.filter(t=>t._id!==e)),setTimeout(()=>A(!1),800)},ge=()=>{let e=`${window.location.origin}/vendedor/${m._id}`;navigator.clipboard.writeText(e),L(!0),setTimeout(()=>L(!1),2e3)},_e=g.filter(e=>e.tipo===E),Q=g.filter(e=>e.tipo===`imovel`).length,$=g.filter(e=>e.tipo===`carro`).length,ve=_(m);return re?(0,b.jsx)(`div`,{style:{height:`100vh`,display:`flex`,alignItems:`center`,justifyContent:`center`,background:`#f8fafc`},children:(0,b.jsx)(`div`,{className:`nx-spinner`,style:{borderColor:`rgba(42, 193, 180, 0.2)`,borderTopColor:`#2ac1b4`}})}):(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(`style`,{children:`
