import{O as e,y as t}from"./index-C6-CdwxB.js";import{G as n,It as r,Jt as i,R as a,Xt as o,Yt as s,Zt as c,_t as l,lt as u,ot as d}from"./mdi-B7Ib99Nx.js";e();var f=c(),p=t(),m=[{value:`website`,label:`Site`,icon:i},{value:`instagram`,label:`Instagram`,icon:d},{value:`facebook`,label:`Facebook`,icon:n},{value:`linkedin`,label:`LinkedIn`,icon:u},{value:`youtube`,label:`YouTube`,icon:o},{value:`tiktok`,label:`TikTok`,icon:l},{value:`whatsapp`,label:`WhatsApp`,icon:s},{value:`outro`,label:`Link`,icon:a}],h=e=>m.find(t=>t.value===e)||m[m.length-1],g=e=>e?/^https?:\/\//i.test(e)?e:`https://${e}`:`#`,_=e=>{if(e?.tipo!==`whatsapp`)return g(e?.url);let t=String(e.url||``).replace(/\D/g,``);return t?`https://wa.me/${t.length===9?`351${t}`:t}`:`#`},v=e=>{if(e.tipo===`whatsapp`)return`WhatsApp`;let t=_(e);try{let n=new URL(t),r=n.pathname.split(`/`).filter(Boolean)[0];return[`instagram`,`tiktok`].includes(e.tipo)&&r?`@${r.replace(/^@/,``)}`:n.hostname.replace(/^www\./,``)}catch{return String(e.url).replace(/(^\w+:|^)\/\//,``)}},y=e=>{let t=Array.isArray(e?.linksPerfil)?e.linksPerfil.filter(e=>e?.url).slice(0,3):[];return t.length>0?t:e?.website?[{tipo:`website`,url:e.website}]:[]};function b({user:e,isOwner:t=!1,totalImoveis:n=0,totalCarros:i=0,links:a=[],shareLabel:o=`Partilhar Montra`,onShare:s,onEditProfile:c,onLogout:l,onUpgrade:u,onAvatarChange:d,onCapaChange:m,fileInputAvatarRef:g,fileInputCapaRef:y,uploadingAvatar:b=!1,uploadingCapa:x=!1,linkCopiado:S=!1}){let C=e?.nome?.charAt(0).toUpperCase()||`?`,w=e?.tipo===`admin`,T=e?.premiumAtivo===!0,E=e?.tipoConta===`profissional`||w,D=w?e?.nome?.toUpperCase().includes(`NOXVELIA`)?e?.nome:`NOXVELIA ${e?.nome}`:e?.nome,O=t||!w,k=!w&&e?.mostrarTelefonePublico!==!1?e?.telefone?.replace(/\D/g,``):``;return(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(`style`,{children:`
        .profile-card {
          background: #ffffff;
