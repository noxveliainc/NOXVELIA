import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{C as t,M as n,S as r,T as i,g as a,k as o}from"./index-x0qvdr3f.js";import{Xt as s,et as c,o as l,ut as u}from"./mdi-re486Yfv.js";import{t as d}from"./AnuncioCard-BgcTZ0at.js";var f=e(n(),1),p=s(),m=r();function h(){let[e,n]=(0,f.useState)([]),[r,s]=(0,f.useState)(!0),[h,g]=(0,f.useState)(``),_=o(),v=(localStorage.getItem(`@App:contexto_visual`)||`carro`)===`carro`,y=v?`/carros`:`/imoveis`,b=v?`automóveis`:`imóveis`;return(0,f.useEffect)(()=>{(async()=>{try{let{data:e}=await t.get(`/anuncios/favoritos`);n(e||[])}catch(e){console.error(e),g(`Não foi possível carregar a tua lista de favoritos.`)}finally{s(!1)}})()},[]),r?(0,m.jsx)(a,{label:`A carregar favoritos`,detail:`Estamos a reunir os anúncios que guardaste.`,minHeight:`calc(100vh - 72px)`,tone:`light`}):(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(`style`,{children:`
        .fav-outer {
          background: #ffffff;
