const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/MapaResultados-fbA9XENg.js","assets/jsx-runtime-On9Szgki.js","assets/index-D2Xr4Zru.js","assets/index-avNInRZP.css","assets/MapaResultados-CcXJxNtP.css"])))=>i.map(i=>d[i]);
import{g as e,l as t,t as n,u as r,y as i}from"./jsx-runtime-On9Szgki.js";import{C as a,E as o,T as s,t as c,w as l,x as u}from"./index-D2Xr4Zru.js";import{Ft as d,T as f,U as p,b as m,bt as ee,c as te,h as ne,it as re,jt as ie,nt as ae,x as oe}from"./mdi-CnOwmxTs.js";import{t as se}from"./Seo-D3mUuF0d.js";import{t as ce}from"./AnuncioCard-CwG-qNfg.js";import{t as le}from"./GoogleAdSlot-Ci5_1tRG.js";import{i as ue,n as de,r as fe,t as pe}from"./localizacoes-CvOZjRrK.js";import{t as me}from"./funnelAnalytics-CjjL7_eA.js";var h=i(e(),1);function he(e,t){let[n,r]=(0,h.useState)(e);return(0,h.useEffect)(()=>{let n=setTimeout(()=>{r(e)},t);return()=>{clearTimeout(n)}},[e,t]),n}var g=d(),_=n(),ge=[`T0`,`T1`,`T2`,`T3`,`T4`,`T5+`],v=[{value:`apartamento`,label:`Apartamento`},{value:`moradia`,label:`Moradia`},{value:`terreno`,label:`Terreno`},{value:`loja`,label:`Loja`},{value:`escritorio`,label:`Escritorio`}],_e=[`Gasolina`,`Diesel`,`Eléctrico`,`Híbrido`,`GPL`],ve=[`Manual`,`Automático`],ye=(0,h.lazy)(()=>c(()=>import(`./MapaResultados-fbA9XENg.js`),__vite__mapDeps([0,1,2,3,4]))),y=e=>String(e||``).split(`,`).map(e=>e.trim()).filter(Boolean);function b({tipoPadrao:e=`imovel`,seoParams:n=null}){let[i]=o(),c=t(),d=r(),{signed:b}=a(),x=c.pathname.includes(`carro`)?`carro`:e||`imovel`,be=i.toString(),S=n?.toString()||``,C=(0,h.useMemo)(()=>({search:new URLSearchParams(be),seo:S?new URLSearchParams(S):null}),[be,S]),w=(0,h.useCallback)(e=>C.seo?.get(e)||C.search.get(e)||``,[C]),xe=w(`marca`),Se=x===`carro`&&fe.includes(xe)?xe:``,T=w(`q`),E=(0,h.useCallback)(()=>({tipo:x,precoMin:``,precoMax:w(`precoMax`),distrito:w(`distrito`)||`Todos`,cidade:w(`cidade`),marca:Se,modelo:w(`modelo`),tiposImovel:y(w(`tipoImovel`)),tipologias:y(w(`tipologia`)),combustiveis:y(w(`combustivel`)),transmissao:y(w(`transmissao`))}),[w,Se,x]),D=(0,h.useMemo)(()=>E(),[E]),Ce=u(c,x===`carro`?`/carros`:`/imoveis`),[O,k]=(0,h.useState)([]),[A,we]=(0,h.useState)([]),[j,M]=(0,h.useState)(!1),[Te,Ee]=(0,h.useState)(!1),[De,Oe]=(0,h.useState)(null),[ke,Ae]=(0,h.useState)(0),[N,je]=(0,h.useState)(`relevancia`),[P,F]=(0,h.useState)(T),[I,L]=(0,h.useState)(!1),[R,z]=(0,h.useState)(!1),[B,Me]=(0,h.useState)(!0),[V,Ne]=(0,h.useState)(`grelha`),[Pe,Fe]=(0,h.useState)(!1),[Ie,H]=(0,h.useState)(``),[U,W]=(0,h.useState)(D),Le=(0,h.useRef)(null),G=(0,h.useRef)(!1),K=(0,h.useRef)(1),q=(0,h.useRef)(U),Re=(0,h.useRef)(N),ze=(0,h.useRef)(N),J=(0,h.useRef)(``),Be=(0,h.useRef)(!1),Y=he(P,300);(0,h.useEffect)(()=>{q.current=U},[U]),(0,h.useEffect)(()=>{Re.current=N},[N]),(0,h.useEffect)(()=>{let e=()=>z(e=>!e);return window.addEventListener(`toggle-filtros`,e),()=>window.removeEventListener(`toggle-filtros`,e)},[]),(0,h.useEffect)(()=>{if(!R)return;let e=e=>{e.key===`Escape`&&z(!1)},t=document.body.style.overflow;return document.body.style.overflow=`hidden`,window.addEventListener(`keydown`,e),()=>{document.body.style.overflow=t,window.removeEventListener(`keydown`,e)}},[R]);let Ve=(0,h.useCallback)(async()=>{try{let e=q.current,t=J.current,n=e.tipo||x,r=new URLSearchParams;r.set(`tipo`,n),e.distrito&&e.distrito!==`Todos`&&r.set(`distrito`,e.distrito),e.cidade&&r.set(`cidade`,e.cidade),e.tipologias.length&&r.set(`tipologia`,e.tipologias.join(`,`)),e.tiposImovel?.length&&r.set(`tipoImovel`,e.tiposImovel.join(`,`)),e.precoMax&&r.set(`precoMax`,e.precoMax),t&&t.trim()&&r.set(`q`,t.trim()),n===`carro`&&(e.marca&&r.set(`marca`,e.marca),e.modelo&&r.set(`modelo`,e.modelo),e.combustiveis.length&&r.set(`combustivel`,e.combustiveis.join(`,`)),e.transmissao.length&&r.set(`transmissao`,e.transmissao.join(`,`))),n===`imovel`&&e.tipologias.length&&r.set(`tipologia`,e.tipologias.join(`,`)),n===`imovel`&&e.tiposImovel?.length&&r.set(`tipoImovel`,e.tiposImovel.join(`,`));let{data:i}=await l.get(`/anuncios/pesquisa/mapa?${r.toString()}`);we(Array.isArray(i)?i:[])}catch(e){console.warn(`Erro ao carregar mapa:`,e)}},[x]),X=(0,h.useCallback)(async(t,n=!1,r=null)=>{if(!G.current){G.current=!0,t===1?M(!0):Ee(!0),Oe(null);try{let i=q.current,a=Re.current,o=J.current,s=new URLSearchParams,u=r||i.tipo;(!u||u===`undefined`)&&(u=c.pathname.includes(`carro`)?`carro`:e||`imovel`),s.set(`tipo`,u),s.set(`page`,t),s.set(`limit`,12),s.set(`sort`,a),o&&o.trim()&&s.set(`q`,o.trim()),i.precoMax&&s.set(`precoMax`,i.precoMax),i.distrito&&i.distrito!==`Todos`&&s.set(`distrito`,i.distrito),i.cidade&&s.set(`cidade`,i.cidade),u===`carro`&&(i.marca&&s.set(`marca`,i.marca),i.modelo&&s.set(`modelo`,i.modelo),i.combustiveis.length&&s.set(`combustivel`,i.combustiveis.join(`,`)),i.transmissao.length&&s.set(`transmissao`,i.transmissao.join(`,`))),u===`imovel`&&i.tipologias.length&&s.set(`tipologia`,i.tipologias.join(`,`)),u===`imovel`&&i.tiposImovel?.length&&s.set(`tipoImovel`,i.tiposImovel.join(`,`));let{data:d}=await l.get(`/anuncios?${s.toString()}`),f=d.anuncios||(Array.isArray(d)?d:[]),p=d.totalAnuncios===void 0?f.length:d.totalAnuncios;k(n?e=>[...e,...f]:f),Ae(p);let m=f.length===12;L(m),m&&(K.current=t)}catch{Oe(`Falha ao atualizar dados.`),L(!1)}finally{M(!1),Ee(!1),G.current=!1}}},[e,c.pathname]);(0,h.useEffect)(()=>{q.current=D,W(D),z(!1),L(!1),k([]),F(T),J.current=T,K.current=1;let e=setTimeout(()=>{X(1,!1,x)},50);return()=>clearTimeout(e)},[x,D,T,X]),(0,h.useEffect)(()=>{if(ze.current===N)return;ze.current=N;let e=!1,t,n=()=>{if(!e){if(G.current){t=setTimeout(n,80);return}L(!1),k([]),K.current=1,X(1,!1,q.current.tipo)}};return n(),()=>{e=!0,clearTimeout(t)}},[N,X]),(0,h.useEffect)(()=>{if(J.current=Y,!Be.current){Be.current=!0;return}L(!1),k([]),K.current=1,X(1,!1,null)},[Y]),(0,h.useEffect)(()=>{if(V!==`mapa`)return;let e=setTimeout(()=>{Ve()},60);return()=>clearTimeout(e)},[x,U.distrito,U.cidade,U.precoMax,U.marca,U.modelo,U.tiposImovel,U.tipologias,U.combustiveis,U.transmissao,Y,Ve,V]),(0,h.useEffect)(()=>{if(!I||V===`mapa`)return;let e=new IntersectionObserver(e=>{if(e[0].isIntersecting){let e=K.current+1;X(e,!0,q.current.tipo)}},{rootMargin:`200px`,threshold:.1}),t=Le.current;return t&&e.observe(t),()=>e.disconnect()},[I,X,V]);let Z=(e,t)=>{W(n=>{let r=n[e]||[],i=r.includes(t)?r.filter(e=>e!==t):[...r,t];return{...n,[e]:i}})},He=()=>{me(`search_start`,{vertical:x}),L(!1),k([]),K.current=1,setTimeout(()=>{X(1,!1,q.current.tipo)},50),z(!1)},Ue=U.marca?ue(U.marca):[],We=U.distrito&&U.distrito!==`Todos`?de[U.distrito]:[],Q=x===`carro`?`var(--nx-accent-car)`:`var(--nx-accent-home)`,$=[U.precoMax&&`Ate ${Number(U.precoMax).toLocaleString(`pt-PT`)} EUR`,U.distrito!==`Todos`&&U.distrito,U.cidade,U.marca,U.modelo,...(U.tiposImovel||[]).map(e=>v.find(t=>t.value===e)?.label||e),...U.tipologias,...U.combustiveis,...U.transmissao,P.trim()&&`"${P.trim()}"`].filter(Boolean);return(0,_.jsxs)(_.Fragment,{children:[!n&&(0,_.jsx)(se,{title:x===`carro`?`Carros usados e novos em Portugal | Noxvelia`:`Imóveis para venda em Portugal | Noxvelia`,description:x===`carro`?`Pesquisa carros usados e novos em Portugal por marca, modelo, preço e localização.`:`Pesquisa apartamentos, moradias e terrenos em Portugal por tipologia, preço e localização.`,path:x===`carro`?`/carros`:`/imoveis`}),(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(`style`,{children:`
