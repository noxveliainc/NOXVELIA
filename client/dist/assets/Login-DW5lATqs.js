import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{n as t,t as n}from"./jsx-runtime-BX1tsrJU.js";import{O as r,S as i,T as a,_ as o,k as s,v as c}from"./index-DYqNjN_M.js";import{i as l,n as u,r as d,t as f}from"./TurnstileWidget-DpXoFaZ3.js";var p=e(t(),1),m=n();function h(){let[e,t]=(0,p.useState)(``),[n,h]=(0,p.useState)(``),[g,_]=(0,p.useState)(!1),[v,y]=(0,p.useState)(!1),[b,x]=(0,p.useState)(``),[S,C]=(0,p.useState)(!1),[w,T]=(0,p.useState)(``),E=s(),D=r(),{login:O,loginGoogle:k}=i(),A=D.state?.mensagemRegisto,j=o(D.state,localStorage.getItem(`@App:contexto_visual`)===`carro`?`/carros`:`/imoveis`),M=()=>{C(!0),setTimeout(()=>{if(JSON.parse(sessionStorage.getItem(`@App:user`)||`{}`)?.tipo===`admin`){E(`/admin`,{replace:!0});return}let e=localStorage.getItem(`@App:contexto_visual`)===`carro`?`/carros`:`/imoveis`,t=c(D.state,e);E(t,{replace:!0})},700)};return(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(`style`,{children:`
        .auth-root {
          position: relative;
          overflow: hidden;
