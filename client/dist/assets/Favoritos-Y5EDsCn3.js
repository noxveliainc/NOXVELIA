import{g as e,t,u as n,y as r}from"./jsx-runtime-On9Szgki.js";import{C as i,S as a,g as o}from"./index-C7yYFwV9.js";import{Xt as s,et as c,o as l,ut as u}from"./mdi-lCQrejZI.js";import{t as d}from"./AnuncioCard-CaRbBV0n.js";var f=r(e(),1),p=s(),m=t();function h(){let[e,t]=(0,f.useState)([]),[r,s]=(0,f.useState)(!0),[h,g]=(0,f.useState)(``),_=n(),v=(localStorage.getItem(`@App:contexto_visual`)||`carro`)===`carro`,y=v?`/carros`:`/imoveis`,b=v?`automóveis`:`imóveis`;return(0,f.useEffect)(()=>{(async()=>{try{let{data:e}=await a.get(`/anuncios/favoritos`);t(e||[])}catch(e){console.error(e),g(`Não foi possível carregar a tua lista de favoritos.`)}finally{s(!1)}})()},[]),r?(0,m.jsx)(o,{label:`A carregar favoritos`,detail:`Estamos a reunir os anúncios que guardaste.`,minHeight:`calc(100vh - 72px)`,tone:`light`}):(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(`style`,{children:`
        .fav-outer {
          background: #ffffff;
