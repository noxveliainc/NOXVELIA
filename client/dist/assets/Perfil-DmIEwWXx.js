import{A as e,O as t,T as n,b as r,p as i,v as a,y as o}from"./index-CnrnGc9x.js";import{i as s,r as c}from"./images-io1S19E8.js";import{Bt as l,C as u,G as d,R as f,Rt as p,Vt as m,_ as h,at as g,jt as _,mt as v,st as y,zt as b}from"./mdi-D05ENuqc.js";import{t as x}from"./AnuncioCard-B0SM1YKn.js";import{n as ee,t as te}from"./ProfileView-5D3SitIs.js";var S=e(t(),1),C=m(),w=o(),T=[{value:`website`,label:`Website`,icon:p,placeholder:`Ex: https://www.teusite.pt`},{value:`instagram`,label:`Instagram`,icon:g,placeholder:`Ex: https://instagram.com/oteuperfil`},{value:`facebook`,label:`Facebook`,icon:d,placeholder:`Ex: https://facebook.com/oteuperfil`},{value:`linkedin`,label:`LinkedIn`,icon:y,placeholder:`Ex: https://linkedin.com/in/oteuperfil`},{value:`youtube`,label:`YouTube`,icon:l,placeholder:`Ex: https://youtube.com/@oteucanal`},{value:`tiktok`,label:`TikTok`,icon:v,placeholder:`Ex: https://tiktok.com/@oteuperfil`},{value:`whatsapp`,label:`WhatsApp`,icon:b,placeholder:`Ex: 912345678 ou https://wa.me/351912345678`},{value:`outro`,label:`Outro`,icon:f,placeholder:`Ex: https://www.outrolink.pt`}],E=()=>({tipo:`website`,url:``}),ne=e=>T.find(t=>t.value===e)||T[T.length-1],re=(e,t)=>{let n=Array.isArray(e)?e.filter(e=>e?.url).slice(0,3):[];return n.length>0?n.map(e=>({tipo:e.tipo||`outro`,url:e.url||``})):t?[{tipo:`website`,url:t}]:[E()]};function D(){let{user:e,signed:t,atualizarAvatar:o,atualizarUser:l,logout:d}=a(),f=n(),p=(0,S.useRef)(null),m=(0,S.useRef)(null),g=localStorage.getItem(`@App:contexto_visual`)||`imovel`,[v,y]=(0,S.useState)(null),[b,D]=(0,S.useState)([]),[O,k]=(0,S.useState)(g),[A,j]=(0,S.useState)(!0),[M,N]=(0,S.useState)(!1),[P,F]=(0,S.useState)(!1),[ie,I]=(0,S.useState)(!1),[L,ae]=(0,S.useState)(null),[oe,R]=(0,S.useState)(!1),[z,B]=(0,S.useState)(null),[V,H]=(0,S.useState)(null),[U,W]=(0,S.useState)(!1),[G,K]=(0,S.useState)({nomeEmpresa:``,nif:``,website:``}),[se,q]=(0,S.useState)(!1),[J,Y]=(0,S.useState)({bio:``,website:``,localidade:``,mostrarTelefonePublico:!0,linksPerfil:[E()]}),ce=O===`carro`?`/carros`:`/imoveis`,le=O===`carro`?`Automóveis`:`Imóveis`;(0,S.useEffect)(()=>{if(!t){f(`/login`);return}e&&y(e);let n=!0;return(async()=>{try{let[e,t]=await Promise.all([r.get(`/users/me`),r.get(`/users/me/anuncios`)]);if(!n)return;y(e.data),D(t.data),j(!1)}catch(e){if(!n)return;e.response?.status===401||e.response?.status===403?(d(),f(`/login`)):(ae(`Não foi possível carregar os teus dados.`),j(!1))}})(),()=>{n=!1}},[f,t,e,d]);let ue=()=>{d(),f(`/`,{replace:!0})},de=async e=>{let t=e.target.files[0];if(t){F(!0);try{let e=new FormData;e.append(`imagens`,t),e.append(`kind`,`avatar`);let n=await r.post(`/upload/imagens`,e,{headers:{"Content-Type":`multipart/form-data`}}),i=s(n.data)[0],a=c(i,`large`)||n.data.url,l=await r.put(`/users/me`,{avatarUrl:a});o&&o(a),y(l.data)}catch{alert(`Erro ao processar a imagem do avatar.`)}finally{F(!1)}}},fe=async e=>{let t=e.target.files[0];if(t){I(!0);try{let e=new FormData;e.append(`imagens`,t),e.append(`kind`,`cover`);let n=await r.post(`/upload/imagens`,e,{headers:{"Content-Type":`multipart/form-data`}}),i=s(n.data)[0],a=c(i,`large`)||n.data.url,o=await r.put(`/users/me`,{capaUrl:a});y(o.data),l&&l(o.data)}catch{alert(`Erro ao processar a imagem de capa.`)}finally{I(!1)}}},pe=async e=>{if(e.preventDefault(),!G.nomeEmpresa){alert(`O Nome da Empresa é obrigatório.`);return}try{W(!1),N(!0);let e=await r.put(`/users/me`,{tipoConta:`profissional`,nome:G.nomeEmpresa,nif:G.nif,website:G.website});y(e.data),l&&l(e.data),alert(`A tua conta foi evoluída para Profissional com sucesso.`)}catch{alert(`Ocorreu um erro ao evoluir a tua conta.`)}finally{N(!1)}},me=()=>{Y({bio:v?.bio||``,website:v?.website||``,localidade:v?.localidade||``,mostrarTelefonePublico:v?.mostrarTelefonePublico!==!1,linksPerfil:re(v?.linksPerfil,v?.website)}),q(!0)},X=(e,t,n)=>{Y(r=>({...r,linksPerfil:r.linksPerfil.map((r,i)=>i===e?{...r,[t]:n}:r)}))},he=()=>{Y(e=>e.linksPerfil.length>=3?e:{...e,linksPerfil:[...e.linksPerfil,E()]})},Z=e=>{Y(t=>{let n=t.linksPerfil.filter((t,n)=>n!==e);return{...t,linksPerfil:n.length?n:[E()]}})},ge=async e=>{e.preventDefault();let t=J.linksPerfil.map(e=>({tipo:e.tipo||`outro`,url:(e.url||``).trim()})).filter(e=>e.url).slice(0,3),n=t.find(e=>e.tipo===`website`)?.url||``;try{N(!0),q(!1);let e=await r.put(`/users/me`,{bio:J.bio,localidade:J.localidade,mostrarTelefonePublico:J.mostrarTelefonePublico,website:n,linksPerfil:t});y(e.data),l&&l(e.data)}catch{alert(`Erro ao guardar as alterações do perfil.`)}finally{N(!1)}},_e=async e=>{if(z===e){B(null),H(null);return}B(e);try{let{data:t}=await r.get(`/analytics/anuncio/${e}`);H(t)}catch{alert(`Erro ao carregar dados.`),B(null)}},ve=e=>{N(!0),D(t=>t.filter(t=>t._id!==e)),setTimeout(()=>N(!1),800)},ye=()=>{let e=`${window.location.origin}/vendedor/${v._id}`;navigator.clipboard.writeText(e),R(!0),setTimeout(()=>R(!1),2e3)},be=b.filter(e=>e.tipo===O),Q=b.filter(e=>e.tipo===`imovel`).length,$=b.filter(e=>e.tipo===`carro`).length,xe=ee(v);return A?(0,w.jsx)(i,{label:`A carregar perfil`,detail:`Estamos a preparar a tua área NOXVELIA.`,minHeight:`100vh`,tone:`light`}):(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(`style`,{children:`
