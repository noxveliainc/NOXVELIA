import{a as e,n as t,t as n}from"./jsx-runtime-CdvZGgm7.js";import{C as r,S as i,x as a}from"./index-BJ3pH-Te.js";import{n as o,r as s,t as c}from"./images-io1S19E8.js";import{i as l}from"./seo-BZnLo9Qd.js";var u=e(t(),1),d=n(),f={camera:`M4 8h3l1.5-2h7L17 8h3v10H4V8zm8 8a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z`,check:`M12 3l7 3v5c0 5-3.1 8.3-7 10-3.9-1.7-7-5-7-10V6l7-3zm-3 9 2 2 4-5`,location:`M12 21s6-5.2 6-11a6 6 0 0 0-12 0c0 5.8 6 11 6 11zm0-8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z`,star:`M12 4l2.3 4.7 5.2.8-3.8 3.7.9 5.2-4.6-2.4-4.6 2.4.9-5.2-3.8-3.7 5.2-.8L12 4z`,trash:`M6 7h12M9 7V5h6v2m-7 3 .6 9h6.8l.6-9`};function p({name:e,size:t=14,color:n}){return(0,d.jsx)(`svg`,{className:`nxc-icon`,width:t,height:t,viewBox:`0 0 24 24`,"aria-hidden":`true`,focusable:`false`,style:n?{color:n}:void 0,children:(0,d.jsx)(`path`,{d:f[e]})})}function m({anuncio:e,showStatus:t=!1,onAnuncioEliminado:n,forceSellerIdentity:f=!1}){let{user:m,signed:h}=a(),[g,_]=(0,u.useState)(!1),[v,y]=(0,u.useState)(!1),b=e?.preco?new Intl.NumberFormat(`pt-PT`,{style:`currency`,currency:`EUR`,maximumFractionDigits:0}).format(e.preco):`Sob Consulta`,x=e?.utilizador?.nome?.charAt(0).toUpperCase()||`?`,S={ativo:{bg:`rgba(16,185,129,.12)`,color:`#10b981`,border:`rgba(16,185,129,.2)`,label:`Activo`},pausado:{bg:`rgba(239,68,68,.12)`,color:`#ef4444`,border:`rgba(239,68,68,.2)`,label:`Pausado`},expirado:{bg:`rgba(245,158,11,.12)`,color:`#f59e0b`,border:`rgba(245,158,11,.2)`,label:`A expirar`},pendente:{bg:`rgba(59,130,246,.12)`,color:`#3b82f6`,border:`rgba(59,130,246,.2)`,label:`Pendente`}},C=S[e?.estado]||S.pendente,w=e?.utilizador?._id||e?.utilizador?.id||e?.utilizador,T=m?._id||m?.id,E=!f&&h&&(w&&T&&String(w)===String(T)||!!n),D=e?.destacado===!0,O=e?.utilizador?.premiumAtivo===!0,k=e?.utilizador?.tipo===`admin`||e?.utilizador?.premiumAtivo===!0,A=e?.utilizador?.tipoConta===`profissional`||e?.utilizador?.premiumAtivo===!0,j=e?.tipo===`carro`,M=e?.precoAnalise,N=Number(e?.scoreQualidade||0),P=Math.max(0,Math.min(100,Math.round(N/10*100))),F=e?.fotos?.[0]||e?.imagens?.[0]||e?.imagem,I=s(F,`medium`),L=o(F),R=c(F,{width:800,height:600}),z=(j?[{label:`Ano`,value:e?.carro?.ano||null},{label:`Km`,value:e?.carro?.km==null?null:`${new Intl.NumberFormat(`pt-PT`).format(e.carro.km)} km`},{label:`Combustível`,value:(e=>e?{gasolina:`Gasolina`,diesel:`Diesel`,eletrico:`Eletrico`,hibrido:`Hibrido`,gpl:`GPL`}[String(e).toLowerCase()]||e:null)(e?.carro?.combustivel)},{label:`Caixa`,value:e?.carro?.transmissao||null}]:[{label:`Tipo`,value:e?.imovel?.tipologia||e?.imovel?.tipoImovel},{label:`Área`,value:e?.imovel?.area?`${e.imovel.area} m2`:null},{label:`Quartos`,value:e?.imovel?.quartos==null?null:`${e.imovel.quartos}`},{label:`Garagem`,value:e?.imovel?.garagem?`Sim`:null}]).filter(e=>e.value).slice(0,3),B=[O&&{label:`Premium`,tone:`premium`},e?.garantia&&{label:`Garantia`,tone:`trust`},e?.aceitaRetoma&&{label:`Retoma`,tone:`trust`},A&&!O&&{label:`Profissional`,tone:`business`}].filter(Boolean).slice(0,3),V=e=>{e.preventDefault(),e.stopPropagation(),y(!0)},H=e=>{e?.preventDefault(),e?.stopPropagation(),y(!1)};return(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(`style`,{children:`
        /* ── CARD ── */
        .nxc-wrap {
          display: flex;
      ...
      `}),(0,d.jsxs)(r,{to:l(e),className:`nxc-wrap${D?` premium`:``}`,children:[(0,d.jsxs)(`div`,{className:`nxc-img`,children:[I?(0,d.jsx)(`img`,{src:I,srcSet:L||void 0,sizes:`(max-width: 720px) 100vw, 360px`,width:R.width,height:R.height,alt:e.titulo,loading:`lazy`,decoding:`async`}):(0,d.jsx)(`div`,{className:`nxc-placeholder`,children:j?`🚗`:`🏠`}),(0,d.jsx)(`div`,{className:`nxc-img-overlay`}),(0,d.jsx)(`span`,{className:`nxc-badge-tipo`,children:j?`Automóvel`:`Imóvel`}),D&&(0,d.jsxs)(`span`,{className:`nxc-badge-premium`,children:[(0,d.jsx)(p,{name:`star`,size:12}),` Destaque`]}),!D&&t&&e?.estado&&!E&&(0,d.jsx)(`span`,{className:`nxc-badge-status`,style:{background:C.bg,color:C.color,border:`1px solid ${C.border}`},children:C.label}),E&&(0,d.jsxs)(`button`,{type:`button`,className:`nxc-delete-btn`,onClick:V,children:[(0,d.jsx)(p,{name:`trash`,size:12}),` Apagar`]}),e?.fotos?.length>1&&(0,d.jsxs)(`div`,{className:`nxc-photo-count`,children:[(0,d.jsx)(p,{name:`camera`,size:12}),` `,e.fotos.length]})]}),(0,d.jsxs)(`div`,{className:`nxc-body`,children:[(0,d.jsxs)(`div`,{className:`nxc-price-row`,children:[(0,d.jsx)(`div`,{className:`nxc-price`,children:b}),M&&(0,d.jsx)(`span`,{className:`nxc-price-signal ${M.estado}`,title:M.detalhe,children:M.label})]}),(0,d.jsx)(`div`,{className:`nxc-title`,children:e?.titulo}),D&&(0,d.jsxs)(`div`,{className:`nxc-featured-note`,children:[(0,d.jsx)(p,{name:`star`,size:12}),` Anúncio em destaque`]}),B.length>0&&(0,d.jsx)(`div`,{className:`nxc-trust-strip`,"aria-label":`Sinais de confiança`,children:B.map(e=>(0,d.jsx)(`span`,{className:`nxc-trust-pill ${e.tone||``}`.trim(),children:e.label},e.label))}),N>0&&(0,d.jsxs)(`div`,{className:`nxc-quality`,title:`Força do anúncio: ${N}/10`,children:[(0,d.jsxs)(`span`,{className:`nxc-quality-label`,children:[N,`/10`]}),(0,d.jsx)(`span`,{className:`nxc-quality-track`,children:(0,d.jsx)(`span`,{className:`nxc-quality-fill`})})]}),z.length>0&&(0,d.jsx)(`div`,{className:`nxc-insights`,children:z.map(e=>(0,d.jsxs)(`span`,{className:`nxc-insight`,children:[(0,d.jsx)(`span`,{className:`nxc-insight-label`,children:e.label}),(0,d.jsx)(`span`,{className:`nxc-insight-value`,children:e.value})]},e.label))}),!j&&(0,d.jsxs)(`div`,{className:`nxc-tags`,children:[e?.imovel?.area&&(0,d.jsxs)(`span`,{className:`nxc-tag`,children:[e.imovel.area,` m²`]}),e?.imovel?.tipologia&&(0,d.jsx)(`span`,{className:`nxc-tag`,children:e.imovel.tipologia})]})]}),(0,d.jsxs)(`div`,{className:`nxc-footer`,children:[(0,d.jsxs)(`div`,{className:`nxc-user`,children:[(0,d.jsx)(`div`,{className:`nxc-avatar`,children:e?.utilizador?.avatarUrl?(0,d.jsx)(`img`,{src:e.utilizador.avatarUrl,alt:``}):x}),(0,d.jsxs)(`span`,{className:`nxc-username${E?` mine`:``}`,children:[E?`O teu anúncio`:e?.utilizador?.nome||`Anunciante`,k&&(0,d.jsx)(p,{name:`check`,size:13,color:`#2563eb`})]})]}),e?.localizacao?.cidade&&(0,d.jsxs)(`div`,{className:`nxc-loc`,children:[(0,d.jsx)(p,{name:`location`,size:13}),e.localizacao.cidade]})]})]}),v&&(0,d.jsx)(`div`,{className:`nxc-modal-overlay`,onClick:H,children:(0,d.jsxs)(`div`,{className:`nxc-modal-box`,onClick:e=>e.stopPropagation(),children:[(0,d.jsx)(`div`,{className:`nxc-modal-icon`,children:(0,d.jsx)(p,{name:`trash`,size:42,color:`#ef4444`})}),(0,d.jsx)(`h3`,{className:`nxc-modal-title`,children:`Eliminar anúncio?`}),(0,d.jsxs)(`p`,{className:`nxc-modal-text`,children:[`Esta ação é `,(0,d.jsx)(`strong`,{children:`permanente e irreversível`}),`.`]}),(0,d.jsxs)(`div`,{className:`nxc-modal-actions`,children:[(0,d.jsx)(`button`,{type:`button`,className:`nxc-modal-cancel`,onClick:H,disabled:g,children:`Cancelar`}),(0,d.jsx)(`button`,{type:`button`,className:`nxc-modal-delete`,onClick:async t=>{t.preventDefault(),t.stopPropagation(),_(!0);try{let t=e._id||e.id;if(!t)throw Error(`ID não encontrado.`);let r=await i.delete(`/anuncios/${t}`);if(r.status>=200&&r.status<300)y(!1),n?.(t);else throw Error(`Resposta inesperada.`)}catch(e){alert(e.response?.data?.erro||`Não foi possível eliminar. Tenta novamente.`),_(!1)}},disabled:g,children:g?`A apagar…`:`Apagar`})]})]})})]})}export{m as t};