import{C as e,M as t,O as n,P as r,S as i,T as a,_ as o,k as s,v as c,x as l}from"./index-YAop2Ko_.js";import{n as u,t as d}from"./GoogleAuthButton-BGpohMAN.js";var f=r(t(),1),p=i(),m=[`Aveiro`,`Beja`,`Braga`,`Bragança`,`Castelo Branco`,`Coimbra`,`Évora`,`Faro`,`Guarda`,`Leiria`,`Lisboa`,`Portalegre`,`Porto`,`Santarém`,`Setúbal`,`Viana do Castelo`,`Vila Real`,`Viseu`,`Açores`,`Madeira`];function h(){let t=s(),r=n(),{loginGoogle:i}=l(),h=r.state?.googleProfile||null,[g,_]=(0,f.useState)(r.state?.googleCredential||``),[v,y]=(0,f.useState)({nome:h?.nome||``,email:h?.email||``,password:``,confirmarPassword:``,telefone:``,mostrarTelefonePublico:!0,localidade:``,aceitouTermos:!1,tipoConta:`particular`}),[b,x]=(0,f.useState)(!1),[S,C]=(0,f.useState)(!1),[w,T]=(0,f.useState)(!1),[E,D]=(0,f.useState)(``),[O,k]=(0,f.useState)(!1),[A,j]=(0,f.useState)(!1),M=o(r.state,`/`),N=!!g,P=()=>c(r.state,M),F=e=>{let t=e.target.value.replace(/\D/g,``);t.length<=9&&y({...v,telefone:t})},I=e=>{let t=e.length>=9,n=/[A-Z]/.test(e),r=/\d/.test(e),i=/[!@#$%^&*(),.?":{}|<>]/.test(e);return t&&n&&r&&i};return(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(`style`,{children:`
        .auth-root {
          position: relative;
          overflow: hidden;
