import{C as e,N as t,O as n,S as r,g as i,j as a,x as o}from"./index-C0TSapMH.js";import{i as s,r as c}from"./images-io1S19E8.js";import{Ft as l,Jt as u,L as d,S as ee,W as f,Xt as p,Yt as m,at as h,ct as g,g as te,gt as _,qt as v}from"./mdi-QYMZJQRB.js";import{t as ne}from"./AnuncioCard-7Yjh4l7i.js";import{n as y,t as b}from"./ProfileView-yZc3c1r7.js";var x=t(a(),1),S=p(),C=r(),w=[{value:`website`,label:`Website`,icon:v,placeholder:`Ex: https://www.teusite.pt`},{value:`instagram`,label:`Instagram`,icon:h,placeholder:`Ex: https://instagram.com/oteuperfil`},{value:`facebook`,label:`Facebook`,icon:f,placeholder:`Ex: https://facebook.com/oteuperfil`},{value:`linkedin`,label:`LinkedIn`,icon:g,placeholder:`Ex: https://linkedin.com/in/oteuperfil`},{value:`youtube`,label:`YouTube`,icon:m,placeholder:`Ex: https://youtube.com/@oteucanal`},{value:`tiktok`,label:`TikTok`,icon:_,placeholder:`Ex: https://tiktok.com/@oteuperfil`},{value:`whatsapp`,label:`WhatsApp`,icon:u,placeholder:`Ex: 912345678 ou https://wa.me/351912345678`},{value:`outro`,label:`Outro`,icon:d,placeholder:`Ex: https://www.outrolink.pt`}],T=()=>({tipo:`website`,url:``}),E=e=>w.find(t=>t.value===e)||w[w.length-1],re=(e,t)=>{let n=Array.isArray(e)?e.filter(e=>e?.url).slice(0,3):[];return n.length>0?n.map(e=>({tipo:e.tipo||`outro`,url:e.url||``})):t?[{tipo:`website`,url:t}]:[T()]};function D(){let{user:t,signed:r,atualizarAvatar:a,atualizarUser:u,logout:d}=o(),f=n(),p=(0,x.useRef)(null),m=(0,x.useRef)(null),h=localStorage.getItem(`@App:contexto_visual`)||`imovel`,[g,_]=(0,x.useState)(null),[v,D]=(0,x.useState)([]),[O,k]=(0,x.useState)(h),[A,j]=(0,x.useState)(!0),[M,N]=(0,x.useState)(!1),[P,F]=(0,x.useState)(!1),[ie,I]=(0,x.useState)(!1),[L,ae]=(0,x.useState)(null),[oe,R]=(0,x.useState)(!1),[z,B]=(0,x.useState)(null),[V,H]=(0,x.useState)(null),[U,W]=(0,x.useState)(!1),[G,K]=(0,x.useState)({nomeEmpresa:``,nif:``,website:``}),[se,q]=(0,x.useState)(!1),[J,Y]=(0,x.useState)({bio:``,website:``,localidade:``,mostrarTelefonePublico:!0,linksPerfil:[T()]}),ce=O===`carro`?`/carros`:`/imoveis`,le=O===`carro`?`Automóveis`:`Imóveis`;(0,x.useEffect)(()=>{if(!r){f(`/login`);return}t&&_(t);let n=!0;return(async()=>{try{let[t,r]=await Promise.all([e.get(`/users/me`),e.get(`/users/me/anuncios`)]);if(!n)return;_(t.data),D(r.data),j(!1)}catch(e){if(!n)return;e.response?.status===401||e.response?.status===403?(d(),f(`/login`)):(ae(`Não foi possível carregar os teus dados.`),j(!1))}})(),()=>{n=!1}},[f,r,t,d]);let ue=()=>{d(),f(`/`,{replace:!0})},de=async t=>{let n=t.target.files[0];if(n){F(!0);try{let t=new FormData;t.append(`imagens`,n),t.append(`kind`,`avatar`);let r=await e.post(`/upload/imagens`,t,{headers:{"Content-Type":`multipart/form-data`}}),i=s(r.data)[0],o=c(i,`large`)||r.data.url,l=await e.put(`/users/me`,{avatarUrl:o});a&&a(o),_(l.data)}catch{alert(`Erro ao processar a imagem do avatar.`)}finally{F(!1)}}},fe=async t=>{let n=t.target.files[0];if(n){I(!0);try{let t=new FormData;t.append(`imagens`,n),t.append(`kind`,`cover`);let r=await e.post(`/upload/imagens`,t,{headers:{"Content-Type":`multipart/form-data`}}),i=s(r.data)[0],a=c(i,`large`)||r.data.url,o=await e.put(`/users/me`,{capaUrl:a});_(o.data),u&&u(o.data)}catch{alert(`Erro ao processar a imagem de capa.`)}finally{I(!1)}}},pe=async t=>{if(t.preventDefault(),!G.nomeEmpresa){alert(`O Nome da Empresa é obrigatório.`);return}try{W(!1),N(!0);let t=await e.put(`/users/me`,{tipoConta:`profissional`,nome:G.nomeEmpresa,nif:G.nif,website:G.website});_(t.data),u&&u(t.data),alert(`A tua conta foi evoluída para Profissional com sucesso.`)}catch{alert(`Ocorreu um erro ao evoluir a tua conta.`)}finally{N(!1)}},me=()=>{Y({bio:g?.bio||``,website:g?.website||``,localidade:g?.localidade||``,mostrarTelefonePublico:g?.mostrarTelefonePublico!==!1,linksPerfil:re(g?.linksPerfil,g?.website)}),q(!0)},X=(e,t,n)=>{Y(r=>({...r,linksPerfil:r.linksPerfil.map((r,i)=>i===e?{...r,[t]:n}:r)}))},he=()=>{Y(e=>e.linksPerfil.length>=3?e:{...e,linksPerfil:[...e.linksPerfil,T()]})},Z=e=>{Y(t=>{let n=t.linksPerfil.filter((t,n)=>n!==e);return{...t,linksPerfil:n.length?n:[T()]}})},ge=async t=>{t.preventDefault();let n=J.linksPerfil.map(e=>({tipo:e.tipo||`outro`,url:(e.url||``).trim()})).filter(e=>e.url).slice(0,3),r=n.find(e=>e.tipo===`website`)?.url||``;try{N(!0),q(!1);let t=await e.put(`/users/me`,{bio:J.bio,localidade:J.localidade,mostrarTelefonePublico:J.mostrarTelefonePublico,website:r,linksPerfil:n});_(t.data),u&&u(t.data)}catch{alert(`Erro ao guardar as alterações do perfil.`)}finally{N(!1)}},_e=async t=>{if(z===t){B(null),H(null);return}B(t);try{let{data:n}=await e.get(`/analytics/anuncio/${t}`);H(n)}catch{alert(`Erro ao carregar dados.`),B(null)}},ve=e=>{N(!0),D(t=>t.filter(t=>t._id!==e)),setTimeout(()=>N(!1),800)},ye=()=>{let e=`${window.location.origin}/vendedor/${g._id}`;navigator.clipboard.writeText(e),R(!0),setTimeout(()=>R(!1),2e3)},be=v.filter(e=>e.tipo===O),Q=v.filter(e=>e.tipo===`imovel`).length,$=v.filter(e=>e.tipo===`carro`).length,xe=y(g);return A?(0,C.jsx)(i,{label:`A carregar perfil`,detail:`Estamos a preparar a tua área NOXVELIA.`,minHeight:`100vh`,tone:`light`}):(0,C.jsxs)(C.Fragment,{children:[(0,C.jsx)(`style`,{children:`
