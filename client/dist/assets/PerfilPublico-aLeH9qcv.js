import{d as v,b as j,r as a,j as t,c as z}from"./index-CE1zdK-t.js";import{A as N}from"./AnuncioCard-DUVEFPjG.js";import{o as C,P}from"./ProfileView-DXN1dSOG.js";import"./mdi-UYaLHP2S.js";function I(){var f,d;const{id:p}=v(),s=j(),[e,g]=a.useState(null),[r,m]=a.useState([]),[b,u]=a.useState(!0),[l,h]=a.useState(""),[w,c]=a.useState(!1);a.useEffect(()=>{let o=!0;return(async()=>{try{const{data:n}=await z.get(`/users/vendedor/${p}`);if(!o)return;g(n.vendedor),m(n.anuncios||[])}catch{o&&h("Erro ao carregar a montra do vendedor.")}finally{o&&u(!1)}})(),()=>{o=!1}},[p]);const y=()=>{const o=window.location.href;navigator.clipboard.writeText(o),c(!0),setTimeout(()=>c(!1),2e3)};if(b)return t.jsx("div",{style:{minHeight:"calc(100vh - 80px)",display:"flex",alignItems:"center",justifyContent:"center",background:"#f8fafc"},children:t.jsx("div",{className:"nx-spinner",style:{borderColor:"#e2e8f0",borderTopColor:"#0f172a"}})});if(l)return t.jsxs("div",{style:{minHeight:"calc(100vh - 80px)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:"#f8fafc",color:"#0f172a"},children:[t.jsx("p",{style:{color:"#64748b",marginBottom:"24px",fontSize:"15px"},children:l}),t.jsx("button",{onClick:()=>s(-1),style:{padding:"12px 24px",background:"#0f172a",color:"#fff",border:"none",borderRadius:"8px",fontWeight:700,cursor:"pointer"},children:"Voltar a pesquisa"})]});(f=e==null?void 0:e.nome)!=null&&f.charAt(0).toUpperCase();const i=(e==null?void 0:e.tipo)==="admin";i||(e==null||e.premiumAtivo),i?e.nome.toUpperCase().includes("NOXVELIA")?e.nome:`${e.nome}`:e==null||e.nome,e==null||e.tipoConta,(d=e==null?void 0:e.telefone)==null||d.replace(/\D/g,"");const k=C(e);return t.jsxs(t.Fragment,{children:[t.jsx("style",{children:`
...
//# sourceMappingURL=PerfilPublico-aLeH9qcv.js.map
