import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{n as t,t as n}from"./jsx-runtime-BX1tsrJU.js";import{C as r,O as i,S as a,T as o,_ as s,k as c,v as l}from"./index-DHzGJvgt.js";import{n as u,t as d}from"./GoogleAuthButton-BW0LfADY.js";var f=e(t(),1),p=n(),m=[`Aveiro`,`Beja`,`Braga`,`Bragança`,`Castelo Branco`,`Coimbra`,`Évora`,`Faro`,`Guarda`,`Leiria`,`Lisboa`,`Portalegre`,`Porto`,`Santarém`,`Setúbal`,`Viana do Castelo`,`Vila Real`,`Viseu`,`Açores`,`Madeira`];function h(){let e=c(),t=i(),{loginGoogle:n}=a(),h=t.state?.googleProfile||null,[g,_]=(0,f.useState)(t.state?.googleCredential||``),[v,y]=(0,f.useState)({nome:h?.nome||``,email:h?.email||``,password:``,confirmarPassword:``,telefone:``,mostrarTelefonePublico:!0,localidade:``,aceitouTermos:!1,tipoConta:`particular`}),[b,x]=(0,f.useState)(!1),[S,C]=(0,f.useState)(!1),[w,T]=(0,f.useState)(!1),[E,D]=(0,f.useState)(``),[O,k]=(0,f.useState)(!1),[A,j]=(0,f.useState)(!1),M=s(t.state,`/`),N=!!g,P=()=>l(t.state,M),F=e=>{let t=e.target.value.replace(/\D/g,``);t.length<=9&&y({...v,telefone:t})},I=e=>{let t=e.length>=9,n=/[A-Z]/.test(e),r=/\d/.test(e),i=/[!@#$%^&*(),.?":{}|<>]/.test(e);return t&&n&&r&&i};return(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(`style`,{children:`
        .auth-root {
          position: relative;
          overflow: hidden;
